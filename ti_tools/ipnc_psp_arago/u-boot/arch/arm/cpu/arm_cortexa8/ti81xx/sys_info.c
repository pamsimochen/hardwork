...
#if defined(CONFIG_TI814X) && !defined(CONFIG_TI811X) && !defined(CONFIG_TI813X)  && !defined(CONFIG_DM385)
...
{
	char *cpu_s, *sec_s;
	int arm_freq, ddr_freq, l3_freq, dsp_freq, iva_freq, iss_freq, dss_freq, rev;
