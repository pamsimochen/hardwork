...
#define I2C_CNT		((unsigned long)i2c_base + 0x98)
#define I2C_DATA	((unsigned long)i2c_base + 0x9c)
#define I2C_CON		((unsigned long)i2c_base + 0xA4)
#define I2C_OA		((unsigned long)i2c_base + 0xA8)
#define I2C_SA		((unsigned long)i2c_base + 0xAC)
#define I2C_PSC		((unsigned long)i2c_base + 0xB0)
#define I2C_SCLL	((unsigned long)i2c_base + 0xB4)
#define I2C_SCLH	((unsigned long)i2c_base + 0xB8)
