...
#define SYSBOOT_IPNC_BW_MASK		(BIT(SYSBOOT_IPNC_BW_POS))
...
#if !(defined(CONFIG_TI813X) || defined(CONFIG_DM385))
...
/* In ti814x I2C1 and I2C3 have common clk control */
...
#ifdef CONFIG_TI814X
#define CM_ALWON_HSMMC0_CLKCTRL		(PRCM_BASE + 0x161C)
