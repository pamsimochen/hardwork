...
ifeq ($(LOW_POWER_OPP100_MODE), YES)
PLATFORM_CPPFLAGS += -DLOW_POWER_OPP100_MODE
endif
...
ifdef BUILD_TAG
CFLAGS := $(CPPFLAGS) -Wall -Wstrict-prototypes -Wl,--relax,  -ffunction-sections -finline-limit=10 \
