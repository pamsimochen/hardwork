...
*
* @brief   This is the top level client header file that drives the mp4
*      (Advanced Simple Profile) Video Decoder Call using XDM/XDAIS Interface
*
* @author:  Ashish Singh
*
...
*
* @version 0.3 (Dec 2010) : Added debug trace parameter for run time access
*                           inside structure "sAppControlParams" [Nitesh]
*
* @version 0.4(August 2011) : Updated with new test app paramertes[Ashish]
*
*
****************************************************************************
*/
...
#ifndef _TESTAPP_DECODER_H_
#define _TESTAPP_DECODER_H_
...
*/
static XDAS_UInt32 frameNumsToStop[12] = {20,30, 140, 200, 240, 613,
                                     756, 843, 933, 1010, 1200, 1375 };
/**
 * Indicates the frame numbers from which application wants to resume the
 * decoding.
*/
static  XDAS_UInt32 frameNumsToSeek[12] = {10, 40, 170, 120, 250, 452, 543, 620,
                                     760, 899, 935, 1044};
...
(
  IMPEG4VDEC_OutArgs *outArgs, XDAS_Int16 xoff,
...
(
  IMPEG4VDEC_OutArgs *outArgs, XDAS_Int16 xoff, XDAS_Int16 yoff,
...
********************************************************************************
*/
XDAS_Void MPEG4DEC_ScratchMemoryCorruption();
