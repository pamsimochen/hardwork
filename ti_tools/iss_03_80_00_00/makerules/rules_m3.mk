...
CFLAGS_DIROPTS = -fr=$(OBJDIR) -fs=$(OBJDIR) --pch_dir=$(OBJDIR)
...
ifeq ($(PROFILE_$(CORE)), debug)
 CFLAGS_XDCINTERNAL = -Dxdc_target_name__=M3 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_4_6_1 
#-D_DEBUG_=1 --symdebug:dwarf
 CFLAGS_INTERNAL += -g
 ifndef MODULE_NAME
...
LIB_PATHS +=$(hdvpss_PATH)/build/ti/psp/vps/lib/ti814x-evm/m3/debug/hdvpss_drivers.aem3
LIB_PATHS +=$(hdvpss_PATH)/build/ti/psp/devices/lib/ti814x-evm/m3/debug/hdvpss_devices.aem3
LIB_PATHS +=$(hdvpss_PATH)/build/ti/psp/platforms/lib/ti814x-evm/m3/debug/hdvpss_platform.aem3
LIB_PATHS +=$(hdvpss_PATH)/build/ti/psp/i2c/lib/ti814x-evm/m3/debug/hdvpss_i2c.aem3
LIB_PATHS +=$(hdvpss_PATH)/build/ti/psp/proxyServer/lib/ti814x-evm/m3/debug/hdvpss_proxyServer.aem3
LIB_PATHS +=$(hdvpss_PATH)/build/ti/psp/examples/utility/lib/ti814x-evm/m3/debug/hdvpss_examples_utility.aem3
LIB_PATHS +=            $(iss_PATH)/packages/ti/psp/iss/alg/aewb/ti2a/awb/lib/release/iss_ti2a_awb.aem3 \
			...
			$(edma3lld_PATH)/packages/ti/sdo/edma3/drv/lib/m3/debug/edma3_lld_drv.aem3 \
			$(edma3lld_PATH)/packages/ti/sdo/edma3/rm/lib/ti814x-evm/m3/debug/edma3_lld_rm.aem3 \
