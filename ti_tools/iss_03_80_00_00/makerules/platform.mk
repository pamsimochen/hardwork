...
ifeq ($(ISA),m3)
  ...
  ifeq ($(SOC),ti814x)
    ifeq ($(CORE),m3video)
      PLATFORM_XDC = "ti.platforms.evmDM8148:core0"
    else
      PLATFORM_XDC = "ti.platforms.evmDM8148:core1"
    endif
  endif
# TBD
  ifeq ($(SOC),ti8107)
...
ifeq ($(CORE),m3vpss)
  CFGARGS_XDC = \"{coreName: \\\"VPSS-M3\\\", platformMem: \\\"$(PLATFORM_MEM)\\\"}\"
endif
ifeq ($(CORE),m3video)
  CFGARGS_XDC = \"{coreName:\\\"VIDEO-M3\\\", platformMem: \\\"$(PLATFORM_MEM)\\\"}\"
endif
ifneq ($(SOC),ti810x)
  ifeq ($(CORE),c6xdsp)
