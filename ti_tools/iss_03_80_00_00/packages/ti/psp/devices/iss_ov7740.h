 ...
 * \defgroup ISS_DRV_FVID2_DEVICE_VID_ENC_OV7740_API OV7740 Video Encoder API
 *
 *  This modules define API specific to OV7740 video encoder device.
 *
 * @{
*/
 ...
 *  \file iss_ov7740.h
 *
 *  \brief OV7740 Sensor API
*/

#ifndef _ISS_OV7740_H_
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
#define _ISS_OV7740_H_
 ...
 */
/**
  * \addtogroup ISS_DRV_FVID2_IOCTL_OV7740
  * @{
*/
...
/**
  ...
  *
*/
#define IOCTL_ISS_OV7740_GET_DETAILED_CHIP_ID      \
...
/**
  ...
  *
*/
#define IOCTL_ISS_OV7740_QUERY_HPD      \
...
/**
  ...
  *
  *
  * \param cmdArgs       [IN]   Pointer to Iss_Ov7740Prms
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure.
  *
*/
#define IOCTL_ISS_OV7740_SET_PARAMS      \
...
/**
  ...
  *
*/
#define IOCTL_ISS_OV7740_GET_PARAMS      \
 ...
 *  This structure is used in setting mode in OV7740 using
...
} Iss_Ov7740ModeParams;

/**
 * \brief Structure for hot plug detection parameters.
 *
 * It is used to get
 * the hpd parameters using IOCTL_ISS_OV7740_QUERY_HPD ioctl.
 */
typedef struct
{
...
{
    UInt32 outputType;
    /**< Type of the OUTPUT i.e. HDMI of DVI #Iss_Ov7740OutputType */
} Iss_Ov7740Prms;
