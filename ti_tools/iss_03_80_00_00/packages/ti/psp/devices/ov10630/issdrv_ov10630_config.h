 ...
 * ===================================================================*/
#ifndef _ISSDRV_OV10630_CONFIG_H_
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
#define _ISSDRV_OV10630_CONFIG_H_

#define PSP_I2C_MAX_REG_RD_WR       	(0x300) //make sure larger than REGISTERNUMBER

#define OV_10630_ADDR			(0x37)  // CCI write address

#define OV_10630_BOARD_PRECONFIG		(TRUE)	//TURE/FALSE
