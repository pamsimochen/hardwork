 ...
 *  ==================================================================
 */                                                                   
int RemoteDebug_putChar_Iss(char ch)
{
 ...
 *  ==================================================================
 */                                                                   
int RemoteDebug_getChar_Iss(char *pChar, UInt32 timeout)
{
    volatile RemoteDebug_CoreObj *pCoreObj;
...
/* ===================================================================
 *  @func     RemoteDebug_getString_Iss                                               
 *                                                                    
 *  @desc     Function does the following                             
 *                                                                    
 *  @modif    This function modifies the following structures         
 ...
 *  ==================================================================
 */                                                                   
int RemoteDebug_getString_Iss(char *pChar, UInt32 timeout)
{
