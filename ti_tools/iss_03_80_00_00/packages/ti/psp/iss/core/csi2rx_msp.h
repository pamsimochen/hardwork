...
**/
    ...
    typedef struct {
    /** Code Frame Start */
        int drvCcp2txCodeFsOn:1;
    /** Code Frame End */
        int drvCcp2txCodeFeOn:1;
    /** Code Line Start */
        int drvCcp2txCodeLsOn:1;
    /** Code Line End */
        int drvCcp2txCodeLeOn:1;
        int reserved:28;
    } MSP_drvCcp2txCodesT;
