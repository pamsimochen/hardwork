...
#define ISS_COMP_ISP_OUT_ALIGN      (32)
#define ISP_OUT_ROUND_UP(a)         ((a + (ISS_COMP_ISP_OUT_ALIGN - 1)) & ~(ISS_COMP_ISP_OUT_ALIGN - 1))

#define ISS_CROP_NO_ZOOM            0x10000
...
typedef struct {
    ...
    rsz_config_t rsz_config;
    isif_cfg_t isif_cfg;
    ccp2_path_enable_t ccp_cfg;
    ccp2_lcm_enable_t ccp_lcm_cfg;
    isif_2dlsc_cfg_t lsc2d_cfg;
    h3a_cfg_t h3a_cfg;
    ipipeif_h3a_input_cfg_t h3a_input_cfg;
 ...
 *  ==================================================================
 */                                                                   
ISP_RETURN sensor_pipe_init(void);
 ...
 *  ==================================================================
 */                                                                   
ISP_RETURN issDrvRawToYuvStart(iss_drv_config_t * iss_drv_config, void *in_buff,
                               void *out_buff_rszA, void *out_buff_rszB,
                               void *out_buff_rszA_C, void *out_buff_rszB_C,
                               void *raw_out_buff);
 ...
 *  ==================================================================
 */                                                                   
ISP_RETURN issDrvStopIsif(uint32 need_frame, uint32 width, uint32 height,
                          void *in_buffer);
