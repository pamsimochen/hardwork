 ...
 */
    typedef struct IVS1_Params {
        ...
        //This is the threshold for detecting panning.  Enter the number of pixels motion per frame in Q.8. 
        //Panning speed is calculated and compared to this threshold.
        //This value should be relative to vertImgSizeBeforeBSC and horzImgSizeBeforeBSC in VS_CreationParamsStruct. 
        //It is best to compute this value as a percentage of horzImgSizeBeforeBSC.
        //Recommended value is 1% of horzImgSizeBeforeBSC in Q.8.
        //If you set this input to 0, VS will use the default value automatically.
        XDAS_UInt16    panningCaseMotionThreshold; 

        //Number of motion compensation pixels in the vertical and horizontal directions
        //These values should be relative to vertImgSizeBeforeBSC and horzImgSizeBeforeBSC from above
        //It is best to compute these values as a percentage of vertImgSizeBeforeBSC and horzImgSizeBeforeBSC
        //Recommended value is 10% of vertImgSizeBeforeBSC and horzImgSizeBeforeBSC
        XDAS_UInt16    bounPels;  
        XDAS_UInt16    bounLines;  
 ...
 */
    typedef struct IVS1_InArgs {
        ...
        XDAS_UInt32  enableOverwriteWindowLocation;                     //If set to 1, overwrites the window location using the values provided. If set to 0, overwrite is disabled.
        XDAS_UInt32  horizontalWindowLocation_overwriteValue_beforeBSC; //Horizontal location of the upper left corner of the window. Should be relative to horzImgSizeBeforeBSC in VS_CreationParamsStruct.
        XDAS_UInt32  verticalWindowLocation_overwriteValue_beforeBSC;   //Vertical location of the upper left corner of the window. Should be relative to vertImgSizeBeforeBSC in VS_CreationParamsStruct.
    } IVS1_InArgs;
 ...
 */
    typedef struct IVS1_Fxns {
        IALG_Fxns ialg;           /**< xDAIS algorithm interface.
         ...
         XDAS_Int32(*process) (IVS1_Handle handle, IVS1_InArgs * inArgs,
                               IVS1_OutArgs * outArgs);

         XDAS_Int32(*control) (IVS1_Handle handle, IVS1_Cmd id,
                               IVS1_DynamicParams * params,
                               IVS1_Status * status);
    ...
    /* 
     *  ======== VS_TI_IVS ========
     *  TI's implementation of the IVS interface
     */
