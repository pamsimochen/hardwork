...
/**
 *  @Component instance:   MLB
 *
 *  @Filename:             mlb_inst_cred.h
 *
...
extern "C" {
    ...
    /* 
     * Instance MLB of component MLB mapped in MONICA at address 0x4A0F4000
     */
...
#define BITFIELD BITFIELD_32
    ...
    /* 
     *  List of Register arrays for component instance MLB
     *
     */

    /* 
     *  List of bundle arrays for component instance MLB
     *
     */
                                                                             /*-------------------------------------------------------------------------*//**
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_FIFOSTATUS_REGSET_0_15                0x80ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_FIFOSTATUS_REGSET_0_15__ELSIZE        0x4ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_FIFOSTATUS_REGSET_0_15__NELEMS        8
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQ_REGSET_0_3                        0x100ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQ_REGSET_0_3__ELSIZE                0x10ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQ_REGSET_0_3__NELEMS                3
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MESSAGE_REGSET_0_15                   0x40ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MESSAGE_REGSET_0_15__ELSIZE           0x4ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MESSAGE_REGSET_0_15__NELEMS           8
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MSGSTATUS_REGSET_0_15                 0xC0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MSGSTATUS_REGSET_0_15__ELSIZE         0x4ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MSGSTATUS_REGSET_0_15__NELEMS         8

    /* 
     *  List of bundles for component instance MLB
     *
     */
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_FIFOSTATUS__OFFSET                    0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_RAW__OFFSET                 0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_CLR__OFFSET                 0x4ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_SET__OFFSET                 0x8ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_CLR__OFFSET                 0xCul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MESSAGE__OFFSET                       0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MSGSTATUS__OFFSET                     0x0ul

    /* 
     * List of registers for component instance MLB
     *
     */
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_REVISION                              0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG                             0x10ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MESSAGE                               0x40ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_FIFOSTATUS                            0x80ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_MSGSTATUS                             0xC0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_RAW                         0x100ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_CLR                         0x104ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_SET                         0x108ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_CLR                         0x10Cul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQ_EOI                               0x140ul

    /* 
     * List of register bitfields for component instance MLB
     *
     */
...
#define MLB__MAILBOX_MSGSTATUS__NBOFMSGMBM__POS       0
                                                                             ...
                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_RAW__NOTFULLSTATUSUUMB7   
 *
 * @BRIEF        NotFull Status bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_RAW__NOTFULLSTATUSUUMB7 BITFIELD(15, 15)
#define MLB__MAILBOX_IRQSTATUS_RAW__NOTFULLSTATUSUUMB7__POS 15

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB7   
 *
 * @BRIEF        NewMessage Status bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB7 BITFIELD(14, 14)
#define MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB7__POS 14

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_RAW__NOTFULLSTATUSUUMB6   
 *
 * @BRIEF        NotFull Status bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_RAW__NOTFULLSTATUSUUMB6 BITFIELD(13, 13)
#define MLB__MAILBOX_IRQSTATUS_RAW__NOTFULLSTATUSUUMB6__POS 13

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB6   
 *
 * @BRIEF        NewMessage Status bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB6 BITFIELD(12, 12)
#define MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB6__POS 12
...
#define MLB__MAILBOX_IRQSTATUS_RAW__NEWMSGSTATUSUUMB0__POS 0
                                                                             ...
                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_CLR__NOTFULLSTATUSENUUMB7   
 *
 * @BRIEF        NotFull Status bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_CLR__NOTFULLSTATUSENUUMB7 BITFIELD(15, 15)
#define MLB__MAILBOX_IRQSTATUS_CLR__NOTFULLSTATUSENUUMB7__POS 15

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB7   
 *
 * @BRIEF        NewMessage Status bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB7 BITFIELD(14, 14)
#define MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB7__POS 14

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_CLR__NOTFULLSTATUSENUUMB6   
 *
 * @BRIEF        NotFull Status bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_CLR__NOTFULLSTATUSENUUMB6 BITFIELD(13, 13)
#define MLB__MAILBOX_IRQSTATUS_CLR__NOTFULLSTATUSENUUMB6__POS 13

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB6   
 *
 * @BRIEF        NewMessage Status bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB6 BITFIELD(12, 12)
#define MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB6__POS 12
...
#define MLB__MAILBOX_IRQSTATUS_CLR__NEWMSGSTATUSENUUMB0__POS 0
                                                                             ...
                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_SET__NOTFULLENABLEUUMB7   
 *
 * @BRIEF        NotFull Enable bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_SET__NOTFULLENABLEUUMB7 BITFIELD(15, 15)
#define MLB__MAILBOX_IRQENABLE_SET__NOTFULLENABLEUUMB7__POS 15

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB7   
 *
 * @BRIEF        NewMessage Enable bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB7 BITFIELD(14, 14)
#define MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB7__POS 14

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_SET__NOTFULLENABLEUUMB6   
 *
 * @BRIEF        NotFull Enable bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_SET__NOTFULLENABLEUUMB6 BITFIELD(13, 13)
#define MLB__MAILBOX_IRQENABLE_SET__NOTFULLENABLEUUMB6__POS 13

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB6   
 *
 * @BRIEF        NewMessage Enable bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB6 BITFIELD(12, 12)
#define MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB6__POS 12
...
#define MLB__MAILBOX_IRQENABLE_SET__NEWMSGENABLEUUMB0__POS 0
                                                                             ...
                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_CLR__NOTFULLENABLEUUMB7   
 *
 * @BRIEF        NotFull Enable bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_CLR__NOTFULLENABLEUUMB7 BITFIELD(15, 15)
#define MLB__MAILBOX_IRQENABLE_CLR__NOTFULLENABLEUUMB7__POS 15

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_CLR__NEWMSGENABLEUUMB7   
 *
 * @BRIEF        NewMessage Enable bit for User u, Mailbox 7 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_CLR__NEWMSGENABLEUUMB7 BITFIELD(14, 14)
#define MLB__MAILBOX_IRQENABLE_CLR__NEWMSGENABLEUUMB7__POS 14

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_CLR__NOTFULLENABLEUUMB6   
 *
 * @BRIEF        NotFull Enable bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_CLR__NOTFULLENABLEUUMB6 BITFIELD(13, 13)
#define MLB__MAILBOX_IRQENABLE_CLR__NOTFULLENABLEUUMB6__POS 13

                                                                             /*-------------------------------------------------------------------------*//**
 * @DEFINITION   MLB__MAILBOX_IRQENABLE_CLR__NEWMSGENABLEUUMB6   
 *
 * @BRIEF        NewMessage Enable bit for User u, Mailbox 6 - (RW) 
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQENABLE_CLR__NEWMSGENABLEUUMB6 BITFIELD(12, 12)
#define MLB__MAILBOX_IRQENABLE_CLR__NEWMSGENABLEUUMB6__POS 12
...
#define MLB__MAILBOX_IRQ_EOI__EOIVAL__POS             0
    ...
    /* 
     * List of register bitfields values for component instance MLB
     *
     */
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG__SIDLEMODE__B00        0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG__SIDLEMODE__B01        0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG__SIDLEMODE__B10        0x2ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG__SIDLEMODE__B11        0x3ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG__SOFTRESET__B0         0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_SYSCONFIG__SOFTRESET__B1         0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQ_EOI__EOIVAL__B0              0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define MLB__MAILBOX_IRQ_EOI__EOIVAL__B1              0x1ul
