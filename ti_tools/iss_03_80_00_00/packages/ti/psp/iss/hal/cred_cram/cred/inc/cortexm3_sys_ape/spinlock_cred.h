...
#ifndef __SPINLOCK_CRED_H
#define __SPINLOCK_CRED_H
...
extern "C" {
    ...
    /* 
     * Instance SPINLOCK of component SPINLOCK mapped in MONICA at address 0x4A0F6000
     */
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__LOCK_REG                                 0x800ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__LOCK_REG__ELSIZE                         0x4ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION                                 0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG                                0x10ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSTATUS                                 0x14ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION__SCHEME__LEGACY            0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION__SCHEME__HIGHLANDER        0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION__RESERVED__DSPS            0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION__RESERVED__WTBU            0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION__RESERVED__RES2            0x2ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__REVISION__RESERVED__RES3            0x3ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__CLOCKACTIVITYOCP__NOTREQUIRED 0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__CLOCKACTIVITYOCP__REQUIRED 0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__SIDLEMODE__FORCEIDLE     0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__SIDLEMODE__NOIDLE        0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__SIDLEMODE__SMARTIDLE     0x2ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__SIDLEMODE__UNUSED3       0x3ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__ENWAKEUP__NOWAKEUPGEN    0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__ENWAKEUP__WAKEUPGEN1     0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__SOFTRESET__NOOP          0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__SOFTRESET__DORESET       0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__AUTOGATING__FREERUNNING  0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSCONFIG__AUTOGATING__GATED        0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSTATUS__NUMLOCKS__32LOCKS         0x1ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSTATUS__NUMLOCKS__64LOCKS         0x2ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSTATUS__NUMLOCKS__128LOCKS        0x4ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__SYSTATUS__NUMLOCKS__256LOCKS        0x8ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__LOCK_REG__TAKEN__FREE               0x0ul
 ...
 *
    *//*------------------------------------------------------------------------ */
#define SPINLOCK__LOCK_REG__TAKEN__BUSY               0x1ul

#ifdef __cplusplus
}
#endif
#endif                                                     /* __SPINLOCK_CRED_H 
                                                            */
