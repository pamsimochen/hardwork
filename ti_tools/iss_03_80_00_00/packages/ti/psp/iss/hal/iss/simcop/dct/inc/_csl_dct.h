...
*used for setting the registers of H/W  DCT module in SIMCOP in OMAP4/Monica
*
* @path DCT\inc
*
* @rev 1.0
...
#if 0
/*****************************************************************************
 * individual functions to Set writable registers in the 
 * DCT module of SIMCOP 
 */
 /*****************************************************************************/
/* ===================================================================
 *  @func     _CSL_dctEnable                                               
 ...
 *  ==================================================================
 */                                                                   
CSL_Status _CSL_dctSetTrigSrcType(CSL_DctHandle hndl, CSL_DctTrgSrcType data);

/* ===================================================================
 *  @func     _CSL_dctSetAutoGating                                               
 *                                                                    
 *  @desc     Function does the following                             
 *                                                                    
 *  @modif    This function modifies the following structures         
 ...
 *  ==================================================================
 */                                                                   
CSL_Status _CSL_dctSetIntEnable(CSL_DctHandle hndl, CSL_DctIntEnableType data);

/*****************************************************************************/
/* individual functions to Query readable registers in the DCT module of
 * SIMCOP */
 /*****************************************************************************/

/* ===================================================================
 *  @func     _CSL_dctGetState                                               
 *                                                                    
 *  @desc     Function does the following                             
 *                                                                    
 *  @modif    This function modifies the following structures         
 ...
 *  ==================================================================
 */                                                                   
CSL_Status _CSL_dctGetSpDataFmt(CSL_DctHandle hndl, CSL_DctSpDataType * data);

/* ===================================================================
 *  @func     _CSL_dctGetTrigSrcType                                               
 *                                                                    
 *  @desc     Function does the following                             
 *                                                                    
 *  @modif    This function modifies the following structures         
 ...
 *  ==================================================================
 */                                                                   
CSL_Status _CSL_dctGetTrigSrcType(CSL_DctHandle hndl, CSL_DctTrgSrcType * data);

/* ===================================================================
 *  @func     _CSL_dctGetAutoGating                                               
 *                                                                    
 *  @desc     Function does the following                             
 *                                                                    
 *  @modif    This function modifies the following structures         
...
#endif
/*****************************************************************************/
 /* Functions to get the DCT unique identifier & resource allocation mask *
  * into the handle */
 /*****************************************************************************/
/* ===================================================================
 *  @func     _CSL_dctGetAttrs                                               
 *                                                                    
 *  @desc     Function does the following                             
 *                                                                    
 *  @modif    This function modifies the following structures         
