...
public class gnu_targets_codesourcery
{
    ...
    void GCArmv5T$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                ...
                if (fxn != null) po.addFxn("getRawVersion", (Proto.Fxn)om.findStrict("xdc.bld.ITarget3$$getRawVersion", "gnu.targets.codesourcery"), fxn);
                fxn = Global.get(cap, "asmName");
                if (fxn != null) po.addFxn("asmName", (Proto.Fxn)om.findStrict("gnu.targets.ITarget$$asmName", "gnu.targets.codesourcery"), fxn);
    }
