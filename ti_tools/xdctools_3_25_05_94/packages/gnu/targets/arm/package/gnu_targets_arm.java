...
public class gnu_targets_arm
{
    ...
    void IM$$TYPES()
    {
        ...
        po.init("gnu.targets.arm.IM.Module", om.findStrict("gnu.targets.ITarget.Module", "gnu.targets.arm"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        ...
        po.addFld("platform", $$T_Str, "ti.platforms.tiva:LM4F232H5QD", "wh");
        po.addFld("LONGNAME", $$T_Str, "bin/arm-none-eabi-gcc", "wh");
        po.addFld("stdInclude", $$T_Str, "gnu/targets/arm/std.h", "rh");
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
    ...
    void M3$$TYPES()
    {
        ...
        po.addFld("platform", $$T_Str, "ti.platforms.tiva:LM3S9B90", "wh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-mcpu=cortex-m3 -mthumb -mabi=aapcs -g"), "rh");
    ...
    void M4$$TYPES()
    {
        ...
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-mcpu=cortex-m4 -mthumb -msoft-float -mabi=aapcs -g"), "rh");
        po.addFld("ccBin", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "bin/arm-none-eabi-gcc -c -MD -MF $@.dep", "opts", "-mcpu=cortex-m4 -mthumb -msoft-float -mabi=aapcs -g"), "rh");
    ...
    void M4F$$TYPES()
    {
        ...
        po.addFld("isa", $$T_Str, "v7M4", "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mabi=aapcs -g"), "rh");
        ...
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -x assembler-with-cpp", "opts", "-Wa,-mcpu=cortex-m4 -Wa,-mthumb -Wa,-mfloat-abi=hard -Wa,-mfpu=fpv4-sp-d16 "), "rh");
    ...
    void A8F$$TYPES()
    {
        ...
        po.init("gnu.targets.arm.A8F.Module", om.findStrict("gnu.targets.ITarget.Module", "gnu.targets.arm"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("name", $$T_Str, "A8F", "rh");
        po.addFld("suffix", $$T_Str, "a8fg", "rh");
        po.addFld("isa", $$T_Str, "v7A8", "rh");
        ...
        po.addFld("LONGNAME", $$T_Str, "bin/arm-none-eabi-gcc", "wh");
        po.addFld("stdInclude", $$T_Str, "gnu/targets/arm/std.h", "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-mcpu=cortex-a8 -mfpu=neon -mfloat-abi=hard -mabi=aapcs -g"), "rh");
        ...
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -x assembler-with-cpp", "opts", "-mcpu=cortex-a8 -mfpu=neon -mfloat-abi=hard"), "rh");
        ...
        po.addFld("lnkOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-mfloat-abi=hard -nostartfiles -Wl,-static -Wl,--gc-sections", "suffix", "-Wl,--start-group -lgcc -lc -lm -Wl,--end-group -Wl,-Map=$(XDCCFGDIR)/$@.map -L$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/lib/fpu"), "wh");
        po.addFld("arBin", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "bin/arm-none-eabi-ar ", "opts", ""), "rh");
        po.addFld("bspLib", $$T_Str, "nosys", "wh");
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "gnu.targets.arm")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "-g", "defs", "-D_DEBUG_=1"), "linkOpts", "-g")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", " -O2 "), "linkOpts", " ")})}), "wh");
        po.addFld("compatibleSuffixes", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{}), "wh");
    ...
    void A9F$$TYPES()
    {
        ...
        po.init("gnu.targets.arm.A9F.Module", om.findStrict("gnu.targets.ITarget.Module", "gnu.targets.arm"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        ...
        po.addFld("LONGNAME", $$T_Str, "bin/arm-none-eabi-gcc", "wh");
        po.addFld("stdInclude", $$T_Str, "gnu/targets/arm/std.h", "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-mcpu=cortex-a9 -mfpu=neon -mfloat-abi=hard -mabi=aapcs -g"), "rh");
        ...
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -x assembler-with-cpp", "opts", "-mcpu=cortex-a9 -mfpu=neon -mfloat-abi=hard"), "rh");
    ...
    void A15F$$TYPES()
    {
        ...
        po.init("gnu.targets.arm.A15F.Module", om.findStrict("gnu.targets.ITarget.Module", "gnu.targets.arm"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        ...
        po.addFld("LONGNAME", $$T_Str, "bin/arm-none-eabi-gcc", "wh");
        po.addFld("stdInclude", $$T_Str, "gnu/targets/arm/std.h", "rh");
        po.addFld("cc", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -MD -MF $@.dep", "opts", "-mcpu=cortex-a15 -mfpu=neon -mfloat-abi=hard -mabi=aapcs -g"), "rh");
        ...
        po.addFld("ccOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("ccConfigOpts", (Proto)om.findStrict("xdc.bld.ITarget2.Options", "gnu.targets.arm"), Global.newObject("prefix", "-Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -I$(XDCROOT)/packages/gnu/targets/arm/libs/install-native/$(GCCTARG)/include", "suffix", "-Dfar= -D__DYNAMIC_REENT__ "), "wh");
        po.addFld("asm", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "gnu.targets.arm"), Global.newObject("cmd", "$(rootDir)/$(LONGNAME) -c -x assembler-with-cpp", "opts", "-mcpu=cortex-a15 -mfpu=neon -mfloat-abi=hard"), "rh");
