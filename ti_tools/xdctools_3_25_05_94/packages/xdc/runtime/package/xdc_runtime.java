...
public class xdc_runtime
{
    ...
    void Text$$TYPES()
    {
        ...
        po.init("xdc.runtime.Text.MatchVisState", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("pat", Proto.Elm.newCNum("(xdc_CString)"), $$UNDEF, "w");
    ...
    void Types$$TYPES()
    {
        ...
        po.init("xdc.runtime.Types.Site", null);
                ...
                po.addFld("file", Proto.Elm.newCNum("(xdc_CString)"), $$UNDEF, "w");
        ...
        po.init("xdc.runtime.Types.RegDesc", null);
                ...
                po.addFld("modName", Proto.Elm.newCNum("(xdc_CString)"), $$UNDEF, "w");
    ...
    void Diags$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "setMask", "entry", "0x%x", "exit", ""));
        vo.bind("$$loggables", loggables.toArray());
    ...
    void Error$$SINGLETONS()
    {
        ...
        loggables.add(Global.newObject("name", "raiseX", "entry", "%p, %d, 0x%x, %d", "exit", ""));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("Error", vo);
    ...
    void Registry$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "addModule", "entry", "%p, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "findByName", "entry", "0x%x", "exit", "%p"));
        loggables.add(Global.newObject("name", "findByNamePattern", "entry", "0x%x, %d, %p", "exit", "%p"));
        loggables.add(Global.newObject("name", "findById", "entry", "%d", "exit", "%p"));
        loggables.add(Global.newObject("name", "getMask", "entry", "0x%x, %p", "exit", "%d"));
        ...
        loggables.add(Global.newObject("name", "getModuleName", "entry", "%p", "exit", "0x%x"));
    ...
    void System$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("xdc_runtime_System_Module__startupDone__E", "xdc_runtime_System_abort__E", "xdc_runtime_System_atexit__E", "xdc_runtime_System_exit__E", "xdc_runtime_System_putch__E", "xdc_runtime_System_flush__E", "xdc_runtime_System_printf_va__E", "xdc_runtime_System_aprintf_va__E", "xdc_runtime_System_sprintf_va__E", "xdc_runtime_System_asprintf_va__E", "xdc_runtime_System_vprintf__E", "xdc_runtime_System_avprintf__E", "xdc_runtime_System_vsprintf__E", "xdc_runtime_System_avsprintf__E", "xdc_runtime_System_snprintf_va__E", "xdc_runtime_System_vsnprintf__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        ...
        loggables.add(Global.newObject("name", "printf", "entry", "0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "aprintf", "entry", "0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "sprintf", "entry", "%p, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "asprintf", "entry", "%p, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "vprintf", "entry", "0x%x, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "avprintf", "entry", "0x%x, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "vsprintf", "entry", "%p, 0x%x, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "avsprintf", "entry", "%p, 0x%x, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "snprintf", "entry", "%p, 0x%x, 0x%x", "exit", "%d"));
        loggables.add(Global.newObject("name", "vsnprintf", "entry", "%p, 0x%x, 0x%x, 0x%x", "exit", "%d"));
        vo.bind("$$loggables", loggables.toArray());
    ...
    void Text$$SINGLETONS()
    {
        ...
        loggables.add(Global.newObject("name", "matchRope", "entry", "%d, 0x%x, %p", "exit", "%d"));
