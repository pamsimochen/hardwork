...
instance:
     ...
     *  @p
     *
     *  If instance names are enabled and used for statically created instances,
     *  the config parameter `{@link xdc.runtime.Text#isLoaded Text.isLoaded}`
     *  must be set to `true` to have these names available at runtime.
     *
...
/*
 *  @(#) xdc.runtime; 2, 1, 0,438; 12-19-2013 19:53:36; /db/ztree/library/trees/xdc/xdc-z63x/src/packages/
 */
