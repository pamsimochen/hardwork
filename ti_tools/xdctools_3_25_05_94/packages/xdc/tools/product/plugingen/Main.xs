...
function run(cmdr, args)
{
    ...
    /* Check if supresseProductTypeInfo is used. Throw an error to any users still using this option*/
...
/*
 *  @(#) xdc.tools.product.plugingen; 1, 0, 0,100; 12-7-2013 14:16:39; /db/ztree/library/trees/xdctools/xdctools-f41x/src/
 */
