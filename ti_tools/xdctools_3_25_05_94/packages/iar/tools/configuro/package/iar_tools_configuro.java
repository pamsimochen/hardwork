...
public class iar_tools_configuro
{
    ...
    void Main$$OBJECTS()
    {
        ...
        Object objP = om.bind("iar.tools.configuro.Main.Object", new Proto.Str(po, true));
    ...
    void Main$$TYPES()
    {
        ...
        po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{"[-o outdir (optional)]", "[-c codegen_dir]", "[--cc compiler_name_string]", "[--device device_name]", "[--compileOptions compile_options_string]", "[--linkOptions linker_options_string]", "[--profile profile]", "[--projFile project_file (optional)]", "infile.cfg (optional)"}), "wh");
        ...
        po.addFld("compiler", $$T_Str, null, "wh");
