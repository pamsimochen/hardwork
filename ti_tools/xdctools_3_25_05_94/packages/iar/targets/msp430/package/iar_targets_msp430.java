...
public class iar_targets_msp430
{
    ...
    void MSP430X_large$$TYPES()
    {
        ...
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "iar.targets.msp430")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "--debug --dlib_config $(rootDir)/lib/dlib/dl430xlfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlfn.r43")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-Ohs --dlib_config $(rootDir)/lib/dlib/dl430xlfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlfn.r43")}), Global.newArray(new Object[]{"debug_full", Global.newObject("compileOpts", Global.newObject("copts", "--debug --dlib_config $(rootDir)/lib/dlib/dl430xlff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlff.r43")}), Global.newArray(new Object[]{"release_full", Global.newObject("compileOpts", Global.newObject("copts", "-Ohs --dlib_config $(rootDir)/lib/dlib/dl430xlff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xlff.r43")})}), "wh");
    ...
    void MSP430X_small$$TYPES()
    {
        ...
        po.addFld("profiles", new Proto.Map((Proto)om.findStrict("xdc.bld.ITarget.OptionSet", "iar.targets.msp430")), Global.newArray(new Object[]{Global.newArray(new Object[]{"debug", Global.newObject("compileOpts", Global.newObject("copts", "--debug --dlib_config $(rootDir)/lib/dlib/dl430xsfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsfn.r43")}), Global.newArray(new Object[]{"release", Global.newObject("compileOpts", Global.newObject("copts", "-Ohs --dlib_config $(rootDir)/lib/dlib/dl430xsfn.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsfn.r43")}), Global.newArray(new Object[]{"debug_full", Global.newObject("compileOpts", Global.newObject("copts", "--debug --dlib_config $(rootDir)/lib/dlib/dl430xsff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsff.r43")}), Global.newArray(new Object[]{"release_full", Global.newObject("compileOpts", Global.newObject("copts", "-Ohs --dlib_config $(rootDir)/lib/dlib/dl430xsff.h"), "linkOpts", "$(rootDir)/lib/dlib/dl430xsff.r43")})}), "wh");
