...
{
    static final String VERS = "@(#) xdc-z51\n";
    ...
    void CallBack$$OBJECTS()
    {
        ...
        Object objP = om.bind("iar.rov.server.CallBack.Object", new Proto.Str(po, true));
    ...
    void Main$$OBJECTS()
    {
        ...
        Object objP = om.bind("iar.rov.server.Main.Object", new Proto.Str(po, true));
    ...
    void SymbolTable$$OBJECTS()
    {
        ...
        Object objP = om.bind("iar.rov.server.SymbolTable.Object", new Proto.Str(po, true));
    ...
    void Server$$FUNCTIONS()
    {
        ...
        fxn = (Proto.Fxn)om.bind("iar.rov.server.Server$$startModel", new Proto.Fxn(om.findStrict("iar.rov.server.Server.Module", "iar.rov.server"), null, 1, 1, false));
    ...
    void Main$$TYPES()
    {
        ...
        po.init("iar.rov.server.Main.Module", om.findStrict("xdc.tools.ICmd.Module", "iar.rov.server"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
        po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{" ", "Usage", "[-e executable]", "[-m Module Tab]", "[-l]", "[--help]", " "}), "wh");
