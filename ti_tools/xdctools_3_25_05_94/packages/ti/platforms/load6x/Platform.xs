...
function getExecCmd(prog, packagePath)
{
    ...
    if (os == "Solaris" || os == "Linux") {
        return (packagePath + os + "/exec6x -root " + prog.build.target.rootDir
            + " $(1) " + prog.name);
    }
    if (os == "Windows") {
...
/*
 *  @(#) ti.platforms.load6x; 1, 0, 1, 1,160; 12-20-2013 12:46:49; /db/ztree/library/trees/platform/platform-o37x/src/
 */
