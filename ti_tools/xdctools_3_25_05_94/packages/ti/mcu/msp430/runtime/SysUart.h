...
#define ti_mcu_msp430_runtime_SysUart___VERS 160
...
__extern xdc_Void ti_mcu_msp430_runtime_SysUart_abort__E( xdc_CString str );
xdc__CODESECT(ti_mcu_msp430_runtime_SysUart_abort__F, "ti_mcu_msp430_runtime_SysUart_abort")
__extern xdc_Void ti_mcu_msp430_runtime_SysUart_abort__F( xdc_CString str );
__extern xdc_Void ti_mcu_msp430_runtime_SysUart_abort__R( xdc_CString str );
