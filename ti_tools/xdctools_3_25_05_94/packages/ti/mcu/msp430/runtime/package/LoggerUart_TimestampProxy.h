...
#define ti_mcu_msp430_runtime_LoggerUart_TimestampProxy___VERS 160
...
__extern xdc_Void ti_mcu_msp430_runtime_LoggerUart_TimestampProxy_Params__init__S( xdc_Ptr dst, const xdc_Void* src, xdc_SizeT psz, xdc_SizeT isz );
