...
public class ti_catalog_arm_cortexa15
{
    ...
    void DRA7XX$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.arm.cortexa15.DRA7XX.Object", new Proto.Str(po, true));
    ...
    void TCI6636K2H$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.arm.cortexa15.TCI6636K2H.Object", new Proto.Str(po, true));
    ...
    void DRA7XX$$TYPES()
    {
        ...
        po.addFld("minDataUnitSize", Proto.Elm.newCNum("(xdc_Int)"), 1L, "wh");
        po.addFld("dataWordSize", Proto.Elm.newCNum("(xdc_Int)"), 4L, "wh");
        po.addFld("memMap", new Proto.Map((Proto)om.findStrict("xdc.platform.IPlatform.Memory", "ti.catalog.arm.cortexa15")), Global.newArray(new Object[]{Global.newArray(new Object[]{"SRAM", Global.newObject("comment", "On-Chip SRAM", "name", "SRAM", "base", 0x402F0000L, "len", 0x00010000L, "space", "code/data", "access", "RWX")}), Global.newArray(new Object[]{"OCMC_RAM1", Global.newObject("name", "OCMC_RAM1", "base", 0x40300000L, "len", 0x00080000L)}), Global.newArray(new Object[]{"OCMC_RAM2", Global.newObject("name", "OCMC_RAM2", "base", 0x40400000L, "len", 0x00100000L)}), Global.newArray(new Object[]{"OCMC_RAM3", Global.newObject("name", "OCMC_RAM3", "base", 0x40500000L, "len", 0x00100000L)})}), "wh");
                fxn = Global.get(cap, "getMemoryMap");
                if (fxn != null) po.addFxn("getMemoryMap", (Proto.Fxn)om.findStrict("xdc.platform.ICpuDataSheet$$getMemoryMap", "ti.catalog.arm.cortexa15"), fxn);
                fxn = Global.get(cap, "getRegisterSet");
                if (fxn != null) po.addFxn("getRegisterSet", (Proto.Fxn)om.findStrict("xdc.platform.ICpuDataSheet$$getRegisterSet", "ti.catalog.arm.cortexa15"), fxn);
