...
xdc__CODESECT(ti_catalog_arm_cortexm4_tiva_ce_Boot_Module__startupDone__S, "ti_catalog_arm_cortexm4_tiva_ce_Boot_Module__startupDone")
...
xdc__CODESECT(ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockSet__F, "ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockSet")
__extern xdc_Void ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockSet__F( xdc_ULong ulConfig );
__extern xdc_Void ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockSet__R( xdc_ULong ulConfig );
...
xdc__CODESECT(ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockFreqSet__F, "ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockFreqSet")
__extern xdc_ULong ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockFreqSet__F( xdc_ULong ulConfig, xdc_ULong ulSysClock );
__extern xdc_ULong ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlClockFreqSet__R( xdc_ULong ulConfig, xdc_ULong ulSysClock );

/* sysCtlLDOSet__E */
#define ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet__E
xdc__CODESECT(ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet__E, "ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet")
__extern xdc_Void ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet__E( xdc_ULong ulVoltage );
xdc__CODESECT(ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet__F, "ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet")
__extern xdc_Void ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet__F( xdc_ULong ulVoltage );
__extern xdc_Void ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet__R( xdc_ULong ulVoltage );
...
#define Boot_sysCtlLDOSet ti_catalog_arm_cortexm4_tiva_ce_Boot_sysCtlLDOSet
