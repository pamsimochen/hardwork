...
public class ti_catalog_arm_cortexm4
{
    ...
    void Tiva$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.arm.cortexm4.Tiva.Object", new Proto.Str(po, true));
    ...
    void DRA7XX$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.arm.cortexm4.DRA7XX.Object", new Proto.Str(po, true));
    ...
    void TDA3XX$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.catalog.arm.cortexm4.TDA3XX.Object", new Proto.Str(po, true));
    ...
    void DRA7XX$$TYPES()
    {
        ...
        po.addFld("minDataUnitSize", Proto.Elm.newCNum("(xdc_Int)"), 1L, "wh");
        po.addFld("dataWordSize", Proto.Elm.newCNum("(xdc_Int)"), 4L, "wh");
        po.addFld("memMap", new Proto.Map((Proto)om.findStrict("xdc.platform.IPlatform.Memory", "ti.catalog.arm.cortexm4")), Global.newArray(new Object[]{Global.newArray(new Object[]{"L2_ROM", Global.newObject("name", "L2_ROM", "base", 0x00000000L, "len", 0x00004000L)}), Global.newArray(new Object[]{"L2_RAM", Global.newObject("name", "L2_RAM", "base", 0x20000000L, "len", 0x00010000L)}), Global.newArray(new Object[]{"OCMC_RAM1", Global.newObject("name", "OCMC_RAM1", "base", 0x40300000L, "len", 0x00080000L)}), Global.newArray(new Object[]{"OCMC_RAM2", Global.newObject("name", "OCMC_RAM2", "base", 0x40400000L, "len", 0x00100000L)}), Global.newArray(new Object[]{"OCMC_RAM3", Global.newObject("name", "OCMC_RAM3", "base", 0x40500000L, "len", 0x00100000L)})}), "wh");
                fxn = Global.get(cap, "getMemoryMap");
                if (fxn != null) po.addFxn("getMemoryMap", (Proto.Fxn)om.findStrict("xdc.platform.ICpuDataSheet$$getMemoryMap", "ti.catalog.arm.cortexm4"), fxn);
                fxn = Global.get(cap, "getRegisterSet");
                if (fxn != null) po.addFxn("getRegisterSet", (Proto.Fxn)om.findStrict("xdc.platform.ICpuDataSheet$$getRegisterSet", "ti.catalog.arm.cortexm4"), fxn);
