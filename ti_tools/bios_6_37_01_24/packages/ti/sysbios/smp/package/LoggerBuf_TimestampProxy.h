...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Handle__label__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Handle__label")
...
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Module__startupDone__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Module__startupDone")
__extern xdc_Bool ti_sysbios_smp_LoggerBuf_TimestampProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__create__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__delete__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__delete")
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__destruct__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__destruct")
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__get__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__get")
__extern xdc_Ptr ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__first__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__first")
__extern xdc_Ptr ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__next__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__next")
__extern xdc_Ptr ti_sysbios_smp_LoggerBuf_TimestampProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Params__init__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Params__init")
...
/* Proxy__abstract__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Proxy__abstract__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Proxy__abstract")
__extern xdc_Bool ti_sysbios_smp_LoggerBuf_TimestampProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_Proxy__delegate__S, "ti_sysbios_smp_LoggerBuf_TimestampProxy_Proxy__delegate")
...
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_get32__R, "ti_sysbios_smp_LoggerBuf_TimestampProxy_get32")
__extern xdc_Bits32 ti_sysbios_smp_LoggerBuf_TimestampProxy_get32__R( void );
...
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_get64__R, "ti_sysbios_smp_LoggerBuf_TimestampProxy_get64")
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_get64__R( xdc_runtime_Types_Timestamp64* result );
...
xdc__CODESECT(ti_sysbios_smp_LoggerBuf_TimestampProxy_getFreq__R, "ti_sysbios_smp_LoggerBuf_TimestampProxy_getFreq")
__extern xdc_Void ti_sysbios_smp_LoggerBuf_TimestampProxy_getFreq__R( xdc_runtime_Types_FreqHz* freq );
