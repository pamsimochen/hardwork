...
#define ti_sysbios_smp_SysStd_abort ti_sysbios_smp_SysStd_abort__F

/* exit */
#undef ti_sysbios_smp_SysStd_exit
#define ti_sysbios_smp_SysStd_exit ti_sysbios_smp_SysStd_exit__F

/* flush */
#undef ti_sysbios_smp_SysStd_flush
#define ti_sysbios_smp_SysStd_flush ti_sysbios_smp_SysStd_flush__F

/* putch */
#undef ti_sysbios_smp_SysStd_putch
#define ti_sysbios_smp_SysStd_putch ti_sysbios_smp_SysStd_putch__F

/* ready */
#undef ti_sysbios_smp_SysStd_ready
#define ti_sysbios_smp_SysStd_ready ti_sysbios_smp_SysStd_ready__F

/* Module_startup */
#undef ti_sysbios_smp_SysStd_Module_startup
#define ti_sysbios_smp_SysStd_Module_startup ti_sysbios_smp_SysStd_Module_startup__F

/* Instance_init */
#undef ti_sysbios_smp_SysStd_Instance_init
#define ti_sysbios_smp_SysStd_Instance_init ti_sysbios_smp_SysStd_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_smp_SysStd_Instance_finalize
#define ti_sysbios_smp_SysStd_Instance_finalize ti_sysbios_smp_SysStd_Instance_finalize__F
