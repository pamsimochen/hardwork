...
public class ti_sysbios_smp
{
    ...
    void Load$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("ti.sysbios.smp.Load.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("ti.sysbios.smp.Load", new Value.Obj("ti.sysbios.smp.Load", po));
        pkgV.bind("Load", vo);
        // decls 
        spo = (Proto.Obj)om.bind("ti.sysbios.smp.Load$$ModuleView", new Proto.Obj());
        om.bind("ti.sysbios.smp.Load.ModuleView", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.sysbios.smp.Load$$Stat", new Proto.Obj());
        om.bind("ti.sysbios.smp.Load.Stat", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.sysbios.smp.Load$$HookContext", new Proto.Obj());
        om.bind("ti.sysbios.smp.Load.HookContext", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.sysbios.smp.Load$$Module_State", new Proto.Obj());
        om.bind("ti.sysbios.smp.Load.Module_State", new Proto.Str(spo, false));
    }
    ...
    void LoggerBuf$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.smp.LoggerBuf.Object", new Proto.Str(po, false));
    ...
    void LoggerBuf_Module_GateProxy$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.smp.LoggerBuf_Module_GateProxy.Object", new Proto.Str(po, false));
    ...
    {
        // module Load
        om.bind("ti.sysbios.smp.Load.getTaskLoad", new Extern("ti_sysbios_smp_Load_getTaskLoad__E", "xdc_Bool(*)(ti_sysbios_knl_Task_Handle,ti_sysbios_smp_Load_Stat*)", true, false));
        om.bind("ti.sysbios.smp.Load.update", new Extern("ti_sysbios_smp_Load_update__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.smp.Load.reset", new Extern("ti_sysbios_smp_Load_reset__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.smp.Load.getGlobalSwiLoad", new Extern("ti_sysbios_smp_Load_getGlobalSwiLoad__E", "xdc_Bool(*)(ti_sysbios_smp_Load_Stat*)", true, false));
        om.bind("ti.sysbios.smp.Load.getGlobalHwiLoad", new Extern("ti_sysbios_smp_Load_getGlobalHwiLoad__E", "xdc_Bool(*)(ti_sysbios_smp_Load_Stat*)", true, false));
        om.bind("ti.sysbios.smp.Load.getCPULoad", new Extern("ti_sysbios_smp_Load_getCPULoad__E", "xdc_UInt32(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.smp.Load.calculateLoad", new Extern("ti_sysbios_smp_Load_calculateLoad__E", "xdc_UInt32(*)(ti_sysbios_smp_Load_Stat*)", true, false));
        om.bind("ti.sysbios.smp.Load.setMinIdle", new Extern("ti_sysbios_smp_Load_setMinIdle__E", "xdc_UInt32(*)(xdc_UInt32)", true, false));
        om.bind("ti.sysbios.smp.Load.addTask", new Extern("ti_sysbios_smp_Load_addTask__E", "xdc_Bool(*)(ti_sysbios_knl_Task_Handle,ti_sysbios_smp_Load_HookContext*)", true, false));
        om.bind("ti.sysbios.smp.Load.removeTask", new Extern("ti_sysbios_smp_Load_removeTask__E", "xdc_Bool(*)(ti_sysbios_knl_Task_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.idleFxn", new Extern("ti_sysbios_smp_Load_idleFxn__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.smp.Load.taskCreateHook", new Extern("ti_sysbios_smp_Load_taskCreateHook__E", "xdc_Void(*)(ti_sysbios_knl_Task_Handle,xdc_runtime_Error_Block*)", true, false));
        om.bind("ti.sysbios.smp.Load.taskDeleteHook", new Extern("ti_sysbios_smp_Load_taskDeleteHook__E", "xdc_Void(*)(ti_sysbios_knl_Task_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.taskSwitchHook", new Extern("ti_sysbios_smp_Load_taskSwitchHook__E", "xdc_Void(*)(ti_sysbios_knl_Task_Handle,ti_sysbios_knl_Task_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.swiBeginHook", new Extern("ti_sysbios_smp_Load_swiBeginHook__E", "xdc_Void(*)(ti_sysbios_knl_Swi_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.swiEndHook", new Extern("ti_sysbios_smp_Load_swiEndHook__E", "xdc_Void(*)(ti_sysbios_knl_Swi_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.hwiBeginHook", new Extern("ti_sysbios_smp_Load_hwiBeginHook__E", "xdc_Void(*)(ti_sysbios_interfaces_IHwi_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.hwiEndHook", new Extern("ti_sysbios_smp_Load_hwiEndHook__E", "xdc_Void(*)(ti_sysbios_interfaces_IHwi_Handle)", true, false));
        om.bind("ti.sysbios.smp.Load.taskRegHook", new Extern("ti_sysbios_smp_Load_taskRegHook__E", "xdc_Void(*)(xdc_Int)", true, false));
        om.bind("ti.sysbios.smp.Load.logLoads", new Extern("ti_sysbios_smp_Load_logLoads__I", "xdc_Void(*)(xdc_Void)", true, false));
    }
    ...
    void Load$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sysbios.smp.Load.Stat", "ti.sysbios.smp");
        sizes.clear();
        sizes.add(Global.newArray("threadTime", "UInt32"));
        sizes.add(Global.newArray("totalTime", "UInt32"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.smp.Load.Stat']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.smp.Load.Stat']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.smp.Load.Stat'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.sysbios.smp.Load.HookContext", "ti.sysbios.smp");
        sizes.clear();
        ...
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.smp.Load.HookContext']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.smp.Load.HookContext']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.smp.Load.HookContext'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.sysbios.smp.Load.Module_State", "ti.sysbios.smp");
        sizes.clear();
        ...
        sizes.add(Global.newArray("swiEnv", "Sti.sysbios.smp.Load;HookContext"));
        sizes.add(Global.newArray("swiCnt", "UInt32"));
        sizes.add(Global.newArray("hwiStartTime", "UInt32"));
        sizes.add(Global.newArray("hwiEnv", "Sti.sysbios.smp.Load;HookContext"));
        ...
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.smp.Load.Module_State']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.smp.Load.Module_State']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.smp.Load.Module_State'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void Load$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "ti/sysbios/smp/Load.xs");
        om.bind("ti.sysbios.smp.Load$$capsule", cap);
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load.Module", "ti.sysbios.smp");
        po.init("ti.sysbios.smp.Load.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.sysbios.smp"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
            po.addFld("rovViewInfo", (Proto)om.findStrict("xdc.rov.ViewInfo.Instance", "ti.sysbios.smp"), $$UNDEF, "wh");
            po.addFld("LS_cpuLoad", (Proto)om.findStrict("xdc.runtime.Log$$Event", "ti.sysbios.smp"), Global.newObject("mask", 0x0800L, "msg", "LS_cpuLoad: %d%%"), "w");
            po.addFld("LS_hwiLoad", (Proto)om.findStrict("xdc.runtime.Log$$Event", "ti.sysbios.smp"), Global.newObject("mask", 0x0800L, "msg", "LS_hwiLoad: %d,%d"), "w");
            po.addFld("LS_swiLoad", (Proto)om.findStrict("xdc.runtime.Log$$Event", "ti.sysbios.smp"), Global.newObject("mask", 0x0800L, "msg", "LS_swiLoad: %d,%d"), "w");
            po.addFld("LS_taskLoad", (Proto)om.findStrict("xdc.runtime.Log$$Event", "ti.sysbios.smp"), Global.newObject("mask", 0x0800L, "msg", "LS_taskLoad: 0x%x,%d,%d,0x%x"), "w");
        ...
        if (fxn != null) om.bind("ti.sysbios.smp.Load$$module$use", true);
        if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
        fxn = Global.get(cap, "module$meta$init");
        if (fxn != null) om.bind("ti.sysbios.smp.Load$$module$meta$init", true);
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$static$init");
        if (fxn != null) om.bind("ti.sysbios.smp.Load$$module$static$init", true);
        if (fxn != null) po.addFxn("module$static$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        if (fxn != null) om.bind("ti.sysbios.smp.Load$$module$validate", true);
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
        // struct Load.ModuleView
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$ModuleView", "ti.sysbios.smp");
        po.init("ti.sysbios.smp.Load.ModuleView", null);
        ...
        om.bind("ti.sysbios.smp.Load.FuncPtr", new Proto.Adr("xdc_Void(*)(xdc_Void)", "PFv"));
        // struct Load.Stat
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$Stat", "ti.sysbios.smp");
        po.init("ti.sysbios.smp.Load.Stat", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$HookContext", "ti.sysbios.smp");
        po.init("ti.sysbios.smp.Load.HookContext", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("qElem", (Proto)om.findStrict("ti.sysbios.knl.Queue.Elem", "ti.sysbios.smp"), $$DEFAULT, "w");
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$Module_State", "ti.sysbios.smp");
        po.init("ti.sysbios.smp.Load.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                ...
                po.addFld("runningTask", new Proto.Arr((Proto)om.findStrict("ti.sysbios.knl.Task.Handle", "ti.sysbios.smp"), false), $$DEFAULT, "w");
                po.addFld("firstSwitchDone", $$T_Bool, $$UNDEF, "w");
                po.addFld("swiStartTime", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("swiEnv", (Proto)om.findStrict("ti.sysbios.smp.Load.HookContext", "ti.sysbios.smp"), $$DEFAULT, "w");
                po.addFld("swiCnt", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("hwiStartTime", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("hwiEnv", (Proto)om.findStrict("ti.sysbios.smp.Load.HookContext", "ti.sysbios.smp"), $$DEFAULT, "w");
                ...
                po.addFldV("taskList", (Proto)om.findStrict("ti.sysbios.knl.Queue.Object", "ti.sysbios.smp"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_taskList", (Proto)om.findStrict("ti.sysbios.knl.Queue.Object", "ti.sysbios.smp"), $$DEFAULT, "w");
                po.addFldV("gate", (Proto)om.findStrict("ti.sysbios.gates.GateMutex.Object", "ti.sysbios.smp"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_gate", (Proto)om.findStrict("ti.sysbios.gates.GateMutex.Object", "ti.sysbios.smp"), $$DEFAULT, "w");
    }
    ...
    void Load$$ROV()
    {
        ...
        vo = (Value.Obj)om.findStrict("ti.sysbios.smp.Load", "ti.sysbios.smp");
        vo.bind("Stat$fetchDesc", Global.newObject("type", "ti.sysbios.smp.Load.Stat", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$Stat", "ti.sysbios.smp");
        vo.bind("HookContext$fetchDesc", Global.newObject("type", "ti.sysbios.smp.Load.HookContext", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$HookContext", "ti.sysbios.smp");
        vo.bind("Module_State$fetchDesc", Global.newObject("type", "ti.sysbios.smp.Load.Module_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load$$Module_State", "ti.sysbios.smp");
    ...
    void Load$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("ti.sysbios.smp.Load", "ti.sysbios.smp");
        po = (Proto.Obj)om.findStrict("ti.sysbios.smp.Load.Module", "ti.sysbios.smp");
        vo.init2(po, "ti.sysbios.smp.Load", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.findStrict("ti.sysbios.smp.Load$$capsule", "ti.sysbios.smp"));
        ...
        vo.bind("ModuleView", om.findStrict("ti.sysbios.smp.Load.ModuleView", "ti.sysbios.smp"));
        tdefs.add(om.findStrict("ti.sysbios.smp.Load.ModuleView", "ti.sysbios.smp"));
        vo.bind("FuncPtr", om.findStrict("ti.sysbios.smp.Load.FuncPtr", "ti.sysbios.smp"));
        vo.bind("Stat", om.findStrict("ti.sysbios.smp.Load.Stat", "ti.sysbios.smp"));
        tdefs.add(om.findStrict("ti.sysbios.smp.Load.Stat", "ti.sysbios.smp"));
        ...
        vo.bind("HookContext", om.findStrict("ti.sysbios.smp.Load.HookContext", "ti.sysbios.smp"));
        tdefs.add(om.findStrict("ti.sysbios.smp.Load.HookContext", "ti.sysbios.smp"));
        mcfgs.add("autoAddTasks");
        icfgs.add("autoAddTasks");
        vo.bind("Module_State", om.findStrict("ti.sysbios.smp.Load.Module_State", "ti.sysbios.smp"));
        tdefs.add(om.findStrict("ti.sysbios.smp.Load.Module_State", "ti.sysbios.smp"));
        ...
        vo.bind("getTaskLoad", om.findStrict("ti.sysbios.smp.Load.getTaskLoad", "ti.sysbios.smp"));
        vo.bind("update", om.findStrict("ti.sysbios.smp.Load.update", "ti.sysbios.smp"));
        vo.bind("reset", om.findStrict("ti.sysbios.smp.Load.reset", "ti.sysbios.smp"));
        vo.bind("getGlobalSwiLoad", om.findStrict("ti.sysbios.smp.Load.getGlobalSwiLoad", "ti.sysbios.smp"));
        vo.bind("getGlobalHwiLoad", om.findStrict("ti.sysbios.smp.Load.getGlobalHwiLoad", "ti.sysbios.smp"));
        vo.bind("getCPULoad", om.findStrict("ti.sysbios.smp.Load.getCPULoad", "ti.sysbios.smp"));
        vo.bind("calculateLoad", om.findStrict("ti.sysbios.smp.Load.calculateLoad", "ti.sysbios.smp"));
        vo.bind("setMinIdle", om.findStrict("ti.sysbios.smp.Load.setMinIdle", "ti.sysbios.smp"));
        vo.bind("addTask", om.findStrict("ti.sysbios.smp.Load.addTask", "ti.sysbios.smp"));
        vo.bind("removeTask", om.findStrict("ti.sysbios.smp.Load.removeTask", "ti.sysbios.smp"));
        vo.bind("idleFxn", om.findStrict("ti.sysbios.smp.Load.idleFxn", "ti.sysbios.smp"));
        vo.bind("taskCreateHook", om.findStrict("ti.sysbios.smp.Load.taskCreateHook", "ti.sysbios.smp"));
        vo.bind("taskDeleteHook", om.findStrict("ti.sysbios.smp.Load.taskDeleteHook", "ti.sysbios.smp"));
        vo.bind("taskSwitchHook", om.findStrict("ti.sysbios.smp.Load.taskSwitchHook", "ti.sysbios.smp"));
        vo.bind("swiBeginHook", om.findStrict("ti.sysbios.smp.Load.swiBeginHook", "ti.sysbios.smp"));
        vo.bind("swiEndHook", om.findStrict("ti.sysbios.smp.Load.swiEndHook", "ti.sysbios.smp"));
        vo.bind("hwiBeginHook", om.findStrict("ti.sysbios.smp.Load.hwiBeginHook", "ti.sysbios.smp"));
        vo.bind("hwiEndHook", om.findStrict("ti.sysbios.smp.Load.hwiEndHook", "ti.sysbios.smp"));
        vo.bind("taskRegHook", om.findStrict("ti.sysbios.smp.Load.taskRegHook", "ti.sysbios.smp"));
        vo.bind("logLoads", om.findStrict("ti.sysbios.smp.Load.logLoads", "ti.sysbios.smp"));
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_smp_Load_Module__startupDone__E", "ti_sysbios_smp_Load_getTaskLoad__E", "ti_sysbios_smp_Load_update__E", "ti_sysbios_smp_Load_reset__E", "ti_sysbios_smp_Load_getGlobalSwiLoad__E", "ti_sysbios_smp_Load_getGlobalHwiLoad__E", "ti_sysbios_smp_Load_getCPULoad__E", "ti_sysbios_smp_Load_calculateLoad__E", "ti_sysbios_smp_Load_setMinIdle__E", "ti_sysbios_smp_Load_addTask__E", "ti_sysbios_smp_Load_removeTask__E", "ti_sysbios_smp_Load_idleFxn__E", "ti_sysbios_smp_Load_taskCreateHook__E", "ti_sysbios_smp_Load_taskDeleteHook__E", "ti_sysbios_smp_Load_taskSwitchHook__E", "ti_sysbios_smp_Load_swiBeginHook__E", "ti_sysbios_smp_Load_swiEndHook__E", "ti_sysbios_smp_Load_hwiBeginHook__E", "ti_sysbios_smp_Load_hwiEndHook__E", "ti_sysbios_smp_Load_taskRegHook__E"));
    ...
    void SysMin$$SINGLETONS()
    {
        ...
        vo.bind("PROXY$", 0);
        loggables.clear();
        loggables.add(Global.newObject("name", "abort", "entry", "0x%x", "exit", ""));
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.sysbios.smp.Load", "ti.sysbios.smp"));
        ...
        ((Value.Obj)om.getv("ti.sysbios.smp.Load")).bless();
