...
public class ti_sysbios_fatfs
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/release/ti.sysbios.fatfs.ar430XS',\n");
            ...
            sb.append("'lib/release/ti.sysbios.fatfs.aearp32F',\n");
            ...
            sb.append("'lib/release/ti.sysbios.fatfs.am4fg',\n");
            sb.append("'lib/release/ti.sysbios.fatfs.aa8fg',\n");
            sb.append("'lib/release/ti.sysbios.fatfs.aa9fg',\n");
            sb.append("'lib/release/ti.sysbios.fatfs.aa15fg',\n");
            sb.append("'lib/release/ti.sysbios.fatfs.arm3',\n");
            sb.append("'lib/release/ti.sysbios.fatfs.arm4',\n");
            sb.append("'lib/release/ti.sysbios.fatfs.arm4f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/release/ti.sysbios.fatfs.ar430XS', {target: 'iar.targets.msp430.MSP430X_small', suffix: 'r430XS'}],\n");
            ...
            sb.append("['lib/release/ti.sysbios.fatfs.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
            ...
            sb.append("['lib/release/ti.sysbios.fatfs.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/release/ti.sysbios.fatfs.aa8fg', {target: 'gnu.targets.arm.A8F', suffix: 'a8fg'}],\n");
            sb.append("['lib/release/ti.sysbios.fatfs.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
            sb.append("['lib/release/ti.sysbios.fatfs.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            ...
            sb.append("['lib/release/ti.sysbios.fatfs.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
        sb.append("];\n");
