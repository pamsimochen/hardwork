...
#define ti_sysbios_heaps_HeapTrack_alloc ti_sysbios_heaps_HeapTrack_alloc__F

/* free */
#undef ti_sysbios_heaps_HeapTrack_free
#define ti_sysbios_heaps_HeapTrack_free ti_sysbios_heaps_HeapTrack_free__F

/* isBlocking */
#undef ti_sysbios_heaps_HeapTrack_isBlocking
#define ti_sysbios_heaps_HeapTrack_isBlocking ti_sysbios_heaps_HeapTrack_isBlocking__F

/* getStats */
#undef ti_sysbios_heaps_HeapTrack_getStats
#define ti_sysbios_heaps_HeapTrack_getStats ti_sysbios_heaps_HeapTrack_getStats__F

/* printTask */
#undef ti_sysbios_heaps_HeapTrack_printTask
#define ti_sysbios_heaps_HeapTrack_printTask ti_sysbios_heaps_HeapTrack_printTask__F

/* printHeap */
#undef ti_sysbios_heaps_HeapTrack_printHeap
#define ti_sysbios_heaps_HeapTrack_printHeap ti_sysbios_heaps_HeapTrack_printHeap__F
...
#define ti_sysbios_heaps_HeapTrack_Module_startup ti_sysbios_heaps_HeapTrack_Module_startup__F

/* Instance_init */
#undef ti_sysbios_heaps_HeapTrack_Instance_init
#define ti_sysbios_heaps_HeapTrack_Instance_init ti_sysbios_heaps_HeapTrack_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_heaps_HeapTrack_Instance_finalize
#define ti_sysbios_heaps_HeapTrack_Instance_finalize ti_sysbios_heaps_HeapTrack_Instance_finalize__F
