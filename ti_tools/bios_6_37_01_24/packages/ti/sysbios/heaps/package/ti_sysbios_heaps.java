...
public class ti_sysbios_heaps
{
    ...
    void HeapTrack$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapTrack.Object", new Proto.Str(po, false));
    ...
    void HeapCallback$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.heaps.HeapCallback.Object", new Proto.Str(po, false));
    ...
    void HeapTrack$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.heaps.HeapTrack.printTrack", new Extern("ti_sysbios_heaps_HeapTrack_printTrack__I", "xdc_Void(*)(ti_sysbios_heaps_HeapTrack_Tracker*,ti_sysbios_heaps_HeapTrack_Handle)", true, false));
    }
    ...
    void HeapTrack$$TYPES()
    {
        ...
        po.init("ti.sysbios.heaps.HeapTrack.BasicView", null);
                ...
                po.addFld("heapSize", $$T_Str, $$UNDEF, "w");
                po.addFld("heapPeak", $$T_Str, $$UNDEF, "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.a64P',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.a64Pe',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.a674',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ae430X',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ae430XS',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ar430XS',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ae64P',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ae64Pe',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ae674',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.ae64T',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.heaps.aea8f',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.ae430X', {target: 'ti.targets.msp430.elf.MSP430X', suffix: 'e430X'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.ae430XS', {target: 'ti.targets.msp430.elf.MSP430X_small', suffix: 'e430XS'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.heaps.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
    ...
    void HeapBuf$$SINGLETONS()
    {
        ...
        vo.bind("$$assertDescCfgs", Global.newArray("A_nullBuf", "A_bufAlign", "A_invalidAlign", "A_invalidRequestedAlign", "A_zeroBlockSize", "A_zeroBlocks", "A_zeroBufSize", "A_invalidBufSize", "A_noBlocksToFree", "A_invalidFree"));
    ...
    void HeapTrack$$SINGLETONS()
    {
        ...
        loggables.add(Global.newObject("name", "isBlocking", "entry", "%p", "exit", "%d"));
        loggables.add(Global.newObject("name", "getStats", "entry", "%p, %p", "exit", ""));
        loggables.add(Global.newObject("name", "printTask", "entry", "%p", "exit", ""));
        loggables.add(Global.newObject("name", "printHeap", "entry", "%p", "exit", ""));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("HeapTrack", vo);
    ...
    void HeapCallback$$SINGLETONS()
    {
        ...
        loggables.add(Global.newObject("name", "isBlocking", "entry", "%p", "exit", "%d"));
        loggables.add(Global.newObject("name", "getStats", "entry", "%p, %p", "exit", ""));
        loggables.add(Global.newObject("name", "getContext", "entry", "%p", "exit", "%p"));
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("HeapCallback", vo);
