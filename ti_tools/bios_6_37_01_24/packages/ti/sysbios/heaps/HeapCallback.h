...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Instance_init__F, "ti_sysbios_heaps_HeapCallback_Instance_init")
__extern void ti_sysbios_heaps_HeapCallback_Instance_init__F( ti_sysbios_heaps_HeapCallback_Object*, const ti_sysbios_heaps_HeapCallback_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Instance_finalize__F, "ti_sysbios_heaps_HeapCallback_Instance_finalize")
__extern void ti_sysbios_heaps_HeapCallback_Instance_finalize__F( ti_sysbios_heaps_HeapCallback_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Instance_init__R, "ti_sysbios_heaps_HeapCallback_Instance_init")
__extern void ti_sysbios_heaps_HeapCallback_Instance_init__R( ti_sysbios_heaps_HeapCallback_Object*, const ti_sysbios_heaps_HeapCallback_Params* );
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Handle__label__S, "ti_sysbios_heaps_HeapCallback_Handle__label")
...
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Module__startupDone__S, "ti_sysbios_heaps_HeapCallback_Module__startupDone")
__extern xdc_Bool ti_sysbios_heaps_HeapCallback_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Object__create__S, "ti_sysbios_heaps_HeapCallback_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Object__delete__S, "ti_sysbios_heaps_HeapCallback_Object__delete")
__extern xdc_Void ti_sysbios_heaps_HeapCallback_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Object__destruct__S, "ti_sysbios_heaps_HeapCallback_Object__destruct")
__extern xdc_Void ti_sysbios_heaps_HeapCallback_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Object__get__S, "ti_sysbios_heaps_HeapCallback_Object__get")
__extern xdc_Ptr ti_sysbios_heaps_HeapCallback_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Object__first__S, "ti_sysbios_heaps_HeapCallback_Object__first")
__extern xdc_Ptr ti_sysbios_heaps_HeapCallback_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Object__next__S, "ti_sysbios_heaps_HeapCallback_Object__next")
__extern xdc_Ptr ti_sysbios_heaps_HeapCallback_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Params__init__S, "ti_sysbios_heaps_HeapCallback_Params__init")
...
/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_heaps_HeapCallback_alloc_FxnT)(void*, xdc_SizeT, xdc_SizeT, xdc_runtime_Error_Block*);
static inline ti_sysbios_heaps_HeapCallback_alloc_FxnT ti_sysbios_heaps_HeapCallback_alloc_fxnP( void )
{
    return (ti_sysbios_heaps_HeapCallback_alloc_FxnT)ti_sysbios_heaps_HeapCallback_alloc; 
}

/* free_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapCallback_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline ti_sysbios_heaps_HeapCallback_free_FxnT ti_sysbios_heaps_HeapCallback_free_fxnP( void )
{
    return (ti_sysbios_heaps_HeapCallback_free_FxnT)ti_sysbios_heaps_HeapCallback_free; 
}

/* isBlocking_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_heaps_HeapCallback_isBlocking_FxnT)(void*);
static inline ti_sysbios_heaps_HeapCallback_isBlocking_FxnT ti_sysbios_heaps_HeapCallback_isBlocking_fxnP( void )
{
    return (ti_sysbios_heaps_HeapCallback_isBlocking_FxnT)ti_sysbios_heaps_HeapCallback_isBlocking; 
}

/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapCallback_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline ti_sysbios_heaps_HeapCallback_getStats_FxnT ti_sysbios_heaps_HeapCallback_getStats_fxnP( void )
{
    return (ti_sysbios_heaps_HeapCallback_getStats_FxnT)ti_sysbios_heaps_HeapCallback_getStats; 
}

/* getContext_{FxnT,fxnP} */
typedef xdc_UArg (*ti_sysbios_heaps_HeapCallback_getContext_FxnT)(void*);
static inline ti_sysbios_heaps_HeapCallback_getContext_FxnT ti_sysbios_heaps_HeapCallback_getContext_fxnP( void )
{
    return (ti_sysbios_heaps_HeapCallback_getContext_FxnT)ti_sysbios_heaps_HeapCallback_getContext; 
}
...
/* create */
static inline ti_sysbios_heaps_HeapCallback_Handle ti_sysbios_heaps_HeapCallback_create( const ti_sysbios_heaps_HeapCallback_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sysbios_heaps_HeapCallback_Handle)ti_sysbios_heaps_HeapCallback_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_heaps_HeapCallback_Params), __eb);
}

/* construct */
static inline void ti_sysbios_heaps_HeapCallback_construct( ti_sysbios_heaps_HeapCallback_Struct* __obj, const ti_sysbios_heaps_HeapCallback_Params* __prms )
{
    ti_sysbios_heaps_HeapCallback_Object__create__S(__obj, sizeof (ti_sysbios_heaps_HeapCallback_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_heaps_HeapCallback_Params), NULL);
}

/* delete */
static inline void ti_sysbios_heaps_HeapCallback_delete( ti_sysbios_heaps_HeapCallback_Handle* instp )
{
    ti_sysbios_heaps_HeapCallback_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_heaps_HeapCallback_destruct( ti_sysbios_heaps_HeapCallback_Struct* obj )
{
    ti_sysbios_heaps_HeapCallback_Object__destruct__S(obj);
}
...
#define HeapCallback_alloc_fxnP ti_sysbios_heaps_HeapCallback_alloc_fxnP
#define HeapCallback_alloc_FxnT ti_sysbios_heaps_HeapCallback_alloc_FxnT
#define HeapCallback_free ti_sysbios_heaps_HeapCallback_free
#define HeapCallback_free_fxnP ti_sysbios_heaps_HeapCallback_free_fxnP
#define HeapCallback_free_FxnT ti_sysbios_heaps_HeapCallback_free_FxnT
#define HeapCallback_isBlocking ti_sysbios_heaps_HeapCallback_isBlocking
#define HeapCallback_isBlocking_fxnP ti_sysbios_heaps_HeapCallback_isBlocking_fxnP
#define HeapCallback_isBlocking_FxnT ti_sysbios_heaps_HeapCallback_isBlocking_FxnT
#define HeapCallback_getStats ti_sysbios_heaps_HeapCallback_getStats
#define HeapCallback_getStats_fxnP ti_sysbios_heaps_HeapCallback_getStats_fxnP
#define HeapCallback_getStats_FxnT ti_sysbios_heaps_HeapCallback_getStats_FxnT
#define HeapCallback_getContext ti_sysbios_heaps_HeapCallback_getContext
#define HeapCallback_getContext_fxnP ti_sysbios_heaps_HeapCallback_getContext_fxnP
#define HeapCallback_getContext_FxnT ti_sysbios_heaps_HeapCallback_getContext_FxnT
