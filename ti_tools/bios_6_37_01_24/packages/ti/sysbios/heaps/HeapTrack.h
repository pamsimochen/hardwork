...
/* Instance_init__F */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Instance_init__F, "ti_sysbios_heaps_HeapTrack_Instance_init")
__extern void ti_sysbios_heaps_HeapTrack_Instance_init__F( ti_sysbios_heaps_HeapTrack_Object*, const ti_sysbios_heaps_HeapTrack_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Instance_finalize__F, "ti_sysbios_heaps_HeapTrack_Instance_finalize")
__extern void ti_sysbios_heaps_HeapTrack_Instance_finalize__F( ti_sysbios_heaps_HeapTrack_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Instance_init__R, "ti_sysbios_heaps_HeapTrack_Instance_init")
__extern void ti_sysbios_heaps_HeapTrack_Instance_init__R( ti_sysbios_heaps_HeapTrack_Object*, const ti_sysbios_heaps_HeapTrack_Params* );
...
/* Handle__label__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Handle__label__S, "ti_sysbios_heaps_HeapTrack_Handle__label")
__extern xdc_runtime_Types_Label* ti_sysbios_heaps_HeapTrack_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Module__startupDone__S, "ti_sysbios_heaps_HeapTrack_Module__startupDone")
__extern xdc_Bool ti_sysbios_heaps_HeapTrack_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Object__create__S, "ti_sysbios_heaps_HeapTrack_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Object__delete__S, "ti_sysbios_heaps_HeapTrack_Object__delete")
__extern xdc_Void ti_sysbios_heaps_HeapTrack_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Object__destruct__S, "ti_sysbios_heaps_HeapTrack_Object__destruct")
__extern xdc_Void ti_sysbios_heaps_HeapTrack_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Object__get__S, "ti_sysbios_heaps_HeapTrack_Object__get")
__extern xdc_Ptr ti_sysbios_heaps_HeapTrack_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Object__first__S, "ti_sysbios_heaps_HeapTrack_Object__first")
__extern xdc_Ptr ti_sysbios_heaps_HeapTrack_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Object__next__S, "ti_sysbios_heaps_HeapTrack_Object__next")
__extern xdc_Ptr ti_sysbios_heaps_HeapTrack_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_heaps_HeapTrack_Params__init__S, "ti_sysbios_heaps_HeapTrack_Params__init")
...
/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sysbios_heaps_HeapTrack_alloc_FxnT)(void*, xdc_SizeT, xdc_SizeT, xdc_runtime_Error_Block*);
static inline ti_sysbios_heaps_HeapTrack_alloc_FxnT ti_sysbios_heaps_HeapTrack_alloc_fxnP( void )
{
    return (ti_sysbios_heaps_HeapTrack_alloc_FxnT)ti_sysbios_heaps_HeapTrack_alloc; 
}

/* free_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapTrack_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline ti_sysbios_heaps_HeapTrack_free_FxnT ti_sysbios_heaps_HeapTrack_free_fxnP( void )
{
    return (ti_sysbios_heaps_HeapTrack_free_FxnT)ti_sysbios_heaps_HeapTrack_free; 
}

/* isBlocking_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sysbios_heaps_HeapTrack_isBlocking_FxnT)(void*);
static inline ti_sysbios_heaps_HeapTrack_isBlocking_FxnT ti_sysbios_heaps_HeapTrack_isBlocking_fxnP( void )
{
    return (ti_sysbios_heaps_HeapTrack_isBlocking_FxnT)ti_sysbios_heaps_HeapTrack_isBlocking; 
}

/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapTrack_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline ti_sysbios_heaps_HeapTrack_getStats_FxnT ti_sysbios_heaps_HeapTrack_getStats_fxnP( void )
{
    return (ti_sysbios_heaps_HeapTrack_getStats_FxnT)ti_sysbios_heaps_HeapTrack_getStats; 
}

/* printHeap_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_heaps_HeapTrack_printHeap_FxnT)(void*);
static inline ti_sysbios_heaps_HeapTrack_printHeap_FxnT ti_sysbios_heaps_HeapTrack_printHeap_fxnP( void )
{
    return (ti_sysbios_heaps_HeapTrack_printHeap_FxnT)ti_sysbios_heaps_HeapTrack_printHeap; 
}
...
/* create */
static inline ti_sysbios_heaps_HeapTrack_Handle ti_sysbios_heaps_HeapTrack_create( const ti_sysbios_heaps_HeapTrack_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sysbios_heaps_HeapTrack_Handle)ti_sysbios_heaps_HeapTrack_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_heaps_HeapTrack_Params), __eb);
}

/* construct */
static inline void ti_sysbios_heaps_HeapTrack_construct( ti_sysbios_heaps_HeapTrack_Struct* __obj, const ti_sysbios_heaps_HeapTrack_Params* __prms )
{
    ti_sysbios_heaps_HeapTrack_Object__create__S(__obj, sizeof (ti_sysbios_heaps_HeapTrack_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sysbios_heaps_HeapTrack_Params), NULL);
}

/* delete */
static inline void ti_sysbios_heaps_HeapTrack_delete( ti_sysbios_heaps_HeapTrack_Handle* instp )
{
    ti_sysbios_heaps_HeapTrack_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sysbios_heaps_HeapTrack_destruct( ti_sysbios_heaps_HeapTrack_Struct* obj )
{
...
#define HeapTrack_alloc_fxnP ti_sysbios_heaps_HeapTrack_alloc_fxnP
#define HeapTrack_alloc_FxnT ti_sysbios_heaps_HeapTrack_alloc_FxnT
#define HeapTrack_free ti_sysbios_heaps_HeapTrack_free
#define HeapTrack_free_fxnP ti_sysbios_heaps_HeapTrack_free_fxnP
#define HeapTrack_free_FxnT ti_sysbios_heaps_HeapTrack_free_FxnT
#define HeapTrack_isBlocking ti_sysbios_heaps_HeapTrack_isBlocking
#define HeapTrack_isBlocking_fxnP ti_sysbios_heaps_HeapTrack_isBlocking_fxnP
#define HeapTrack_isBlocking_FxnT ti_sysbios_heaps_HeapTrack_isBlocking_FxnT
#define HeapTrack_getStats ti_sysbios_heaps_HeapTrack_getStats
#define HeapTrack_getStats_fxnP ti_sysbios_heaps_HeapTrack_getStats_fxnP
#define HeapTrack_getStats_FxnT ti_sysbios_heaps_HeapTrack_getStats_FxnT
...
#define HeapTrack_printHeap_fxnP ti_sysbios_heaps_HeapTrack_printHeap_fxnP
#define HeapTrack_printHeap_FxnT ti_sysbios_heaps_HeapTrack_printHeap_FxnT
