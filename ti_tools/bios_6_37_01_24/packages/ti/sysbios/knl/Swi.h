...
__extern int ti_sysbios_knl_Swi_Instance_init__F( ti_sysbios_knl_Swi_Object*, ti_sysbios_knl_Swi_FuncPtr swiFxn, const ti_sysbios_knl_Swi_Params*, xdc_runtime_Error_Block* );
...
__extern int ti_sysbios_knl_Swi_Instance_init__R( ti_sysbios_knl_Swi_Object*, ti_sysbios_knl_Swi_FuncPtr swiFxn, const ti_sysbios_knl_Swi_Params*, xdc_runtime_Error_Block* );
...
/* getAttrs_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Swi_getAttrs_FxnT)(void*, ti_sysbios_knl_Swi_FuncPtr*, ti_sysbios_knl_Swi_Params*);
static inline ti_sysbios_knl_Swi_getAttrs_FxnT ti_sysbios_knl_Swi_getAttrs_fxnP( void )
{
    return (ti_sysbios_knl_Swi_getAttrs_FxnT)ti_sysbios_knl_Swi_getAttrs; 
}

/* setAttrs_{FxnT,fxnP} */
typedef xdc_Void (*ti_sysbios_knl_Swi_setAttrs_FxnT)(void*, ti_sysbios_knl_Swi_FuncPtr, ti_sysbios_knl_Swi_Params*);
static inline ti_sysbios_knl_Swi_setAttrs_FxnT ti_sysbios_knl_Swi_setAttrs_fxnP( void )
{
    return (ti_sysbios_knl_Swi_setAttrs_FxnT)ti_sysbios_knl_Swi_setAttrs; 
}
...
/* create */
static inline ti_sysbios_knl_Swi_Handle ti_sysbios_knl_Swi_create( ti_sysbios_knl_Swi_FuncPtr swiFxn, const ti_sysbios_knl_Swi_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_knl_Swi_Args__create __args;
    __args.swiFxn = swiFxn;
...
/* construct */
static inline void ti_sysbios_knl_Swi_construct( ti_sysbios_knl_Swi_Struct* __obj, ti_sysbios_knl_Swi_FuncPtr swiFxn, const ti_sysbios_knl_Swi_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sysbios_knl_Swi_Args__create __args;
    __args.swiFxn = swiFxn;
...
#define Swi_getAttrs_fxnP ti_sysbios_knl_Swi_getAttrs_fxnP
#define Swi_getAttrs_FxnT ti_sysbios_knl_Swi_getAttrs_FxnT
#define Swi_setAttrs ti_sysbios_knl_Swi_setAttrs
#define Swi_setAttrs_fxnP ti_sysbios_knl_Swi_setAttrs_fxnP
#define Swi_setAttrs_FxnT ti_sysbios_knl_Swi_setAttrs_FxnT
