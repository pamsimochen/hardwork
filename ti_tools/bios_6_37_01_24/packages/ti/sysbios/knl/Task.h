...
/* getFunc_{FxnT,fxnP} */
typedef ti_sysbios_knl_Task_FuncPtr (*ti_sysbios_knl_Task_getFunc_FxnT)(void*, xdc_UArg*, xdc_UArg*);
static inline ti_sysbios_knl_Task_getFunc_FxnT ti_sysbios_knl_Task_getFunc_fxnP( void )
{
    return (ti_sysbios_knl_Task_getFunc_FxnT)ti_sysbios_knl_Task_getFunc; 
}
...
/* setAffinity_{FxnT,fxnP} */
typedef xdc_UInt (*ti_sysbios_knl_Task_setAffinity_FxnT)(void*, xdc_UInt);
static inline ti_sysbios_knl_Task_setAffinity_FxnT ti_sysbios_knl_Task_setAffinity_fxnP( void )
{
    return (ti_sysbios_knl_Task_setAffinity_FxnT)ti_sysbios_knl_Task_setAffinity; 
}

/* getAffinity_{FxnT,fxnP} */
typedef xdc_UInt (*ti_sysbios_knl_Task_getAffinity_FxnT)(void*);
static inline ti_sysbios_knl_Task_getAffinity_FxnT ti_sysbios_knl_Task_getAffinity_fxnP( void )
{
    return (ti_sysbios_knl_Task_getAffinity_FxnT)ti_sysbios_knl_Task_getAffinity; 
}
...
#define Task_getFunc_fxnP ti_sysbios_knl_Task_getFunc_fxnP
#define Task_getFunc_FxnT ti_sysbios_knl_Task_getFunc_FxnT
...
#define Task_setAffinity_fxnP ti_sysbios_knl_Task_setAffinity_fxnP
#define Task_setAffinity_FxnT ti_sysbios_knl_Task_setAffinity_FxnT
#define Task_getAffinity ti_sysbios_knl_Task_getAffinity
#define Task_getAffinity_fxnP ti_sysbios_knl_Task_getAffinity_fxnP
#define Task_getAffinity_FxnT ti_sysbios_knl_Task_getAffinity_FxnT
