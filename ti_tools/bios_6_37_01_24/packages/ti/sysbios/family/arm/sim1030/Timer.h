...
#define ti_sysbios_family_arm_sim1030_Timer___VERS 160
...
__extern xdc_Void ti_sysbios_family_arm_sim1030_Timer_Params__init__S( xdc_Ptr dst, const xdc_Void* src, xdc_SizeT psz, xdc_SizeT isz );
...
{
    if (dst) {
        ti_sysbios_family_arm_sim1030_Timer_Params__init__S(dst, (const void *)src, sizeof(ti_sysbios_family_arm_sim1030_Timer_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
