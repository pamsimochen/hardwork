...
xdc__CODESECT(ti_sysbios_family_arm_a8_intcps_Hwi_clearPostedInterrupt__F, "ti_sysbios_family_arm_a8_intcps_Hwi_clearPostedInterrupt")
__extern xdc_Void ti_sysbios_family_arm_a8_intcps_Hwi_clearPostedInterrupt__F( xdc_UInt intNum );
__extern xdc_Void ti_sysbios_family_arm_a8_intcps_Hwi_clearPostedInterrupt__R( xdc_UInt intNum );
