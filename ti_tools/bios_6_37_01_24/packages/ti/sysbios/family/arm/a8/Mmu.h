...
xdc__CODESECT(ti_sysbios_family_arm_a8_Mmu_getPhysicalAddr__F, "ti_sysbios_family_arm_a8_Mmu_getPhysicalAddr")
__extern xdc_Ptr ti_sysbios_family_arm_a8_Mmu_getPhysicalAddr__F( xdc_Ptr virtualAddr );
__extern xdc_Ptr ti_sysbios_family_arm_a8_Mmu_getPhysicalAddr__R( xdc_Ptr virtualAddr );
