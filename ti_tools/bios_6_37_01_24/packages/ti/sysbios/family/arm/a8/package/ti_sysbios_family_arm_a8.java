...
public class ti_sysbios_family_arm_a8
{
    ...
    void Mmu$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("defaultAttrs", (Proto)om.findStrict("ti.sysbios.family.arm.a8.Mmu.FirstLevelDescAttrs", "ti.sysbios.family.arm.a8"), Global.newObject("type", om.find("ti.sysbios.family.arm.a8.Mmu.FirstLevelDesc_SECTION"), "bufferable", false, "cacheable", false, "shareable", false, "noexecute", false, "imp", 1L, "domain", 0L, "accPerm", 3L, "tex", 1L), "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.a8.aea8f',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.a8.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
    ...
    void Mmu$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_a8_Mmu_Module__startupDone__E", "ti_sysbios_family_arm_a8_Mmu_disable__E", "ti_sysbios_family_arm_a8_Mmu_enable__E", "ti_sysbios_family_arm_a8_Mmu_initDescAttrs__E", "ti_sysbios_family_arm_a8_Mmu_isEnabled__E", "ti_sysbios_family_arm_a8_Mmu_setFirstLevelDesc__E", "ti_sysbios_family_arm_a8_Mmu_getPhysicalAddr__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
