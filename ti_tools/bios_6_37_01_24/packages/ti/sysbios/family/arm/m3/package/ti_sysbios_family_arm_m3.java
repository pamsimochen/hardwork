...
public class ti_sysbios_family_arm_m3
{
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.m3.Hwi.initEnables", new Extern("ti_sysbios_family_arm_m3_Hwi_initEnables__I", "xdc_Void(*)(xdc_Void)", true, false));
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        mcfgs.add("priGroup");
        mcfgs.add("dispatchTable");
        icfgs.add("dispatchTable");
        mcfgs.add("priorities");
        icfgs.add("priorities");
        icfgs.add("isTiva");
        ...
        vo.bind("initEnables", om.findStrict("ti.sysbios.family.arm.m3.Hwi.initEnables", "ti.sysbios.family.arm.m3"));
