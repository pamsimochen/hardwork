...
public class ti_sysbios_family_arm_systimer
{
    ...
    void Timer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arm.systimer.Timer.Object", new Proto.Str(po, false));
    ...
    void Timer$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("intFreq", (Proto)om.findStrict("xdc.runtime.Types.FreqHz", "ti.sysbios.family.arm.systimer"), Global.newObject("lo", 6144000L, "hi", 0L), "w");
