...
public class ti_sysbios_family_arm_gic
{
    ...
    void Hwi$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arm.gic.Hwi.Object", new Proto.Str(po, false));
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.gic.Hwi.initIntController", new Extern("ti_sysbios_family_arm_gic_Hwi_initIntController__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.gic.Hwi.init", new Extern("ti_sysbios_family_arm_gic_Hwi_init__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.gic.Hwi.dispatch", new Extern("ti_sysbios_family_arm_gic_Hwi_dispatch__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.gic.Hwi.dispatchC", new Extern("ti_sysbios_family_arm_gic_Hwi_dispatchC__I", "xdc_Void(*)(xdc_UArg)", true, false));
    ...
    void Hwi$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("BPR", Proto.Elm.newCNum("(xdc_UInt)"), 3L, "w");
        ...
        if (isCFG) {
            ...
            po.addFld("triggerSensitivity", Proto.Elm.newCNum("(xdc_UInt)"), 0x1L, "w");
            po.addFld("targetProcList", Proto.Elm.newCNum("(xdc_UInt)"), 0x01L, "w");
