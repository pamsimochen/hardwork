...
/* initIntController */
#define Hwi_initIntController ti_sysbios_family_arm_gic_Hwi_initIntController__I

/* init */
#define Hwi_init ti_sysbios_family_arm_gic_Hwi_init__I

/* dispatch */
#define Hwi_dispatch ti_sysbios_family_arm_gic_Hwi_dispatch__I

/* dispatchC */
#define Hwi_dispatchC ti_sysbios_family_arm_gic_Hwi_dispatchC__I
...
#define ti_sysbios_family_arm_gic_Hwi_Module_startup ti_sysbios_family_arm_gic_Hwi_Module_startup__F

/* Instance_init */
#undef ti_sysbios_family_arm_gic_Hwi_Instance_init
#define ti_sysbios_family_arm_gic_Hwi_Instance_init ti_sysbios_family_arm_gic_Hwi_Instance_init__F

/* Instance_finalize */
#undef ti_sysbios_family_arm_gic_Hwi_Instance_finalize
#define ti_sysbios_family_arm_gic_Hwi_Instance_finalize ti_sysbios_family_arm_gic_Hwi_Instance_finalize__F
