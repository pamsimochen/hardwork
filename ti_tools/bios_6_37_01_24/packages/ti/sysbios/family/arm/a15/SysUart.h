...
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_Module_startup__R, "ti_sysbios_family_arm_a15_SysUart_Module_startup")
__extern xdc_Int ti_sysbios_family_arm_a15_SysUart_Module_startup__R( xdc_Int state );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_Module__startupDone__S, "ti_sysbios_family_arm_a15_SysUart_Module__startupDone")
...
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_abort__F, "ti_sysbios_family_arm_a15_SysUart_abort")
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_abort__F( xdc_CString str );
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_abort__R( xdc_CString str );
...
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_exit__F, "ti_sysbios_family_arm_a15_SysUart_exit")
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_exit__F( xdc_Int stat );
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_exit__R( xdc_Int stat );
...
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_flush__F, "ti_sysbios_family_arm_a15_SysUart_flush")
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_flush__F( void );
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_flush__R( void );
...
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_putch__F, "ti_sysbios_family_arm_a15_SysUart_putch")
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_putch__F( xdc_Char ch );
__extern xdc_Void ti_sysbios_family_arm_a15_SysUart_putch__R( xdc_Char ch );
...
xdc__CODESECT(ti_sysbios_family_arm_a15_SysUart_ready__F, "ti_sysbios_family_arm_a15_SysUart_ready")
__extern xdc_Bool ti_sysbios_family_arm_a15_SysUart_ready__F( void );
__extern xdc_Bool ti_sysbios_family_arm_a15_SysUart_ready__R( void );
