...
public class ti_sysbios_family_arm_a15
{
    ...
    void Cache$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.a15.Cache.disableD", new Extern("ti_sysbios_family_arm_a15_Cache_disableD__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.disableP", new Extern("ti_sysbios_family_arm_a15_Cache_disableP__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.enableD", new Extern("ti_sysbios_family_arm_a15_Cache_enableD__I", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Cache.enableP", new Extern("ti_sysbios_family_arm_a15_Cache_enableP__I", "xdc_Void(*)(xdc_Void)", true, false));
        ...
        om.bind("ti.sysbios.family.arm.a15.Cache.exit", new Extern("ti_sysbios_family_arm_a15_Cache_exit__I", "xdc_Void(*)(xdc_Int)", true, false));
    }
    ...
    void Mmu$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.a15.Mmu.initFirstLevelTableBuf", new Extern("ti_sysbios_family_arm_a15_Mmu_initFirstLevelTableBuf__I", "xdc_Void(*)(xdc_UInt64*,xdc_UInt64**)", true, false));
        om.bind("ti.sysbios.family.arm.a15.Mmu.initSecondLevelTableBuf", new Extern("ti_sysbios_family_arm_a15_Mmu_initSecondLevelTableBuf__I", "xdc_Void(*)(xdc_UInt64**)", true, false));
    }
    ...
    void Cache$$SINGLETONS()
    {
        ...
        vo.bind("disableD", om.findStrict("ti.sysbios.family.arm.a15.Cache.disableD", "ti.sysbios.family.arm.a15"));
        vo.bind("disableP", om.findStrict("ti.sysbios.family.arm.a15.Cache.disableP", "ti.sysbios.family.arm.a15"));
        vo.bind("enableD", om.findStrict("ti.sysbios.family.arm.a15.Cache.enableD", "ti.sysbios.family.arm.a15"));
        vo.bind("enableP", om.findStrict("ti.sysbios.family.arm.a15.Cache.enableP", "ti.sysbios.family.arm.a15"));
        ...
        vo.bind("exit", om.findStrict("ti.sysbios.family.arm.a15.Cache.exit", "ti.sysbios.family.arm.a15"));
    ...
    void Mmu$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_a15_Mmu_Module__startupDone__E", "ti_sysbios_family_arm_a15_Mmu_disable__E", "ti_sysbios_family_arm_a15_Mmu_enable__E", "ti_sysbios_family_arm_a15_Mmu_initDescAttrs__E", "ti_sysbios_family_arm_a15_Mmu_isEnabled__E", "ti_sysbios_family_arm_a15_Mmu_setMAIR__E", "ti_sysbios_family_arm_a15_Mmu_setFirstLevelDesc__E", "ti_sysbios_family_arm_a15_Mmu_setSecondLevelDesc__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
