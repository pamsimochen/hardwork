...
public class ti_sysbios_family_arm_ducati
{
    ...
    void GateSmp$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sysbios.family.arm.ducati.GateSmp.Object", new Proto.Str(po, false));
    ...
    void Core$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.ducati.Core.lock", new Extern("ti_sysbios_family_arm_ducati_Core_lock__E", "xdc_Void(*)(xdc_Void)", true, false));
