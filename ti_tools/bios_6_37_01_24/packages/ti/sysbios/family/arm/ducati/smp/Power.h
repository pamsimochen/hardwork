...
xdc__CODESECT(ti_sysbios_family_arm_ducati_smp_Power_Module__startupDone__S, "ti_sysbios_family_arm_ducati_smp_Power_Module__startupDone")
...
xdc__CODESECT(ti_sysbios_family_arm_ducati_smp_Power_idleCPU__F, "ti_sysbios_family_arm_ducati_smp_Power_idleCPU")
__extern xdc_Void ti_sysbios_family_arm_ducati_smp_Power_idleCPU__F( void );
__extern xdc_Void ti_sysbios_family_arm_ducati_smp_Power_idleCPU__R( void );
...
xdc__CODESECT(ti_sysbios_family_arm_ducati_smp_Power_suspend__F, "ti_sysbios_family_arm_ducati_smp_Power_suspend")
__extern xdc_UInt ti_sysbios_family_arm_ducati_smp_Power_suspend__F( ti_sysbios_family_arm_ducati_smp_Power_SuspendArgs* args );
__extern xdc_UInt ti_sysbios_family_arm_ducati_smp_Power_suspend__R( ti_sysbios_family_arm_ducati_smp_Power_SuspendArgs* args );
