...
public class ti_sysbios_timers_dmtimer
{
    ...
    void Timer$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("tsicr", (Proto)om.findStrict("ti.sysbios.timers.dmtimer.Timer.Tsicr", "ti.sysbios.timers.dmtimer"), Global.newObject("sft", 0L, "posted", 0L), "w");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.a64P',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.a64Pe',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.a674',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae64P',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae64Pe',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae674',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae64T',\n");
            ...
            sb.append("'lib/sysbios/debug/ti.sysbios.timers.dmtimer.aea8f',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            ...
            sb.append("['lib/sysbios/debug/ti.sysbios.timers.dmtimer.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
