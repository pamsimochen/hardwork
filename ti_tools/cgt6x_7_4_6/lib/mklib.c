/*---------------------------------------------------------------------------
 * This is mklib version 7.4.6 for C6000 compiler  
...
/*--------------------------------------------------------------------------- 
 * This source code is specific to compiler RTS library version 7.4.6.  
...
library_t LIBRARIES[] = {
    { "rts67plus.lib", { "C67P","NOT_VENC_ASM","C6000" } },
    ...
    { "rts6200_elf40_eh.lib", { "EXCEPTIONS","EABI","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf40.lib", { "EABI","C6XABI","C64P","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf40_eh.lib", { "EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C64P","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6400e_elf40.lib", { "C6400","BIG_ENDIAN","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    ...
    { "rtstesla_le_elf_eh.lib", { "C_MEMCPY","EXCEPTIONS","EABI","C6XABI","TESLA","EABI_TDEH","NOT_VENC_ASM" } },
    { "rts6600_elf40.lib", { "C6600","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6600_elf_mt.lib", { "C6600","EABI","C6XABI","MT","NOT_VENC_ASM","C6000" } },
    { "rts6200e.lib", { "BIG_ENDIAN","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf_mt_eh.lib", { "EXCEPTIONS","EABI","C6XABI","MT","EABI_TDEH","C64P","NOT_VENC_ASM","C6000" } },
    { "rts64pluse_elf_no_parallel_loads_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C64P","NO_PARALLEL_LOADS","NOT_VENC_ASM","C6000" } },
    { "rtstesla_be_elf.lib", { "BIG_ENDIAN","C_MEMCPY","EABI","C6XABI","TESLA","NOT_VENC_ASM" } },
    { "rts6400e_elf.lib", { "C6400","BIG_ENDIAN","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6200e_elf40.lib", { "BIG_ENDIAN","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6740_elf_mt.lib", { "EABI","C6740","C6XABI","MT","NOT_VENC_ASM","C6000" } },
    { "rts6740e_elf_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6740","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf_no_parallel_loads_eh.lib", { "EXCEPTIONS","NO_PARALLEL_LOADS","EABI","C6XABI","EABI_TDEH","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6400_elf_eh.lib", { "C6400","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts67plus_elf40.lib", { "C67P","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64pluse_eh.lib", { "FULL_PORTABLE_EH","BIG_ENDIAN","EXCEPTIONS","C64P","NOT_VENC_ASM","C6000" } },
    { "rts64pluse_elf_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6200v_eh.lib", { "FULL_PORTABLE_EH","NOASM_RTS","C_MEMCPY","EXCEPTIONS","VENC" } },
    { "rts6600_coff_eh.lib", { "FULL_PORTABLE_EH","COFFABI","EXCEPTIONS","C6600","NOT_VENC_ASM","C6000" } },
    { "rts6200e_eh.lib", { "FULL_PORTABLE_EH","BIG_ENDIAN","EXCEPTIONS","NOT_VENC_ASM","C6000" } },
    { "rts67pluse_elf40_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C67P","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6740e.lib", { "BIG_ENDIAN","C6740","NOT_VENC_ASM","C6000" } },
    { "rtstesla_le_coff.lib", { "COFFABI","C_MEMCPY","TESLA","NOT_VENC_ASM" } },
    { "rts67plus_eh.lib", { "FULL_PORTABLE_EH","C67P","EXCEPTIONS","NOT_VENC_ASM","C6000" } },
    { "rts6600e_elf40.lib", { "BIG_ENDIAN","C6600","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6700.lib", { "C6700","NOT_VENC_ASM","C6000" } },
    { "rtstesla_le_elf40.lib", { "C_MEMCPY","EABI","C6XABI","TESLA","ELF40","NOT_VENC_ASM" } },
    ...
    { "rtscgemv_eh.lib", { "FULL_PORTABLE_EH","NOASM_RTS","C_MEMCPY","EXCEPTIONS","VENC","CGEM" } },
    { "rts6400_eh.lib", { "FULL_PORTABLE_EH","C6400","EXCEPTIONS","NOT_VENC_ASM","C6000" } },
    { "rts6200v.lib", { "NOASM_RTS","C_MEMCPY","VENC" } },
    { "rts6700e_elf40.lib", { "C6700","BIG_ENDIAN","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6600e_elf_mt.lib", { "BIG_ENDIAN","C6600","EABI","C6XABI","MT","NOT_VENC_ASM","C6000" } },
    { "rts6400.lib", { "C6400","NOT_VENC_ASM","C6000" } },
    { "rts64pluse.lib", { "BIG_ENDIAN","C64P","NOT_VENC_ASM","C6000" } },
    { "rtstesla_be_coff_eh.lib", { "FULL_PORTABLE_EH","COFFABI","BIG_ENDIAN","C_MEMCPY","EXCEPTIONS","TESLA","NOT_VENC_ASM" } },
    ...
    { "rts6600e_coff_eh.lib", { "FULL_PORTABLE_EH","COFFABI","BIG_ENDIAN","EXCEPTIONS","C6600","NOT_VENC_ASM","C6000" } },
    { "rts6740_elf40_eh.lib", { "EXCEPTIONS","EABI","C6740","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6400_elf40.lib", { "C6400","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6740_elf.lib", { "EABI","C6740","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6400e.lib", { "C6400","BIG_ENDIAN","NOT_VENC_ASM","C6000" } },
    { "rts64pluse_elf40.lib", { "BIG_ENDIAN","EABI","C6XABI","C64P","ELF40","NOT_VENC_ASM","C6000" } },
    { "rtstesla_be_elf40.lib", { "BIG_ENDIAN","C_MEMCPY","EABI","C6XABI","TESLA","ELF40","NOT_VENC_ASM" } },
    { "rts67pluse_elf.lib", { "C67P","BIG_ENDIAN","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6600_elf_mt_eh.lib", { "C6600","EXCEPTIONS","EABI","C6XABI","MT","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rtstesla_be_coff.lib", { "COFFABI","BIG_ENDIAN","C_MEMCPY","TESLA","NOT_VENC_ASM" } },
    { "rts64plus_eh.lib", { "FULL_PORTABLE_EH","EXCEPTIONS","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6740_elf40.lib", { "EABI","C6740","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf_eh.lib", { "EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6740e_elf_mt_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6740","C6XABI","MT","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6740e_eh.lib", { "FULL_PORTABLE_EH","BIG_ENDIAN","EXCEPTIONS","C6740","NOT_VENC_ASM","C6000" } },
    { "rts6740e_elf40_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6740","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6400_elf.lib", { "C6400","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rtstesla_le_elf.lib", { "C_MEMCPY","EABI","C6XABI","TESLA","NOT_VENC_ASM" } },
    { "rts64pluse_elf40_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C64P","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64plusv.lib", { "NOASM_RTS","C_MEMCPY","VENC","C64P" } },
    { "rtscgemv.lib", { "NOASM_RTS","C_MEMCPY","VENC","CGEM" } },
    { "rts64plus.lib", { "C64P","NOT_VENC_ASM","C6000" } },
    { "rts67plus_elf40_eh.lib", { "C67P","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64pluse_elf_no_parallel_loads.lib", { "BIG_ENDIAN","NO_PARALLEL_LOADS","EABI","C6XABI","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6740_elf_mt_eh.lib", { "EXCEPTIONS","EABI","C6740","C6XABI","MT","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6740e_elf.lib", { "BIG_ENDIAN","EABI","C6740","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6600_elf_eh.lib", { "C6600","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6700e_elf.lib", { "C6700","BIG_ENDIAN","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6200e_elf_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6740.lib", { "C6740","NOT_VENC_ASM","C6000" } },
    { "rts67plus_elf_eh.lib", { "C67P","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6200_elf.lib", { "EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6600_elf40_eh.lib", { "C6600","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts67plus_elf.lib", { "C67P","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rtstesla_be_elf_eh.lib", { "BIG_ENDIAN","C_MEMCPY","EXCEPTIONS","EABI","C6XABI","TESLA","EABI_TDEH","NOT_VENC_ASM" } },
    { "rtstesla_be_elf40_eh.lib", { "BIG_ENDIAN","C_MEMCPY","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","TESLA","ELF40","NOT_VENC_ASM" } },
    { "rts6400e_eh.lib", { "FULL_PORTABLE_EH","C6400","BIG_ENDIAN","EXCEPTIONS","NOT_VENC_ASM","C6000" } },
    { "rts6400e_elf40_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C6400","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64plusv_eh.lib", { "FULL_PORTABLE_EH","NOASM_RTS","C_MEMCPY","EXCEPTIONS","VENC","C64P" } },
    { "rts64pluse_elf.lib", { "BIG_ENDIAN","EABI","C6XABI","C64P","NOT_VENC_ASM","C6000" } },
    { "rts67pluse_elf40.lib", { "C67P","BIG_ENDIAN","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6740e_elf40.lib", { "BIG_ENDIAN","EABI","C6740","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6700_elf40_eh.lib", { "C6700","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rtstesla_le_coff_eh.lib", { "FULL_PORTABLE_EH","COFFABI","C_MEMCPY","EXCEPTIONS","TESLA","NOT_VENC_ASM" } },
    { "rts6200.lib", { "NOT_VENC_ASM","C6000" } },
    { "rts6740e_elf_mt.lib", { "BIG_ENDIAN","EABI","C6740","C6XABI","MT","NOT_VENC_ASM","C6000" } },
    ...
    { "rts64pluse_elf_mt.lib", { "BIG_ENDIAN","EABI","C6XABI","MT","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6700e_elf40_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","C6700","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf_mt.lib", { "EABI","C6XABI","MT","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6700e.lib", { "C6700","BIG_ENDIAN","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf.lib", { "EABI","C6XABI","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6600e_elf.lib", { "BIG_ENDIAN","C6600","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6700_elf_eh.lib", { "C6700","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6600e_elf_mt_eh.lib", { "BIG_ENDIAN","C6600","EXCEPTIONS","EABI","C6XABI","MT","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts64plus_elf_no_parallel_loads.lib", { "NO_PARALLEL_LOADS","EABI","C6XABI","C64P","NOT_VENC_ASM","C6000" } },
    { "rts64pluse_elf_mt_eh.lib", { "BIG_ENDIAN","EXCEPTIONS","EABI","C6XABI","MT","EABI_TDEH","C64P","NOT_VENC_ASM","C6000" } },
    { "rts6600e_elf_eh.lib", { "BIG_ENDIAN","C6600","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6740_elf_eh.lib", { "EXCEPTIONS","EABI","C6740","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6600e_elf40_eh.lib", { "BIG_ENDIAN","C6600","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6200_elf_eh.lib", { "EXCEPTIONS","EABI","C6XABI","EABI_TDEH","NOT_VENC_ASM","C6000" } },
    { "rts6200_elf40.lib", { "EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6400_elf40_eh.lib", { "C6400","EXCEPTIONS","EABI","C6XABI","EABI_TDEH","ELF40","NOT_VENC_ASM","C6000" } },
    { "rts6740_eh.lib", { "FULL_PORTABLE_EH","EXCEPTIONS","C6740","NOT_VENC_ASM","C6000" } },
    { "rts6700_elf.lib", { "C6700","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6600_elf.lib", { "C6600","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6200e_elf.lib", { "BIG_ENDIAN","EABI","C6XABI","NOT_VENC_ASM","C6000" } },
    { "rts6700_elf40.lib", { "C6700","EABI","C6XABI","ELF40","NOT_VENC_ASM","C6000" } },
};

const char *DEFAULT_OPTIONS = " -o -oe -k -pdsw225 -q";
