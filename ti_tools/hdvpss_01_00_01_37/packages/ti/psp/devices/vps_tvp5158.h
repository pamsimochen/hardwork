...
/**
 * \ingroup VPS_DRV_FVID2_DEVICE_VID_DEC_API
 * \defgroup VPS_DRV_FVID2_DEVICE_VID_DEC_TVP5158_API TVP5158 Video Decoder API
 *
...
#ifndef _VPS_TVP5158_H_
#define _VPS_TVP5158_H_
...
/**
  * \addtogroup VPS_DRV_FVID2_IOCTL_TVP5158
  * @{
*/
...
/**
  ...
  *
  * \param cmdArgs       [IN]   Vps_Tvp5158VideoNfParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_VPS_TVP5158_SET_VIDEO_NF      \
            (VPS_VID_DEC_IOCTL_BASE + 0x1000)
...
/**
  ...
  * This IOCTL can be called separetly for each channel.
  *
  * \param cmdArgs       [IN]   Vps_Tvp5158AudioModeParams *
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure
  *
*/
#define IOCTL_VPS_TVP5158_SET_AUDIO_MODE    \
            (VPS_VID_DEC_IOCTL_BASE + 0x1001)
...
/**
 * \brief Arguments for IOCTL_VPS_TVP5158_SET_VIDEO_NF
*/
typedef struct
{
...
} Vps_Tvp5158VideoNfParams;

/**
 * \brief Arguments for IOCTL_VPS_TVP5158_SET_AUDIO_MODE
 *
