...
{
    {
        /* Note: 8 channels from DEI will go to dislay.  Scalar will get
         * 8 channels out of which any 4 channels will go to display rest 4
...
const Sys_DeiLinkCfg *Sys_getDeiLinkCfg(Sys_DeiCfgId deiCfgId)
{
    ...
    for (count = 0u;
         count < (sizeof(gSysDeiCfgTbl) / sizeof(Sys_DeiLinkCfg));
         count++)
    {
...
const Sys_ScLinkCfg *Sys_getScLinkCfg(Sys_ScCfgId scCfgId)
{
    ...
    for (count = 0u;
         count < (sizeof(gSysScCfgTbl) / sizeof(Sys_ScLinkCfg));
         count++)
    {
...
const Sys_DispLinkCfg *Sys_getDispLinkCfg(Sys_DispCfgId dispCfgId)
{
    ...
    for (count = 0u;
         count < (sizeof(gSysDispCfgTbl) / sizeof(Sys_DispLinkCfg));
         count++)
    {
