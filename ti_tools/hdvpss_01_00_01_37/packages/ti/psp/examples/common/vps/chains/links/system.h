...
#include <ti/psp/examples/common/vps/chains/links/system_debug.h>
...
#define SYSTEM_LINK_ID_CAPTURE              ( 0)
...
/** \brief Link ID for SCALAR_SW_MS 4 */
#define SYSTEM_LINK_ID_SCALAR_SW_MS_4       (13)

/** \brief Link ID for SCALAR 0 */
#define SYSTEM_LINK_ID_SCALAR_0             (14)
/** \brief Link ID for SCALAR 1 */
#define SYSTEM_LINK_ID_SCALAR_1             (15)

/** \brief Link ID for DISPLAY 0 */
#define SYSTEM_LINK_ID_DISPLAY_0            (16)
/** \brief Link ID for DISPLAY 1 */
#define SYSTEM_LINK_ID_DISPLAY_1            (17)
/** \brief Link ID for DISPLAY 2 */
#define SYSTEM_LINK_ID_DISPLAY_2            (18)

/** \brief Link ID for DISPLAY_HW_MS 0 */
#define SYSTEM_LINK_ID_DISPLAY_HW_MS_0      (19)
/** \brief Link ID for DISPLAY_HW_MS 1 */
#define SYSTEM_LINK_ID_DISPLAY_HW_MS_1      (20)

/** \brief Link ID for GRPX 0 */
#define SYSTEM_LINK_ID_GRPX_0               (21)
/** \brief Link ID for GRPX 1 */
#define SYSTEM_LINK_ID_GRPX_1               (22)
/** \brief Link ID for GRPX 2 */
#define SYSTEM_LINK_ID_GRPX_2               (23)

/** \brief Link ID for NULL 0 */
#define SYSTEM_LINK_ID_NULL_0               (24)
/** \brief Link ID for NULL 1 */
#define SYSTEM_LINK_ID_NULL_1               (25)
/** \brief Link ID for NULL 2 */
#define SYSTEM_LINK_ID_NULL_2               (26)

/** \brief Link ID for VIDEO_SRC 0 */
#define SYSTEM_LINK_ID_VIDEO_SRC_0          (27)
/** \brief Link ID for VIDEO_SRC 1 */
#define SYSTEM_LINK_ID_VIDEO_SRC_1          (28)

/** \brief Link ID for CAPTURE_UT */
#define SYSTEM_LINK_ID_CAPTURE_UT           (29)

/** \brief Link ID for DUP 0 */
#define SYSTEM_LINK_ID_DUP_0                (30)
/** \brief Link ID for DUP 1 */
#define SYSTEM_LINK_ID_DUP_1                (31)

/** \brief Link ID for SW_MS_DEI 0 */
#define SYSTEM_LINK_ID_SW_MS_DEI_0          (32)
/** \brief Link ID for SW_MS_DEI_HQ 0 */
#define SYSTEM_LINK_ID_SW_MS_DEI_HQ_0       (33)

/** \brief Link ID for SW_MS_SC 0 */
#define SYSTEM_LINK_ID_SW_MS_SC_0           (34)
/** \brief Link ID for SW_MS_SC 1 */
#define SYSTEM_LINK_ID_SW_MS_SC_1           (35)
/** \brief Link ID for SW_MS_SC 2 */
#define SYSTEM_LINK_ID_SW_MS_SC_2           (36)
/** \brief Link ID for SW_MS_SC 3 */
#define SYSTEM_LINK_ID_SW_MS_SC_3           (37)

/** \brief Maximum number of link IDs */
#define SYSTEM_LINK_ID_MAX                  (38)
