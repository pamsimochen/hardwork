...
/**
 * \file vps_dctrlDefaultsTI816x.h
 *
...
#ifndef _VPS_DCTRLDEFAULTSTI816X_H
#define _VPS_DCTRLDEFAULTSTI816X_H
...
#define DC_MAX_OUTPUT                       (4u)

/* Defins Maximum resource DC handles. The resources are: VCOMP Main path,
 * VCOMP Aux path, CIG PIP path and four blenders. */
...
{                                                                              \
    {                                                                          \
        ...
        {{{VPS_DC_VENC_HDMI, FALSE, FVID2_STD_1080P_60},                       \
          {VPS_DC_VENC_HDCOMP, FALSE, FVID2_STD_1080P_60},                     \
