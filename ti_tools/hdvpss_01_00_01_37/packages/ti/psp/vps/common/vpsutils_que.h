...
#ifndef _VPSUTILS_QUE_H_
#define _VPSUTILS_QUE_H_
...
/**
  ...
  \defgroup VPS_DRV_UTIL_AQUE_API Utils layer - Array based queue
...
*/
#define VPSUTILS_QUE_FLAG_NO_BLOCK_QUE    (0x00000000)

/** Block on que put if que is full */
#define VPSUTILS_QUE_FLAG_BLOCK_QUE_PUT   (0x00000001)

/** Block on que get if que is empty */
#define VPSUTILS_QUE_FLAG_BLOCK_QUE_GET   (0x00000002)

/** Block on que put if que is full, Block on que get if que is empty  */
#define VPSUTILS_QUE_FLAG_BLOCK_QUE       (0x00000003)
...
/**
  ...
  \param  flags         [I ] VPSUTILS_QUE_FLAG_xxxx
