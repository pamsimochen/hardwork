...
#ifndef _VPSHAL_DEI_H
#define _VPSHAL_DEI_H
...
/** \brief Instance 0 of DEI */
#define VPSHAL_DEI_INST_0               (0u)
/** \brief DEI maximum number of instances */
