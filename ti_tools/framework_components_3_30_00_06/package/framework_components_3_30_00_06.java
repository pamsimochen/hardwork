...
public class framework_components_3_30_00_06
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("framework_components_3_30_00_06.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("framework_components_3_30_00_06", new Value.Obj("framework_components_3_30_00_06", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("framework_components_3_30_00_06.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "framework_components_3_30_00_06"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "framework_components_3_30_00_06", Value.DEFAULT, false);
        pkgV.bind("$name", "framework_components_3_30_00_06");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "framework_components_3_30_00_06.");
        ...
        sb.append("var pkg = xdc.om['framework_components_3_30_00_06'];\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "framework_components_3_30_00_06")).add(pkgV);
    }
