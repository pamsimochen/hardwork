...
TCL_EXTRA_CFLAGS='-fexpensive-optimizations -frename-registers -fomit-frame-pointer -O2 -ggdb2 -pipe '
...
TCL_LD_FLAGS='-Wl,-O1 -Wl,--hash-style=gnu -Wl,--export-dynamic '
...
TCL_COMPAT_OBJS=' strstr.o strtoul.o strtod.o fixstrtod.o'

# Name of the ranlib program to use.
TCL_RANLIB='arm-arago-linux-gnueabi-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/lib -ltcl8.5'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/lib -ltclstub8.5'
