...
TK_LIBS='-L/home/hudson/amsdk-nightly-build/cortex-A8/arago-tmp/sysroots/armv7a-arago-linux-gnueabi/usr/lib -lX11 -lXft    -lpthread -ldl  -lpthread -lieee -lm'
...
TK_XINCLUDES='-I/home/hudson/amsdk-nightly-build/cortex-A8/arago-tmp/sysroots/armv7a-arago-linux-gnueabi/usr/include'

# Linker switch(es) to use to link with the X11 library archive.
TK_XLIBSW='-L/home/hudson/amsdk-nightly-build/cortex-A8/arago-tmp/sysroots/armv7a-arago-linux-gnueabi/usr/lib -lX11'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/lib -ltk8.5'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/lib -ltkstub8.5'
