...
#define __GMP_CC "arm-arago-linux-gnueabi-gcc -march=armv7-a -mtune=cortex-a8 -mfpu=neon -mfloat-abi=softfp -mthumb-interwork -mno-thumb --sysroot=/sim/scratch_a0850442/arago-tmp-arago/sysroots/armv7a-arago-linux-gnueabi -std=gnu99"
#define __GMP_CFLAGS "-fexpensive-optimizations -fomit-frame-pointer -frename-registers -O2 -ggdb2"
