...
#define ti_sdo_ipc_heaps_HeapMultiBufMP___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init__F, "ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init")
__extern int ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init__F( ti_sdo_ipc_heaps_HeapMultiBufMP_Object*, const ti_sdo_ipc_heaps_HeapMultiBufMP_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize__F, "ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize")
__extern void ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize__F( ti_sdo_ipc_heaps_HeapMultiBufMP_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init__R, "ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init")
__extern int ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init__R( ti_sdo_ipc_heaps_HeapMultiBufMP_Object*, const ti_sdo_ipc_heaps_HeapMultiBufMP_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize__R, "ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize")
__extern void ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize__R( ti_sdo_ipc_heaps_HeapMultiBufMP_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Handle__label__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Module__startupDone__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_heaps_HeapMultiBufMP_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Object__create__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Object__delete__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Object__delete")
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Object__destruct__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Object__destruct")
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Object__get__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Object__get")
__extern xdc_Ptr ti_sdo_ipc_heaps_HeapMultiBufMP_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Object__first__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Object__first")
__extern xdc_Ptr ti_sdo_ipc_heaps_HeapMultiBufMP_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Object__next__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Object__next")
__extern xdc_Ptr ti_sdo_ipc_heaps_HeapMultiBufMP_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_Params__init__S, "ti_sdo_ipc_heaps_HeapMultiBufMP_Params__init")
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking__F, "ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking")
__extern xdc_Bool ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking__F( ti_sdo_ipc_heaps_HeapMultiBufMP_Object* __inst );
__extern xdc_Bool ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking__R( ti_sdo_ipc_heaps_HeapMultiBufMP_Handle __inst );
...
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_getStats__F, "ti_sdo_ipc_heaps_HeapMultiBufMP_getStats")
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_getStats__F( ti_sdo_ipc_heaps_HeapMultiBufMP_Object* __inst, xdc_runtime_Memory_Stats* stats );
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_getStats__R( ti_sdo_ipc_heaps_HeapMultiBufMP_Handle __inst, xdc_runtime_Memory_Stats* stats );
...
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_alloc__F, "ti_sdo_ipc_heaps_HeapMultiBufMP_alloc")
__extern xdc_Ptr ti_sdo_ipc_heaps_HeapMultiBufMP_alloc__F( ti_sdo_ipc_heaps_HeapMultiBufMP_Object* __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
__extern xdc_Ptr ti_sdo_ipc_heaps_HeapMultiBufMP_alloc__R( ti_sdo_ipc_heaps_HeapMultiBufMP_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb );
...
xdc__CODESECT(ti_sdo_ipc_heaps_HeapMultiBufMP_free__F, "ti_sdo_ipc_heaps_HeapMultiBufMP_free")
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_free__F( ti_sdo_ipc_heaps_HeapMultiBufMP_Object* __inst, xdc_Ptr block, xdc_SizeT size );
__extern xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_free__R( ti_sdo_ipc_heaps_HeapMultiBufMP_Handle __inst, xdc_Ptr block, xdc_SizeT size );
...
typedef xdc_Bool (*ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking_FxnT)(void*);
static inline ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking_fxnP( void )
{
    return (ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking_FxnT)ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking; 
}

/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_heaps_HeapMultiBufMP_getStats_FxnT)(void*, xdc_runtime_Memory_Stats*);
static inline ti_sdo_ipc_heaps_HeapMultiBufMP_getStats_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_getStats_fxnP( void )
{
    return (ti_sdo_ipc_heaps_HeapMultiBufMP_getStats_FxnT)ti_sdo_ipc_heaps_HeapMultiBufMP_getStats; 
}

/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sdo_ipc_heaps_HeapMultiBufMP_alloc_FxnT)(void*, xdc_SizeT, xdc_SizeT, xdc_runtime_Error_Block*);
static inline ti_sdo_ipc_heaps_HeapMultiBufMP_alloc_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_alloc_fxnP( void )
{
    return (ti_sdo_ipc_heaps_HeapMultiBufMP_alloc_FxnT)ti_sdo_ipc_heaps_HeapMultiBufMP_alloc; 
}

/* free_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_heaps_HeapMultiBufMP_free_FxnT)(void*, xdc_Ptr, xdc_SizeT);
static inline ti_sdo_ipc_heaps_HeapMultiBufMP_free_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_free_fxnP( void )
{
    return (ti_sdo_ipc_heaps_HeapMultiBufMP_free_FxnT)ti_sdo_ipc_heaps_HeapMultiBufMP_free; 
}
...
static inline ti_sdo_ipc_heaps_HeapMultiBufMP_Handle ti_sdo_ipc_heaps_HeapMultiBufMP_Handle_downCast( xdc_runtime_IHeap_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sdo_ipc_heaps_HeapMultiBufMP_Module__FXNS__C ? (ti_sdo_ipc_heaps_HeapMultiBufMP_Handle)i : 0;
}
...
{
    return ti_sdo_ipc_heaps_HeapMultiBufMP_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_heaps_HeapMultiBufMP_Module_getMask( void ) 
{
    return ti_sdo_ipc_heaps_HeapMultiBufMP_Module__diagsMask__C != NULL ? *ti_sdo_ipc_heaps_HeapMultiBufMP_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_heaps_HeapMultiBufMP_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_heaps_HeapMultiBufMP_Module__diagsMask__C != NULL) *ti_sdo_ipc_heaps_HeapMultiBufMP_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_heaps_HeapMultiBufMP_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_heaps_HeapMultiBufMP_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_heaps_HeapMultiBufMP_Handle_name( ti_sdo_ipc_heaps_HeapMultiBufMP_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_heaps_HeapMultiBufMP_Handle ti_sdo_ipc_heaps_HeapMultiBufMP_create( const ti_sdo_ipc_heaps_HeapMultiBufMP_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sdo_ipc_heaps_HeapMultiBufMP_Handle)ti_sdo_ipc_heaps_HeapMultiBufMP_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_heaps_HeapMultiBufMP_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_heaps_HeapMultiBufMP_construct( ti_sdo_ipc_heaps_HeapMultiBufMP_Struct* __obj, const ti_sdo_ipc_heaps_HeapMultiBufMP_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_heaps_HeapMultiBufMP_Object__create__S(__obj, sizeof (ti_sdo_ipc_heaps_HeapMultiBufMP_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_heaps_HeapMultiBufMP_Params), __eb);
}

/* delete */
static inline void ti_sdo_ipc_heaps_HeapMultiBufMP_delete( ti_sdo_ipc_heaps_HeapMultiBufMP_Handle* instp )
{
    ti_sdo_ipc_heaps_HeapMultiBufMP_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_heaps_HeapMultiBufMP_destruct( ti_sdo_ipc_heaps_HeapMultiBufMP_Struct* obj )
{
    ti_sdo_ipc_heaps_HeapMultiBufMP_Object__destruct__S(obj);
}
...
#define HeapMultiBufMP_isBlocking_fxnP ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking_fxnP
#define HeapMultiBufMP_isBlocking_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking_FxnT
#define HeapMultiBufMP_getStats ti_sdo_ipc_heaps_HeapMultiBufMP_getStats
#define HeapMultiBufMP_getStats_fxnP ti_sdo_ipc_heaps_HeapMultiBufMP_getStats_fxnP
#define HeapMultiBufMP_getStats_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_getStats_FxnT
#define HeapMultiBufMP_alloc ti_sdo_ipc_heaps_HeapMultiBufMP_alloc
#define HeapMultiBufMP_alloc_fxnP ti_sdo_ipc_heaps_HeapMultiBufMP_alloc_fxnP
#define HeapMultiBufMP_alloc_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_alloc_FxnT
#define HeapMultiBufMP_free ti_sdo_ipc_heaps_HeapMultiBufMP_free
#define HeapMultiBufMP_free_fxnP ti_sdo_ipc_heaps_HeapMultiBufMP_free_fxnP
#define HeapMultiBufMP_free_FxnT ti_sdo_ipc_heaps_HeapMultiBufMP_free_FxnT
...
#endif
/*
 *  @(#) ti.sdo.ipc.heaps; 1, 0, 0, 0,; 5-10-2013 12:31:05; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
