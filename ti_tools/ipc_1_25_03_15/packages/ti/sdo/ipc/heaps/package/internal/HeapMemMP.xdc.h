...
#define ti_sdo_ipc_heaps_HeapMemMP_isBlocking ti_sdo_ipc_heaps_HeapMemMP_isBlocking__F
...
#define ti_sdo_ipc_heaps_HeapMemMP_Module_startup ti_sdo_ipc_heaps_HeapMemMP_Module_startup__F

/* Instance_init */
#undef ti_sdo_ipc_heaps_HeapMemMP_Instance_init
#define ti_sdo_ipc_heaps_HeapMemMP_Instance_init ti_sdo_ipc_heaps_HeapMemMP_Instance_init__F

/* Instance_finalize */
#undef ti_sdo_ipc_heaps_HeapMemMP_Instance_finalize
#define ti_sdo_ipc_heaps_HeapMemMP_Instance_finalize ti_sdo_ipc_heaps_HeapMemMP_Instance_finalize__F
