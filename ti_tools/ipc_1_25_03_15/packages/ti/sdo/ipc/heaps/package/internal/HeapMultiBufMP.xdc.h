...
#define ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking ti_sdo_ipc_heaps_HeapMultiBufMP_isBlocking__F

/* getStats */
#undef ti_sdo_ipc_heaps_HeapMultiBufMP_getStats
#define ti_sdo_ipc_heaps_HeapMultiBufMP_getStats ti_sdo_ipc_heaps_HeapMultiBufMP_getStats__F
...
#define ti_sdo_ipc_heaps_HeapMultiBufMP_Module_startup ti_sdo_ipc_heaps_HeapMultiBufMP_Module_startup__F

/* Instance_init */
#undef ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init
#define ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_init__F

/* Instance_finalize */
#undef ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize
#define ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize ti_sdo_ipc_heaps_HeapMultiBufMP_Instance_finalize__F
