...
#define ti_sdo_ipc_nsremote_NameServerMessageQ___VERS 150
...
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Module_startup__R, "ti_sdo_ipc_nsremote_NameServerMessageQ_Module_startup")
__extern xdc_Int ti_sdo_ipc_nsremote_NameServerMessageQ_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_init__F, "ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_init")
__extern void ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_init__F( ti_sdo_ipc_nsremote_NameServerMessageQ_Object*, xdc_UInt16 procId, const ti_sdo_ipc_nsremote_NameServerMessageQ_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_finalize__F, "ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_finalize")
__extern void ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_finalize__F( ti_sdo_ipc_nsremote_NameServerMessageQ_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_init__R, "ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_init")
__extern void ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_init__R( ti_sdo_ipc_nsremote_NameServerMessageQ_Object*, xdc_UInt16 procId, const ti_sdo_ipc_nsremote_NameServerMessageQ_Params* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_finalize__R, "ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_finalize")
__extern void ti_sdo_ipc_nsremote_NameServerMessageQ_Instance_finalize__R( ti_sdo_ipc_nsremote_NameServerMessageQ_Object* );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Handle__label__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Module__startupDone__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_nsremote_NameServerMessageQ_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Object__create__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Object__delete__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__delete")
__extern xdc_Void ti_sdo_ipc_nsremote_NameServerMessageQ_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Object__destruct__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__destruct")
__extern xdc_Void ti_sdo_ipc_nsremote_NameServerMessageQ_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Object__get__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__get")
__extern xdc_Ptr ti_sdo_ipc_nsremote_NameServerMessageQ_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Object__first__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__first")
__extern xdc_Ptr ti_sdo_ipc_nsremote_NameServerMessageQ_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Object__next__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Object__next")
__extern xdc_Ptr ti_sdo_ipc_nsremote_NameServerMessageQ_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_Params__init__S, "ti_sdo_ipc_nsremote_NameServerMessageQ_Params__init")
__extern xdc_Void ti_sdo_ipc_nsremote_NameServerMessageQ_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_attach__F, "ti_sdo_ipc_nsremote_NameServerMessageQ_attach")
__extern xdc_Int ti_sdo_ipc_nsremote_NameServerMessageQ_attach__F( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
__extern xdc_Int ti_sdo_ipc_nsremote_NameServerMessageQ_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_detach__F, "ti_sdo_ipc_nsremote_NameServerMessageQ_detach")
__extern xdc_Int ti_sdo_ipc_nsremote_NameServerMessageQ_detach__F( xdc_UInt16 remoteProcId );
__extern xdc_Int ti_sdo_ipc_nsremote_NameServerMessageQ_detach__R( xdc_UInt16 remoteProcId );
...
xdc__CODESECT(ti_sdo_ipc_nsremote_NameServerMessageQ_sharedMemReq__F, "ti_sdo_ipc_nsremote_NameServerMessageQ_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_nsremote_NameServerMessageQ_sharedMemReq__F( xdc_Ptr sharedAddr );
__extern xdc_SizeT ti_sdo_ipc_nsremote_NameServerMessageQ_sharedMemReq__R( xdc_Ptr sharedAddr );
...
__extern xdc_Int ti_sdo_ipc_nsremote_NameServerMessageQ_get__R( ti_sdo_ipc_nsremote_NameServerMessageQ_Handle __inst, xdc_String instanceName, xdc_String name, xdc_Ptr value, xdc_UInt32* valueLen, xdc_runtime_knl_ISync_Handle syncHandle, xdc_runtime_Error_Block* eb );
...
/* get_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_ipc_nsremote_NameServerMessageQ_get_FxnT)(void*, xdc_String, xdc_String, xdc_Ptr, xdc_UInt32*, xdc_runtime_knl_ISync_Handle, xdc_runtime_Error_Block*);
static inline ti_sdo_ipc_nsremote_NameServerMessageQ_get_FxnT ti_sdo_ipc_nsremote_NameServerMessageQ_get_fxnP( void )
{
    return (ti_sdo_ipc_nsremote_NameServerMessageQ_get_FxnT)ti_sdo_ipc_nsremote_NameServerMessageQ_get; 
}
...
static inline ti_sdo_ipc_nsremote_NameServerMessageQ_Handle ti_sdo_ipc_nsremote_NameServerMessageQ_Handle_downCast( ti_sdo_utils_INameServerRemote_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sdo_ipc_nsremote_NameServerMessageQ_Module__FXNS__C ? (ti_sdo_ipc_nsremote_NameServerMessageQ_Handle)i : 0;
}
...
{
    return ti_sdo_ipc_nsremote_NameServerMessageQ_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_nsremote_NameServerMessageQ_Module_getMask( void ) 
{
    return ti_sdo_ipc_nsremote_NameServerMessageQ_Module__diagsMask__C != NULL ? *ti_sdo_ipc_nsremote_NameServerMessageQ_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_nsremote_NameServerMessageQ_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_nsremote_NameServerMessageQ_Module__diagsMask__C != NULL) *ti_sdo_ipc_nsremote_NameServerMessageQ_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_nsremote_NameServerMessageQ_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_nsremote_NameServerMessageQ_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_nsremote_NameServerMessageQ_Handle_name( ti_sdo_ipc_nsremote_NameServerMessageQ_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_nsremote_NameServerMessageQ_Handle ti_sdo_ipc_nsremote_NameServerMessageQ_create( xdc_UInt16 procId, const ti_sdo_ipc_nsremote_NameServerMessageQ_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_nsremote_NameServerMessageQ_Args__create __args;
    __args.procId = procId;
    return (ti_sdo_ipc_nsremote_NameServerMessageQ_Handle)ti_sdo_ipc_nsremote_NameServerMessageQ_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_nsremote_NameServerMessageQ_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_nsremote_NameServerMessageQ_construct( ti_sdo_ipc_nsremote_NameServerMessageQ_Struct* __obj, xdc_UInt16 procId, const ti_sdo_ipc_nsremote_NameServerMessageQ_Params* __prms )
{
    ti_sdo_ipc_nsremote_NameServerMessageQ_Args__create __args;
    __args.procId = procId;
    ti_sdo_ipc_nsremote_NameServerMessageQ_Object__create__S(__obj, sizeof (ti_sdo_ipc_nsremote_NameServerMessageQ_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_nsremote_NameServerMessageQ_Params), NULL);
}

/* delete */
static inline void ti_sdo_ipc_nsremote_NameServerMessageQ_delete( ti_sdo_ipc_nsremote_NameServerMessageQ_Handle* instp )
{
    ti_sdo_ipc_nsremote_NameServerMessageQ_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_nsremote_NameServerMessageQ_destruct( ti_sdo_ipc_nsremote_NameServerMessageQ_Struct* obj )
{
    ti_sdo_ipc_nsremote_NameServerMessageQ_Object__destruct__S(obj);
}
...
#define NameServerMessageQ_get_fxnP ti_sdo_ipc_nsremote_NameServerMessageQ_get_fxnP
#define NameServerMessageQ_get_FxnT ti_sdo_ipc_nsremote_NameServerMessageQ_get_FxnT
...
#endif
/*
 *  @(#) ti.sdo.ipc.nsremote; 1, 0, 0, 0,; 5-10-2013 12:31:19; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
