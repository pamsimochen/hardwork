...
typedef const ti_sdo_ipc_nsremote_NameServerRemoteNotify_Fxns__* ti_sdo_ipc_nsremote_NameServerRemoteNotify_Module;
...
typedef const ti_sdo_ipc_nsremote_NameServerMessageQ_Fxns__* ti_sdo_ipc_nsremote_NameServerMessageQ_Module;
