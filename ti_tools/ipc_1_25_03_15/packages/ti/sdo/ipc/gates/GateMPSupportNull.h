...
#define ti_sdo_ipc_gates_GateMPSupportNull___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Instance_init__F, "ti_sdo_ipc_gates_GateMPSupportNull_Instance_init")
__extern void ti_sdo_ipc_gates_GateMPSupportNull_Instance_init__F( ti_sdo_ipc_gates_GateMPSupportNull_Object*, xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_gates_GateMPSupportNull_Params* );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Instance_init__R, "ti_sdo_ipc_gates_GateMPSupportNull_Instance_init")
__extern void ti_sdo_ipc_gates_GateMPSupportNull_Instance_init__R( ti_sdo_ipc_gates_GateMPSupportNull_Object*, xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_gates_GateMPSupportNull_Params* );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Handle__label__S, "ti_sdo_ipc_gates_GateMPSupportNull_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Module__startupDone__S, "ti_sdo_ipc_gates_GateMPSupportNull_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_gates_GateMPSupportNull_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Object__create__S, "ti_sdo_ipc_gates_GateMPSupportNull_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Object__delete__S, "ti_sdo_ipc_gates_GateMPSupportNull_Object__delete")
__extern xdc_Void ti_sdo_ipc_gates_GateMPSupportNull_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Object__destruct__S, "ti_sdo_ipc_gates_GateMPSupportNull_Object__destruct")
__extern xdc_Void ti_sdo_ipc_gates_GateMPSupportNull_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Object__get__S, "ti_sdo_ipc_gates_GateMPSupportNull_Object__get")
__extern xdc_Ptr ti_sdo_ipc_gates_GateMPSupportNull_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Object__first__S, "ti_sdo_ipc_gates_GateMPSupportNull_Object__first")
__extern xdc_Ptr ti_sdo_ipc_gates_GateMPSupportNull_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Object__next__S, "ti_sdo_ipc_gates_GateMPSupportNull_Object__next")
__extern xdc_Ptr ti_sdo_ipc_gates_GateMPSupportNull_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_Params__init__S, "ti_sdo_ipc_gates_GateMPSupportNull_Params__init")
__extern xdc_Void ti_sdo_ipc_gates_GateMPSupportNull_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_query__F, "ti_sdo_ipc_gates_GateMPSupportNull_query")
__extern xdc_Bool ti_sdo_ipc_gates_GateMPSupportNull_query__F( xdc_Int qual );
__extern xdc_Bool ti_sdo_ipc_gates_GateMPSupportNull_query__R( xdc_Int qual );
...
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_getReservedMask__F, "ti_sdo_ipc_gates_GateMPSupportNull_getReservedMask")
__extern xdc_Bits32* ti_sdo_ipc_gates_GateMPSupportNull_getReservedMask__F( void );
__extern xdc_Bits32* ti_sdo_ipc_gates_GateMPSupportNull_getReservedMask__R( void );
...
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_sharedMemReq__F, "ti_sdo_ipc_gates_GateMPSupportNull_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_gates_GateMPSupportNull_sharedMemReq__F( const ti_sdo_ipc_interfaces_IGateMPSupport_Params* params );
__extern xdc_SizeT ti_sdo_ipc_gates_GateMPSupportNull_sharedMemReq__R( const ti_sdo_ipc_interfaces_IGateMPSupport_Params* params );
...
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_enter__F, "ti_sdo_ipc_gates_GateMPSupportNull_enter")
__extern xdc_IArg ti_sdo_ipc_gates_GateMPSupportNull_enter__F( ti_sdo_ipc_gates_GateMPSupportNull_Object* __inst );
__extern xdc_IArg ti_sdo_ipc_gates_GateMPSupportNull_enter__R( ti_sdo_ipc_gates_GateMPSupportNull_Handle __inst );
...
xdc__CODESECT(ti_sdo_ipc_gates_GateMPSupportNull_leave__F, "ti_sdo_ipc_gates_GateMPSupportNull_leave")
__extern xdc_Void ti_sdo_ipc_gates_GateMPSupportNull_leave__F( ti_sdo_ipc_gates_GateMPSupportNull_Object* __inst, xdc_IArg key );
__extern xdc_Void ti_sdo_ipc_gates_GateMPSupportNull_leave__R( ti_sdo_ipc_gates_GateMPSupportNull_Handle __inst, xdc_IArg key );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*ti_sdo_ipc_gates_GateMPSupportNull_enter_FxnT)(void*);
static inline ti_sdo_ipc_gates_GateMPSupportNull_enter_FxnT ti_sdo_ipc_gates_GateMPSupportNull_enter_fxnP( void )
{
    return (ti_sdo_ipc_gates_GateMPSupportNull_enter_FxnT)ti_sdo_ipc_gates_GateMPSupportNull_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_gates_GateMPSupportNull_leave_FxnT)(void*, xdc_IArg);
static inline ti_sdo_ipc_gates_GateMPSupportNull_leave_FxnT ti_sdo_ipc_gates_GateMPSupportNull_leave_fxnP( void )
{
    return (ti_sdo_ipc_gates_GateMPSupportNull_leave_FxnT)ti_sdo_ipc_gates_GateMPSupportNull_leave; 
}
...
static inline ti_sdo_ipc_gates_GateMPSupportNull_Handle ti_sdo_ipc_gates_GateMPSupportNull_Handle_downCast( ti_sdo_ipc_interfaces_IGateMPSupport_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sdo_ipc_gates_GateMPSupportNull_Module__FXNS__C ? (ti_sdo_ipc_gates_GateMPSupportNull_Handle)i : 0;
}
...
{
    return ti_sdo_ipc_gates_GateMPSupportNull_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_gates_GateMPSupportNull_Module_getMask( void ) 
{
    return ti_sdo_ipc_gates_GateMPSupportNull_Module__diagsMask__C != NULL ? *ti_sdo_ipc_gates_GateMPSupportNull_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_gates_GateMPSupportNull_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_gates_GateMPSupportNull_Module__diagsMask__C != NULL) *ti_sdo_ipc_gates_GateMPSupportNull_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_gates_GateMPSupportNull_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_gates_GateMPSupportNull_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_gates_GateMPSupportNull_Handle_name( ti_sdo_ipc_gates_GateMPSupportNull_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_gates_GateMPSupportNull_Handle ti_sdo_ipc_gates_GateMPSupportNull_create( xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_gates_GateMPSupportNull_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_gates_GateMPSupportNull_Args__create __args;
    __args.localGate = localGate;
    return (ti_sdo_ipc_gates_GateMPSupportNull_Handle)ti_sdo_ipc_gates_GateMPSupportNull_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_gates_GateMPSupportNull_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_gates_GateMPSupportNull_construct( ti_sdo_ipc_gates_GateMPSupportNull_Struct* __obj, xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_gates_GateMPSupportNull_Params* __prms )
{
    ti_sdo_ipc_gates_GateMPSupportNull_Args__create __args;
    __args.localGate = localGate;
    ti_sdo_ipc_gates_GateMPSupportNull_Object__create__S(__obj, sizeof (ti_sdo_ipc_gates_GateMPSupportNull_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_gates_GateMPSupportNull_Params), NULL);
}

/* delete */
static inline void ti_sdo_ipc_gates_GateMPSupportNull_delete( ti_sdo_ipc_gates_GateMPSupportNull_Handle* instp )
{
    ti_sdo_ipc_gates_GateMPSupportNull_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_gates_GateMPSupportNull_destruct( ti_sdo_ipc_gates_GateMPSupportNull_Struct* obj )
{
    ti_sdo_ipc_gates_GateMPSupportNull_Object__destruct__S(obj);
}
...
#define GateMPSupportNull_enter_fxnP ti_sdo_ipc_gates_GateMPSupportNull_enter_fxnP
#define GateMPSupportNull_enter_FxnT ti_sdo_ipc_gates_GateMPSupportNull_enter_FxnT
#define GateMPSupportNull_leave ti_sdo_ipc_gates_GateMPSupportNull_leave
#define GateMPSupportNull_leave_fxnP ti_sdo_ipc_gates_GateMPSupportNull_leave_fxnP
#define GateMPSupportNull_leave_FxnT ti_sdo_ipc_gates_GateMPSupportNull_leave_FxnT
...
#endif
/*
 *  @(#) ti.sdo.ipc.gates; 1, 0, 0, 0,; 5-10-2013 12:30:59; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
