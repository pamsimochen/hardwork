...
#define ti_sdo_ipc_SharedRegion___VERS 150
...
xdc__CODESECT(ti_sdo_ipc_SharedRegion_Module__startupDone__S, "ti_sdo_ipc_SharedRegion_Module__startupDone")
...
__extern xdc_Int ti_sdo_ipc_SharedRegion_attach__R( xdc_UInt16 remoteProcId );
...
__extern xdc_Void ti_sdo_ipc_SharedRegion_clearReservedMemory__R( void );
...
__extern xdc_Int ti_sdo_ipc_SharedRegion_detach__R( xdc_UInt16 remoteProcId );
...
__extern xdc_Ptr ti_sdo_ipc_SharedRegion_reserveMemory__R( xdc_UInt16 id, xdc_SizeT size );
...
__extern xdc_Void ti_sdo_ipc_SharedRegion_resetInternalFields__R( xdc_UInt16 id );
...
__extern xdc_Int ti_sdo_ipc_SharedRegion_start__R( void );
...
__extern xdc_Int ti_sdo_ipc_SharedRegion_stop__R( void );
...
{
    return ti_sdo_ipc_SharedRegion_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_SharedRegion_Module_getMask( void ) 
{
    return ti_sdo_ipc_SharedRegion_Module__diagsMask__C != NULL ? *ti_sdo_ipc_SharedRegion_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_SharedRegion_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_SharedRegion_Module__diagsMask__C != NULL) *ti_sdo_ipc_SharedRegion_Module__diagsMask__C = mask;
}
