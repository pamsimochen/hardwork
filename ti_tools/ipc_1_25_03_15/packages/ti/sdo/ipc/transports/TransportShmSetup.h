...
#define ti_sdo_ipc_transports_TransportShmSetup___VERS 150
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmSetup_Module__startupDone__S, "ti_sdo_ipc_transports_TransportShmSetup_Module__startupDone")
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmSetup_attach__F, "ti_sdo_ipc_transports_TransportShmSetup_attach")
__extern xdc_Int ti_sdo_ipc_transports_TransportShmSetup_attach__F( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
__extern xdc_Int ti_sdo_ipc_transports_TransportShmSetup_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmSetup_detach__F, "ti_sdo_ipc_transports_TransportShmSetup_detach")
__extern xdc_Int ti_sdo_ipc_transports_TransportShmSetup_detach__F( xdc_UInt16 remoteProcId );
__extern xdc_Int ti_sdo_ipc_transports_TransportShmSetup_detach__R( xdc_UInt16 remoteProcId );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmSetup_isRegistered__F, "ti_sdo_ipc_transports_TransportShmSetup_isRegistered")
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmSetup_isRegistered__F( xdc_UInt16 remoteProcId );
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmSetup_isRegistered__R( xdc_UInt16 remoteProcId );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmSetup_sharedMemReq__F, "ti_sdo_ipc_transports_TransportShmSetup_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_transports_TransportShmSetup_sharedMemReq__F( xdc_Ptr sharedAddr );
__extern xdc_SizeT ti_sdo_ipc_transports_TransportShmSetup_sharedMemReq__R( xdc_Ptr sharedAddr );
...
{
    return ti_sdo_ipc_transports_TransportShmSetup_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_transports_TransportShmSetup_Module_getMask( void ) 
{
    return ti_sdo_ipc_transports_TransportShmSetup_Module__diagsMask__C != NULL ? *ti_sdo_ipc_transports_TransportShmSetup_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_transports_TransportShmSetup_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_transports_TransportShmSetup_Module__diagsMask__C != NULL) *ti_sdo_ipc_transports_TransportShmSetup_Module__diagsMask__C = mask;
}
