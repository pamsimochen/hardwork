...
#define ti_sdo_ipc_transports_TransportShmCirc___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Instance_init__F, "ti_sdo_ipc_transports_TransportShmCirc_Instance_init")
__extern int ti_sdo_ipc_transports_TransportShmCirc_Instance_init__F( ti_sdo_ipc_transports_TransportShmCirc_Object*, xdc_UInt16 procId, const ti_sdo_ipc_transports_TransportShmCirc_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Instance_finalize__F, "ti_sdo_ipc_transports_TransportShmCirc_Instance_finalize")
__extern void ti_sdo_ipc_transports_TransportShmCirc_Instance_finalize__F( ti_sdo_ipc_transports_TransportShmCirc_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Instance_init__R, "ti_sdo_ipc_transports_TransportShmCirc_Instance_init")
__extern int ti_sdo_ipc_transports_TransportShmCirc_Instance_init__R( ti_sdo_ipc_transports_TransportShmCirc_Object*, xdc_UInt16 procId, const ti_sdo_ipc_transports_TransportShmCirc_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Instance_finalize__R, "ti_sdo_ipc_transports_TransportShmCirc_Instance_finalize")
__extern void ti_sdo_ipc_transports_TransportShmCirc_Instance_finalize__R( ti_sdo_ipc_transports_TransportShmCirc_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Handle__label__S, "ti_sdo_ipc_transports_TransportShmCirc_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Module__startupDone__S, "ti_sdo_ipc_transports_TransportShmCirc_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmCirc_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Object__create__S, "ti_sdo_ipc_transports_TransportShmCirc_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Object__delete__S, "ti_sdo_ipc_transports_TransportShmCirc_Object__delete")
__extern xdc_Void ti_sdo_ipc_transports_TransportShmCirc_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Object__destruct__S, "ti_sdo_ipc_transports_TransportShmCirc_Object__destruct")
__extern xdc_Void ti_sdo_ipc_transports_TransportShmCirc_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Object__get__S, "ti_sdo_ipc_transports_TransportShmCirc_Object__get")
__extern xdc_Ptr ti_sdo_ipc_transports_TransportShmCirc_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Object__first__S, "ti_sdo_ipc_transports_TransportShmCirc_Object__first")
__extern xdc_Ptr ti_sdo_ipc_transports_TransportShmCirc_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Object__next__S, "ti_sdo_ipc_transports_TransportShmCirc_Object__next")
__extern xdc_Ptr ti_sdo_ipc_transports_TransportShmCirc_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_Params__init__S, "ti_sdo_ipc_transports_TransportShmCirc_Params__init")
__extern xdc_Void ti_sdo_ipc_transports_TransportShmCirc_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_setErrFxn__F, "ti_sdo_ipc_transports_TransportShmCirc_setErrFxn")
__extern xdc_Void ti_sdo_ipc_transports_TransportShmCirc_setErrFxn__F( ti_sdo_ipc_interfaces_IMessageQTransport_ErrFxn errFxn );
__extern xdc_Void ti_sdo_ipc_transports_TransportShmCirc_setErrFxn__R( ti_sdo_ipc_interfaces_IMessageQTransport_ErrFxn errFxn );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_getStatus__F, "ti_sdo_ipc_transports_TransportShmCirc_getStatus")
__extern xdc_Int ti_sdo_ipc_transports_TransportShmCirc_getStatus__F( ti_sdo_ipc_transports_TransportShmCirc_Object* __inst );
__extern xdc_Int ti_sdo_ipc_transports_TransportShmCirc_getStatus__R( ti_sdo_ipc_transports_TransportShmCirc_Handle __inst );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_put__F, "ti_sdo_ipc_transports_TransportShmCirc_put")
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmCirc_put__F( ti_sdo_ipc_transports_TransportShmCirc_Object* __inst, xdc_Ptr msg );
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmCirc_put__R( ti_sdo_ipc_transports_TransportShmCirc_Handle __inst, xdc_Ptr msg );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_control__F, "ti_sdo_ipc_transports_TransportShmCirc_control")
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmCirc_control__F( ti_sdo_ipc_transports_TransportShmCirc_Object* __inst, xdc_UInt cmd, xdc_UArg cmdArg );
__extern xdc_Bool ti_sdo_ipc_transports_TransportShmCirc_control__R( ti_sdo_ipc_transports_TransportShmCirc_Handle __inst, xdc_UInt cmd, xdc_UArg cmdArg );
...
xdc__CODESECT(ti_sdo_ipc_transports_TransportShmCirc_sharedMemReq__F, "ti_sdo_ipc_transports_TransportShmCirc_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_transports_TransportShmCirc_sharedMemReq__F( const ti_sdo_ipc_transports_TransportShmCirc_Params* params );
__extern xdc_SizeT ti_sdo_ipc_transports_TransportShmCirc_sharedMemReq__R( const ti_sdo_ipc_transports_TransportShmCirc_Params* params );
...
typedef xdc_Int (*ti_sdo_ipc_transports_TransportShmCirc_getStatus_FxnT)(void*);
static inline ti_sdo_ipc_transports_TransportShmCirc_getStatus_FxnT ti_sdo_ipc_transports_TransportShmCirc_getStatus_fxnP( void )
{
    return (ti_sdo_ipc_transports_TransportShmCirc_getStatus_FxnT)ti_sdo_ipc_transports_TransportShmCirc_getStatus; 
}

/* put_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sdo_ipc_transports_TransportShmCirc_put_FxnT)(void*, xdc_Ptr);
static inline ti_sdo_ipc_transports_TransportShmCirc_put_FxnT ti_sdo_ipc_transports_TransportShmCirc_put_fxnP( void )
{
    return (ti_sdo_ipc_transports_TransportShmCirc_put_FxnT)ti_sdo_ipc_transports_TransportShmCirc_put; 
}

/* control_{FxnT,fxnP} */
typedef xdc_Bool (*ti_sdo_ipc_transports_TransportShmCirc_control_FxnT)(void*, xdc_UInt, xdc_UArg);
static inline ti_sdo_ipc_transports_TransportShmCirc_control_FxnT ti_sdo_ipc_transports_TransportShmCirc_control_fxnP( void )
{
    return (ti_sdo_ipc_transports_TransportShmCirc_control_FxnT)ti_sdo_ipc_transports_TransportShmCirc_control; 
}
...
static inline ti_sdo_ipc_transports_TransportShmCirc_Handle ti_sdo_ipc_transports_TransportShmCirc_Handle_downCast( ti_sdo_ipc_interfaces_IMessageQTransport_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sdo_ipc_transports_TransportShmCirc_Module__FXNS__C ? (ti_sdo_ipc_transports_TransportShmCirc_Handle)i : 0;
}
...
{
    return ti_sdo_ipc_transports_TransportShmCirc_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_transports_TransportShmCirc_Module_getMask( void ) 
{
    return ti_sdo_ipc_transports_TransportShmCirc_Module__diagsMask__C != NULL ? *ti_sdo_ipc_transports_TransportShmCirc_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_transports_TransportShmCirc_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_transports_TransportShmCirc_Module__diagsMask__C != NULL) *ti_sdo_ipc_transports_TransportShmCirc_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_transports_TransportShmCirc_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_transports_TransportShmCirc_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_transports_TransportShmCirc_Handle_name( ti_sdo_ipc_transports_TransportShmCirc_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_transports_TransportShmCirc_Handle ti_sdo_ipc_transports_TransportShmCirc_create( xdc_UInt16 procId, const ti_sdo_ipc_transports_TransportShmCirc_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_transports_TransportShmCirc_Args__create __args;
    __args.procId = procId;
    return (ti_sdo_ipc_transports_TransportShmCirc_Handle)ti_sdo_ipc_transports_TransportShmCirc_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_transports_TransportShmCirc_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_transports_TransportShmCirc_construct( ti_sdo_ipc_transports_TransportShmCirc_Struct* __obj, xdc_UInt16 procId, const ti_sdo_ipc_transports_TransportShmCirc_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_transports_TransportShmCirc_Args__create __args;
    __args.procId = procId;
    ti_sdo_ipc_transports_TransportShmCirc_Object__create__S(__obj, sizeof (ti_sdo_ipc_transports_TransportShmCirc_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_transports_TransportShmCirc_Params), __eb);
}

/* delete */
static inline void ti_sdo_ipc_transports_TransportShmCirc_delete( ti_sdo_ipc_transports_TransportShmCirc_Handle* instp )
{
    ti_sdo_ipc_transports_TransportShmCirc_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_transports_TransportShmCirc_destruct( ti_sdo_ipc_transports_TransportShmCirc_Struct* obj )
{
    ti_sdo_ipc_transports_TransportShmCirc_Object__destruct__S(obj);
}
...
#define TransportShmCirc_getStatus_fxnP ti_sdo_ipc_transports_TransportShmCirc_getStatus_fxnP
#define TransportShmCirc_getStatus_FxnT ti_sdo_ipc_transports_TransportShmCirc_getStatus_FxnT
#define TransportShmCirc_put ti_sdo_ipc_transports_TransportShmCirc_put
#define TransportShmCirc_put_fxnP ti_sdo_ipc_transports_TransportShmCirc_put_fxnP
#define TransportShmCirc_put_FxnT ti_sdo_ipc_transports_TransportShmCirc_put_FxnT
#define TransportShmCirc_control ti_sdo_ipc_transports_TransportShmCirc_control
#define TransportShmCirc_control_fxnP ti_sdo_ipc_transports_TransportShmCirc_control_fxnP
#define TransportShmCirc_control_FxnT ti_sdo_ipc_transports_TransportShmCirc_control_FxnT
