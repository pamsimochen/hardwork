...
public class ti_sdo_ipc_examples
{
    ...
    void Examples$$TYPES()
    {
        ...
        po.addFld("root", (Proto)om.findStrict("xdc.tools.product.IProductTemplate.TemplateGroup", "ti.sdo.ipc.examples"), Global.newObject("id", "ti.sdo.ipc.examples.root", "name", "IPC Examples", "description", "IPC Examples"), "wh");
        po.addFld("generic", (Proto)om.findStrict("xdc.tools.product.IProductTemplate.TemplateGroup", "ti.sdo.ipc.examples"), Global.newObject("id", "ti.sdo.ipc.examples.root.generic", "name", "Generic IPC Examples", "description", "Generic IPC Examples", "groups", Global.newArray(new Object[]{"ti.sdo.ipc.examples.root"})), "wh");
        po.addFld("templateGroupArr", new Proto.Arr((Proto)om.findStrict("xdc.tools.product.IProductTemplate.TemplateGroup", "ti.sdo.ipc.examples"), false), Global.newArray(new Object[]{Global.newObject("id", "ti.sdo.ipc.examples.root", "name", "IPC Examples", "description", "IPC Examples"), Global.newObject("id", "ti.sdo.ipc.examples.root.generic", "name", "Generic IPC Examples", "description", "Generic IPC Examples", "groups", Global.newArray(new Object[]{"ti.sdo.ipc.examples.root"}))}), "wh");
