...
#define ti_sdo_ipc_MessageQ___VERS 150
...
typedef ti_sdo_ipc_interfaces_IMessageQTransport_Handle (*__ARRAY2_ti_sdo_ipc_MessageQ_Module_State__transports)[2];
...
xdc__CODESECT(ti_sdo_ipc_MessageQ_Module_startup__R, "ti_sdo_ipc_MessageQ_Module_startup")
__extern xdc_Int ti_sdo_ipc_MessageQ_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Instance_init__F, "ti_sdo_ipc_MessageQ_Instance_init")
__extern int ti_sdo_ipc_MessageQ_Instance_init__F( ti_sdo_ipc_MessageQ_Object*, xdc_String name, const ti_sdo_ipc_MessageQ_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Instance_finalize__F, "ti_sdo_ipc_MessageQ_Instance_finalize")
__extern void ti_sdo_ipc_MessageQ_Instance_finalize__F( ti_sdo_ipc_MessageQ_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Instance_init__R, "ti_sdo_ipc_MessageQ_Instance_init")
__extern int ti_sdo_ipc_MessageQ_Instance_init__R( ti_sdo_ipc_MessageQ_Object*, xdc_String name, const ti_sdo_ipc_MessageQ_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Instance_finalize__R, "ti_sdo_ipc_MessageQ_Instance_finalize")
__extern void ti_sdo_ipc_MessageQ_Instance_finalize__R( ti_sdo_ipc_MessageQ_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Handle__label__S, "ti_sdo_ipc_MessageQ_Handle__label")
__extern xdc_runtime_Types_Label* ti_sdo_ipc_MessageQ_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Module__startupDone__S, "ti_sdo_ipc_MessageQ_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_MessageQ_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Object__create__S, "ti_sdo_ipc_MessageQ_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Object__delete__S, "ti_sdo_ipc_MessageQ_Object__delete")
__extern xdc_Void ti_sdo_ipc_MessageQ_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Object__destruct__S, "ti_sdo_ipc_MessageQ_Object__destruct")
__extern xdc_Void ti_sdo_ipc_MessageQ_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Object__get__S, "ti_sdo_ipc_MessageQ_Object__get")
__extern xdc_Ptr ti_sdo_ipc_MessageQ_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Object__first__S, "ti_sdo_ipc_MessageQ_Object__first")
__extern xdc_Ptr ti_sdo_ipc_MessageQ_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Object__next__S, "ti_sdo_ipc_MessageQ_Object__next")
__extern xdc_Ptr ti_sdo_ipc_MessageQ_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_MessageQ_Params__init__S, "ti_sdo_ipc_MessageQ_Params__init")
__extern xdc_Void ti_sdo_ipc_MessageQ_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_Bool ti_sdo_ipc_MessageQ_registerTransport__R( ti_sdo_ipc_interfaces_IMessageQTransport_Handle transport, xdc_UInt16 procId, xdc_UInt priority );
...
__extern xdc_Void ti_sdo_ipc_MessageQ_unregisterTransport__R( xdc_UInt16 procId, xdc_UInt priority );
...
{
    return ti_sdo_ipc_MessageQ_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_MessageQ_Module_getMask( void ) 
{
    return ti_sdo_ipc_MessageQ_Module__diagsMask__C != NULL ? *ti_sdo_ipc_MessageQ_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_MessageQ_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_MessageQ_Module__diagsMask__C != NULL) *ti_sdo_ipc_MessageQ_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_MessageQ_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_MessageQ_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_MessageQ_Handle_name( ti_sdo_ipc_MessageQ_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_MessageQ_Handle ti_sdo_ipc_MessageQ_create( xdc_String name, const ti_sdo_ipc_MessageQ_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_MessageQ_Args__create __args;
    __args.name = name;
    return (ti_sdo_ipc_MessageQ_Handle)ti_sdo_ipc_MessageQ_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_MessageQ_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_MessageQ_construct( ti_sdo_ipc_MessageQ_Struct* __obj, xdc_String name, const ti_sdo_ipc_MessageQ_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_MessageQ_Args__create __args;
    __args.name = name;
    ti_sdo_ipc_MessageQ_Object__create__S(__obj, sizeof (ti_sdo_ipc_MessageQ_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_MessageQ_Params), __eb);
}

/* delete */
static inline void ti_sdo_ipc_MessageQ_delete( ti_sdo_ipc_MessageQ_Handle* instp )
{
    ti_sdo_ipc_MessageQ_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_MessageQ_destruct( ti_sdo_ipc_MessageQ_Struct* obj )
{
    ti_sdo_ipc_MessageQ_Object__destruct__S(obj);
}
