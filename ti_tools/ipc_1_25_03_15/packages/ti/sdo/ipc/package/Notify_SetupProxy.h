...
#define ti_sdo_ipc_Notify_SetupProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Handle__label__S, "ti_sdo_ipc_Notify_SetupProxy_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Module__startupDone__S, "ti_sdo_ipc_Notify_SetupProxy_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_Notify_SetupProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Object__create__S, "ti_sdo_ipc_Notify_SetupProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Object__delete__S, "ti_sdo_ipc_Notify_SetupProxy_Object__delete")
__extern xdc_Void ti_sdo_ipc_Notify_SetupProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Object__destruct__S, "ti_sdo_ipc_Notify_SetupProxy_Object__destruct")
__extern xdc_Void ti_sdo_ipc_Notify_SetupProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Object__get__S, "ti_sdo_ipc_Notify_SetupProxy_Object__get")
__extern xdc_Ptr ti_sdo_ipc_Notify_SetupProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Object__first__S, "ti_sdo_ipc_Notify_SetupProxy_Object__first")
__extern xdc_Ptr ti_sdo_ipc_Notify_SetupProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Object__next__S, "ti_sdo_ipc_Notify_SetupProxy_Object__next")
__extern xdc_Ptr ti_sdo_ipc_Notify_SetupProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Params__init__S, "ti_sdo_ipc_Notify_SetupProxy_Params__init")
__extern xdc_Void ti_sdo_ipc_Notify_SetupProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Proxy__abstract__S, "ti_sdo_ipc_Notify_SetupProxy_Proxy__abstract")
__extern xdc_Bool ti_sdo_ipc_Notify_SetupProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_Proxy__delegate__S, "ti_sdo_ipc_Notify_SetupProxy_Proxy__delegate")
...
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_attach__R, "ti_sdo_ipc_Notify_SetupProxy_attach")
__extern xdc_Int ti_sdo_ipc_Notify_SetupProxy_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_sharedMemReq__R, "ti_sdo_ipc_Notify_SetupProxy_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_Notify_SetupProxy_sharedMemReq__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_Notify_SetupProxy_numIntLines__R, "ti_sdo_ipc_Notify_SetupProxy_numIntLines")
__extern xdc_UInt16 ti_sdo_ipc_Notify_SetupProxy_numIntLines__R( xdc_UInt16 remoteProcId );
