...
typedef const ti_sdo_ipc_GateMP_RemoteSystemProxy_Fxns__* ti_sdo_ipc_GateMP_RemoteSystemProxy_Module;
...
typedef const ti_sdo_ipc_GateMP_RemoteCustom1Proxy_Fxns__* ti_sdo_ipc_GateMP_RemoteCustom1Proxy_Module;
...
typedef const ti_sdo_ipc_GateMP_RemoteCustom2Proxy_Fxns__* ti_sdo_ipc_GateMP_RemoteCustom2Proxy_Module;
...
typedef const ti_sdo_ipc_MessageQ_SetupTransportProxy_Fxns__* ti_sdo_ipc_MessageQ_SetupTransportProxy_Module;
...
typedef const ti_sdo_ipc_Notify_SetupProxy_Fxns__* ti_sdo_ipc_Notify_SetupProxy_Module;
...
typedef const ti_sdo_ipc_Notify_Module_GateProxy_Fxns__* ti_sdo_ipc_Notify_Module_GateProxy_Module;
