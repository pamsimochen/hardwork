...
#define ti_sdo_ipc_GateMP_RemoteSystemProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle__label__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Module__startupDone__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_GateMP_RemoteSystemProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__create__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__delete__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__delete")
__extern xdc_Void ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__destruct__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__destruct")
__extern xdc_Void ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__get__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__get")
__extern xdc_Ptr ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__first__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__first")
__extern xdc_Ptr ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__next__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__next")
__extern xdc_Ptr ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Params__init__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Params__init")
__extern xdc_Void ti_sdo_ipc_GateMP_RemoteSystemProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__abstract__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__abstract")
__extern xdc_Bool ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__delegate__S, "ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__delegate")
...
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_query__R, "ti_sdo_ipc_GateMP_RemoteSystemProxy_query")
__extern xdc_Bool ti_sdo_ipc_GateMP_RemoteSystemProxy_query__R( xdc_Int qual );
...
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_enter__R, "ti_sdo_ipc_GateMP_RemoteSystemProxy_enter")
__extern xdc_IArg ti_sdo_ipc_GateMP_RemoteSystemProxy_enter__R( ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle __inst );
...
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_leave__R, "ti_sdo_ipc_GateMP_RemoteSystemProxy_leave")
__extern xdc_Void ti_sdo_ipc_GateMP_RemoteSystemProxy_leave__R( ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle __inst, xdc_IArg key );
...
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_getReservedMask__R, "ti_sdo_ipc_GateMP_RemoteSystemProxy_getReservedMask")
__extern xdc_Bits32* ti_sdo_ipc_GateMP_RemoteSystemProxy_getReservedMask__R( void );
...
xdc__CODESECT(ti_sdo_ipc_GateMP_RemoteSystemProxy_sharedMemReq__R, "ti_sdo_ipc_GateMP_RemoteSystemProxy_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_GateMP_RemoteSystemProxy_sharedMemReq__R( const ti_sdo_ipc_interfaces_IGateMPSupport_Params* params );
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*ti_sdo_ipc_GateMP_RemoteSystemProxy_enter_FxnT)(void*);
static inline ti_sdo_ipc_GateMP_RemoteSystemProxy_enter_FxnT ti_sdo_ipc_GateMP_RemoteSystemProxy_enter_fxnP( void )
{
    return (ti_sdo_ipc_GateMP_RemoteSystemProxy_enter_FxnT)ti_sdo_ipc_GateMP_RemoteSystemProxy_enter; 
}

/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_GateMP_RemoteSystemProxy_leave_FxnT)(void*, xdc_IArg);
static inline ti_sdo_ipc_GateMP_RemoteSystemProxy_leave_FxnT ti_sdo_ipc_GateMP_RemoteSystemProxy_leave_fxnP( void )
{
    return (ti_sdo_ipc_GateMP_RemoteSystemProxy_leave_FxnT)ti_sdo_ipc_GateMP_RemoteSystemProxy_leave; 
}
...
if (ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__abstract__S()) return (ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle)i;
    return (void*)i2->__fxns == (void*)ti_sdo_ipc_GateMP_RemoteSystemProxy_Proxy__delegate__S() ? (ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle)i : 0;
}
...
{
    if (dst) {
        ti_sdo_ipc_GateMP_RemoteSystemProxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_GateMP_RemoteSystemProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle ti_sdo_ipc_GateMP_RemoteSystemProxy_create( xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_GateMP_RemoteSystemProxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_GateMP_RemoteSystemProxy_Args__create __args;
    __args.localGate = localGate;
    return (ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle)ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_GateMP_RemoteSystemProxy_Params), __eb);
}

/* delete */
static inline void ti_sdo_ipc_GateMP_RemoteSystemProxy_delete( ti_sdo_ipc_GateMP_RemoteSystemProxy_Handle* instp )
{
    ti_sdo_ipc_GateMP_RemoteSystemProxy_Object__delete__S(instp);
}
...
#define GateMP_RemoteSystemProxy_enter_fxnP ti_sdo_ipc_GateMP_RemoteSystemProxy_enter_fxnP
#define GateMP_RemoteSystemProxy_enter_FxnT ti_sdo_ipc_GateMP_RemoteSystemProxy_enter_FxnT
#define GateMP_RemoteSystemProxy_leave ti_sdo_ipc_GateMP_RemoteSystemProxy_leave
#define GateMP_RemoteSystemProxy_leave_fxnP ti_sdo_ipc_GateMP_RemoteSystemProxy_leave_fxnP
#define GateMP_RemoteSystemProxy_leave_FxnT ti_sdo_ipc_GateMP_RemoteSystemProxy_leave_FxnT
