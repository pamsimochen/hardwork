...
#define ti_sdo_ipc_GateMP___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_GateMP_Instance_init__F, "ti_sdo_ipc_GateMP_Instance_init")
__extern int ti_sdo_ipc_GateMP_Instance_init__F( ti_sdo_ipc_GateMP_Object*, const ti_sdo_ipc_GateMP_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_ipc_GateMP_Instance_finalize__F, "ti_sdo_ipc_GateMP_Instance_finalize")
__extern void ti_sdo_ipc_GateMP_Instance_finalize__F( ti_sdo_ipc_GateMP_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_GateMP_Instance_init__R, "ti_sdo_ipc_GateMP_Instance_init")
__extern int ti_sdo_ipc_GateMP_Instance_init__R( ti_sdo_ipc_GateMP_Object*, const ti_sdo_ipc_GateMP_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_ipc_GateMP_Instance_finalize__R, "ti_sdo_ipc_GateMP_Instance_finalize")
__extern void ti_sdo_ipc_GateMP_Instance_finalize__R( ti_sdo_ipc_GateMP_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Handle__label__S, "ti_sdo_ipc_GateMP_Handle__label")
__extern xdc_runtime_Types_Label* ti_sdo_ipc_GateMP_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Module__startupDone__S, "ti_sdo_ipc_GateMP_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_GateMP_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Object__create__S, "ti_sdo_ipc_GateMP_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Object__delete__S, "ti_sdo_ipc_GateMP_Object__delete")
__extern xdc_Void ti_sdo_ipc_GateMP_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Object__destruct__S, "ti_sdo_ipc_GateMP_Object__destruct")
__extern xdc_Void ti_sdo_ipc_GateMP_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Object__get__S, "ti_sdo_ipc_GateMP_Object__get")
__extern xdc_Ptr ti_sdo_ipc_GateMP_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Object__first__S, "ti_sdo_ipc_GateMP_Object__first")
__extern xdc_Ptr ti_sdo_ipc_GateMP_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Object__next__S, "ti_sdo_ipc_GateMP_Object__next")
__extern xdc_Ptr ti_sdo_ipc_GateMP_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_GateMP_Params__init__S, "ti_sdo_ipc_GateMP_Params__init")
__extern xdc_Void ti_sdo_ipc_GateMP_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
__extern xdc_runtime_IGateProvider_Handle ti_sdo_ipc_GateMP_createLocal__R( ti_sdo_ipc_GateMP_LocalProtect localProtect );
...
__extern xdc_Int ti_sdo_ipc_GateMP_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
__extern xdc_Int ti_sdo_ipc_GateMP_detach__R( xdc_UInt16 remoteProcId );
...
__extern xdc_SizeT ti_sdo_ipc_GateMP_getRegion0ReservedSize__R( void );
...
__extern xdc_Void ti_sdo_ipc_GateMP_setRegion0Reserved__R( xdc_Ptr sharedAddr );
...
__extern xdc_Void ti_sdo_ipc_GateMP_openRegion0Reserved__R( xdc_Ptr sharedAddr );
...
__extern xdc_Void ti_sdo_ipc_GateMP_setDefaultRemote__R( ti_sdo_ipc_GateMP_Handle handle );
...
__extern xdc_Int ti_sdo_ipc_GateMP_start__R( xdc_Ptr sharedAddr );
...
__extern xdc_Int ti_sdo_ipc_GateMP_stop__R( void );
...
__extern ti_sdo_ipc_SharedRegion_SRPtr ti_sdo_ipc_GateMP_getSharedAddr__R( ti_sdo_ipc_GateMP_Handle __inst );
...
/* getSharedAddr_{FxnT,fxnP} */
typedef ti_sdo_ipc_SharedRegion_SRPtr (*ti_sdo_ipc_GateMP_getSharedAddr_FxnT)(void*);
static inline ti_sdo_ipc_GateMP_getSharedAddr_FxnT ti_sdo_ipc_GateMP_getSharedAddr_fxnP( void )
{
    return (ti_sdo_ipc_GateMP_getSharedAddr_FxnT)ti_sdo_ipc_GateMP_getSharedAddr; 
}
...
{
    return ti_sdo_ipc_GateMP_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_GateMP_Module_getMask( void ) 
{
    return ti_sdo_ipc_GateMP_Module__diagsMask__C != NULL ? *ti_sdo_ipc_GateMP_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_GateMP_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_GateMP_Module__diagsMask__C != NULL) *ti_sdo_ipc_GateMP_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_GateMP_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_GateMP_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_GateMP_Handle_name( ti_sdo_ipc_GateMP_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_GateMP_Handle ti_sdo_ipc_GateMP_create( const ti_sdo_ipc_GateMP_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sdo_ipc_GateMP_Handle)ti_sdo_ipc_GateMP_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_GateMP_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_GateMP_construct( ti_sdo_ipc_GateMP_Struct* __obj, const ti_sdo_ipc_GateMP_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_GateMP_Object__create__S(__obj, sizeof (ti_sdo_ipc_GateMP_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_GateMP_Params), __eb);
}

/* delete */
static inline void ti_sdo_ipc_GateMP_delete( ti_sdo_ipc_GateMP_Handle* instp )
{
    ti_sdo_ipc_GateMP_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_GateMP_destruct( ti_sdo_ipc_GateMP_Struct* obj )
{
    ti_sdo_ipc_GateMP_Object__destruct__S(obj);
}
...
#define GateMP_getSharedAddr_fxnP ti_sdo_ipc_GateMP_getSharedAddr_fxnP
#define GateMP_getSharedAddr_FxnT ti_sdo_ipc_GateMP_getSharedAddr_FxnT
...
#endif
/*
 *  @(#) ti.sdo.ipc; 1, 0, 0, 0,; 5-10-2013 12:29:42; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
