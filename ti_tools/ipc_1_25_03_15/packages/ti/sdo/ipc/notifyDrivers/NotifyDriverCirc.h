...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverCirc___VERS 150
...
/* Instance_init__F */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init")
__extern void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object*, const ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize")
__extern void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init__R, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init")
__extern void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object*, const ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize__R, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize")
__extern void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle__label__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle__label")
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__startupDone__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__startupDone")
__extern xdc_Bool ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__create__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__delete__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__delete")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__destruct__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__destruct")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__get__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__get")
__extern xdc_Ptr ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__first__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__first")
__extern xdc_Ptr ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__next__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__next")
__extern xdc_Ptr ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params__init__S, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params__init")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst, xdc_UInt32 eventId );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst, xdc_UInt32 eventId );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst, xdc_UInt32 eventId );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst, xdc_UInt32 eventId );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent")
__extern xdc_Int ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst, xdc_UInt32 eventId, xdc_UInt32 payload, xdc_Bool waitClear );
__extern xdc_Int ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst, xdc_UInt32 eventId, xdc_UInt32 payload, xdc_Bool waitClear );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst, xdc_UInt32 eventId );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst, xdc_UInt32 eventId );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst, xdc_UInt32 eventId );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst, xdc_UInt32 eventId );
...
xdc__CODESECT(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle__F, "ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle")
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle__F( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object* __inst, xdc_Ptr driverHandle );
__extern xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle__R( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle __inst, xdc_Ptr driverHandle );
...
__extern xdc_SizeT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sharedMemReq__R( const ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params* params );
...
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent_FxnT)(void*, xdc_UInt32);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent; 
}

/* unregisterEvent_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent_FxnT)(void*, xdc_UInt32);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent; 
}

/* sendEvent_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent_FxnT)(void*, xdc_UInt32, xdc_UInt32, xdc_Bool);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent; 
}

/* disable_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable_FxnT)(void*);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable; 
}

/* enable_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable_FxnT)(void*);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable; 
}

/* disableEvent_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent_FxnT)(void*, xdc_UInt32);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent; 
}

/* enableEvent_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent_FxnT)(void*, xdc_UInt32);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent; 
}

/* setNotifyHandle_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle_FxnT)(void*, xdc_Ptr);
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle_fxnP( void )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle_FxnT)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle; 
}
...
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle_downCast( ti_sdo_ipc_interfaces_INotifyDriver_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__FXNS__C ? (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle)i : 0;
}
...
{
    return ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module_getMask( void ) 
{
    return ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__diagsMask__C != NULL ? *ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__diagsMask__C != NULL) *ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle_name( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle inst )
{
...
/* create */
static inline ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_create( const ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    return (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle)ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__create__S(0, 0, 0, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params), __eb);
}

/* construct */
static inline void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_construct( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Struct* __obj, const ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params* __prms )
{
    ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__create__S(__obj, sizeof (ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Struct), 0, (const xdc_UChar*)__prms, sizeof(ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Params), NULL);
}

/* delete */
static inline void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_delete( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Handle* instp )
{
    ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_destruct( ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Struct* obj )
{
    ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Object__destruct__S(obj);
}
...
#define NotifyDriverCirc_registerEvent_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent_fxnP
#define NotifyDriverCirc_registerEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_registerEvent_FxnT
#define NotifyDriverCirc_unregisterEvent ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent
#define NotifyDriverCirc_unregisterEvent_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent_fxnP
#define NotifyDriverCirc_unregisterEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_unregisterEvent_FxnT
#define NotifyDriverCirc_sendEvent ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent
#define NotifyDriverCirc_sendEvent_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent_fxnP
#define NotifyDriverCirc_sendEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_sendEvent_FxnT
#define NotifyDriverCirc_disable ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable
#define NotifyDriverCirc_disable_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable_fxnP
#define NotifyDriverCirc_disable_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disable_FxnT
#define NotifyDriverCirc_enable ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable
#define NotifyDriverCirc_enable_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable_fxnP
#define NotifyDriverCirc_enable_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enable_FxnT
#define NotifyDriverCirc_disableEvent ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent
#define NotifyDriverCirc_disableEvent_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent_fxnP
#define NotifyDriverCirc_disableEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_disableEvent_FxnT
#define NotifyDriverCirc_enableEvent ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent
#define NotifyDriverCirc_enableEvent_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent_fxnP
#define NotifyDriverCirc_enableEvent_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_enableEvent_FxnT
#define NotifyDriverCirc_setNotifyHandle ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle
#define NotifyDriverCirc_setNotifyHandle_fxnP ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle_fxnP
#define NotifyDriverCirc_setNotifyHandle_FxnT ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_setNotifyHandle_FxnT
...
#endif
/*
 *  @(#) ti.sdo.ipc.notifyDrivers; 1, 0, 0, 0,; 5-10-2013 12:31:13; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
