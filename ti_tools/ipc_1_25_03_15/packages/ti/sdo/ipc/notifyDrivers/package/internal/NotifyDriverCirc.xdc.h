...
#define ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module_startup ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Module_startup__F

/* Instance_init */
#undef ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init
#define ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_init__F

/* Instance_finalize */
#undef ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize
#define ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize ti_sdo_ipc_notifyDrivers_NotifyDriverCirc_Instance_finalize__F
