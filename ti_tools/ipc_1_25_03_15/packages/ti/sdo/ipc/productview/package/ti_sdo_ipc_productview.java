...
public class ti_sdo_ipc_productview
{
    ...
    void IpcProductView$$TYPES()
    {
        ...
        po.addFld("ti_sdo_io_Stream", (Proto)om.findStrict("ti.sdo.ipc.productview.IpcProductView.ProductElemDesc", "ti.sdo.ipc.productview"), $$DEFAULT, "wh");
        po.addFld("ti_sdo_io_DriverTable", (Proto)om.findStrict("ti.sdo.ipc.productview.IpcProductView.ProductElemDesc", "ti.sdo.ipc.productview"), $$DEFAULT, "wh");
        po.addFld("ti_sdo_io_converters_Transformer", (Proto)om.findStrict("ti.sdo.ipc.productview.IpcProductView.ProductElemDesc", "ti.sdo.ipc.productview"), $$DEFAULT, "wh");
        po.addFld("ti_sdo_io_drivers_Generator", (Proto)om.findStrict("ti.sdo.ipc.productview.IpcProductView.ProductElemDesc", "ti.sdo.ipc.productview"), $$DEFAULT, "wh");
        po.addFld("ti_sdo_io_drivers_IomAdapter", (Proto)om.findStrict("ti.sdo.ipc.productview.IpcProductView.ProductElemDesc", "ti.sdo.ipc.productview"), $$DEFAULT, "wh");
        ...
        po.addFld("ioGroup", (Proto)om.findStrict("ti.sdo.ipc.productview.IpcProductView.ProductElemDesc", "ti.sdo.ipc.productview"), $$DEFAULT, "wh");
