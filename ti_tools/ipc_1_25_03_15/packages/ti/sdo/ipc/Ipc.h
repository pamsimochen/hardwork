...
#define ti_sdo_ipc_Ipc___VERS 150
...
xdc__CODESECT(ti_sdo_ipc_Ipc_Module__startupDone__S, "ti_sdo_ipc_Ipc_Module__startupDone")
...
__extern xdc_Void ti_sdo_ipc_Ipc_getEntry__R( ti_sdo_ipc_Ipc_Entry* entry );
...
__extern xdc_Void ti_sdo_ipc_Ipc_setEntry__R( ti_sdo_ipc_Ipc_Entry* entry );
...
__extern xdc_Void ti_sdo_ipc_Ipc_dummy__R( void );
...
{
    return ti_sdo_ipc_Ipc_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_Ipc_Module_getMask( void ) 
{
    return ti_sdo_ipc_Ipc_Module__diagsMask__C != NULL ? *ti_sdo_ipc_Ipc_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_Ipc_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_Ipc_Module__diagsMask__C != NULL) *ti_sdo_ipc_Ipc_Module__diagsMask__C = mask;
}
