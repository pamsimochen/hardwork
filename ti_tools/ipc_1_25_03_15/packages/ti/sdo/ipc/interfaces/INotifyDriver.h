...
#define ti_sdo_ipc_interfaces_INotifyDriver___VERS 150
...
/* delete */
static inline void ti_sdo_ipc_interfaces_INotifyDriver_delete( ti_sdo_ipc_interfaces_INotifyDriver_Handle* instp )
{
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_registerEvent_FxnT)(void*, xdc_UInt32);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_unregisterEvent_FxnT)(void*, xdc_UInt32);
...
typedef xdc_Int (*ti_sdo_ipc_interfaces_INotifyDriver_sendEvent_FxnT)(void*, xdc_UInt32, xdc_UInt32, xdc_Bool);
...
/* disable_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_disable_FxnT)(void*);
...
/* enable_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_enable_FxnT)(void*);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_disableEvent_FxnT)(void*, xdc_UInt32);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_enableEvent_FxnT)(void*, xdc_UInt32);
...
typedef xdc_Void (*ti_sdo_ipc_interfaces_INotifyDriver_setNotifyHandle_FxnT)(void*, xdc_Ptr);
...
#endif
/*
 *  @(#) ti.sdo.ipc.interfaces; 1, 0, 0, 0,; 5-10-2013 12:31:10; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
