...
#define ti_sdo_ipc_interfaces_IGateMPSupport___VERS 150
...
/* create */
static inline ti_sdo_ipc_interfaces_IGateMPSupport_Handle ti_sdo_ipc_interfaces_IGateMPSupport_create( ti_sdo_ipc_interfaces_IGateMPSupport_Module __mod, xdc_runtime_IGateProvider_Handle localGate, const ti_sdo_ipc_interfaces_IGateMPSupport_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_ipc_interfaces_IGateMPSupport_Args__create __args;
    __args.localGate = localGate;
    return (ti_sdo_ipc_interfaces_IGateMPSupport_Handle) __mod->__sysp->__create(0, 0, &__args, (const xdc_UChar*)__prms, sizeof (ti_sdo_ipc_interfaces_IGateMPSupport_Params), __eb);
}

/* delete */
static inline void ti_sdo_ipc_interfaces_IGateMPSupport_delete( ti_sdo_ipc_interfaces_IGateMPSupport_Handle* instp )
{
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*ti_sdo_ipc_interfaces_IGateMPSupport_enter_FxnT)(void*);
...
/* leave_{FxnT,fxnP} */
typedef xdc_Void (*ti_sdo_ipc_interfaces_IGateMPSupport_leave_FxnT)(void*, xdc_IArg);
...
static inline ti_sdo_ipc_interfaces_IGateMPSupport_Module ti_sdo_ipc_interfaces_IGateMPSupport_Module_downCast( xdc_runtime_IGateProvider_Module m )
{
    xdc_runtime_Types_Base* b; for (b = m->__base; b; b = b->base) {
        if (b == &ti_sdo_ipc_interfaces_IGateMPSupport_Interface__BASE__C) return (ti_sdo_ipc_interfaces_IGateMPSupport_Module)m;
    } return 0;
}
...
static inline ti_sdo_ipc_interfaces_IGateMPSupport_Handle ti_sdo_ipc_interfaces_IGateMPSupport_Handle_downCast( xdc_runtime_IGateProvider_Handle i )
{
    ...
    xdc_runtime_Types_Base* b; for (b = i2->__fxns->__base; b; b = b->base) {
        if (b == &ti_sdo_ipc_interfaces_IGateMPSupport_Interface__BASE__C) return (ti_sdo_ipc_interfaces_IGateMPSupport_Handle)i;
    } return 0;
}
...
#endif
/*
 *  @(#) ti.sdo.ipc.interfaces; 1, 0, 0, 0,; 5-10-2013 12:31:09; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
