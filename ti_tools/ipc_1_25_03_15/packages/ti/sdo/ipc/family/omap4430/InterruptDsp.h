...
#define ti_sdo_ipc_family_omap4430_InterruptDsp___VERS 150
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_Module__startupDone__S, "ti_sdo_ipc_family_omap4430_InterruptDsp_Module__startupDone")
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intEnable__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intEnable")
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intEnable__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intEnable__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intDisable__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intDisable")
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intDisable__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intDisable__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intRegister__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intRegister")
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intRegister__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_Fxn func, xdc_UArg arg );
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intRegister__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_Fxn func, xdc_UArg arg );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intUnregister__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intUnregister")
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intUnregister__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intUnregister__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intSend__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intSend")
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intSend__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intSend__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intPost__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intPost")
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intPost__F( xdc_UInt16 srcProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
__extern xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_intPost__R( xdc_UInt16 srcProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_InterruptDsp_intClear__F, "ti_sdo_ipc_family_omap4430_InterruptDsp_intClear")
__extern xdc_UInt ti_sdo_ipc_family_omap4430_InterruptDsp_intClear__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_UInt ti_sdo_ipc_family_omap4430_InterruptDsp_intClear__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
{
    return ti_sdo_ipc_family_omap4430_InterruptDsp_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_family_omap4430_InterruptDsp_Module_getMask( void ) 
{
    return ti_sdo_ipc_family_omap4430_InterruptDsp_Module__diagsMask__C != NULL ? *ti_sdo_ipc_family_omap4430_InterruptDsp_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_family_omap4430_InterruptDsp_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_family_omap4430_InterruptDsp_Module__diagsMask__C != NULL) *ti_sdo_ipc_family_omap4430_InterruptDsp_Module__diagsMask__C = mask;
}
