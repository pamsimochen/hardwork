...
#define ti_sdo_ipc_family_omap4430_NotifySetup___VERS 150
...
typedef xdc_Bool (*CT__ti_sdo_ipc_family_omap4430_NotifySetup_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_sdo_ipc_family_omap4430_NotifySetup_Module__startupDoneFxn ti_sdo_ipc_family_omap4430_NotifySetup_Module__startupDoneFxn__C;
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_NotifySetup_Module__startupDone__S, "ti_sdo_ipc_family_omap4430_NotifySetup_Module__startupDone")
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_NotifySetup_attach__F, "ti_sdo_ipc_family_omap4430_NotifySetup_attach")
__extern xdc_Int ti_sdo_ipc_family_omap4430_NotifySetup_attach__F( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
__extern xdc_Int ti_sdo_ipc_family_omap4430_NotifySetup_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_NotifySetup_sharedMemReq__F, "ti_sdo_ipc_family_omap4430_NotifySetup_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_family_omap4430_NotifySetup_sharedMemReq__F( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
__extern xdc_SizeT ti_sdo_ipc_family_omap4430_NotifySetup_sharedMemReq__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_family_omap4430_NotifySetup_numIntLines__F, "ti_sdo_ipc_family_omap4430_NotifySetup_numIntLines")
__extern xdc_UInt16 ti_sdo_ipc_family_omap4430_NotifySetup_numIntLines__F( xdc_UInt16 remoteProcId );
__extern xdc_UInt16 ti_sdo_ipc_family_omap4430_NotifySetup_numIntLines__R( xdc_UInt16 remoteProcId );
...
{
    return ti_sdo_ipc_family_omap4430_NotifySetup_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_family_omap4430_NotifySetup_Module_getMask( void ) 
{
    return ti_sdo_ipc_family_omap4430_NotifySetup_Module__diagsMask__C != NULL ? *ti_sdo_ipc_family_omap4430_NotifySetup_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_family_omap4430_NotifySetup_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_family_omap4430_NotifySetup_Module__diagsMask__C != NULL) *ti_sdo_ipc_family_omap4430_NotifySetup_Module__diagsMask__C = mask;
}
