...
#define ti_sdo_ipc_family_c647x_Interrupt___VERS 150
...
typedef xdc_Bool (*CT__ti_sdo_ipc_family_c647x_Interrupt_Module__startupDoneFxn)(void);
__extern __FAR__ const CT__ti_sdo_ipc_family_c647x_Interrupt_Module__startupDoneFxn ti_sdo_ipc_family_c647x_Interrupt_Module__startupDoneFxn__C;
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_Module_startup__R, "ti_sdo_ipc_family_c647x_Interrupt_Module_startup")
__extern xdc_Int ti_sdo_ipc_family_c647x_Interrupt_Module_startup__R( xdc_Int state );

/* Module__startupDone__S */
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_Module__startupDone__S, "ti_sdo_ipc_family_c647x_Interrupt_Module__startupDone")
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intEnable__F, "ti_sdo_ipc_family_c647x_Interrupt_intEnable")
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intEnable__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intEnable__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intDisable__F, "ti_sdo_ipc_family_c647x_Interrupt_intDisable")
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intDisable__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intDisable__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intRegister__F, "ti_sdo_ipc_family_c647x_Interrupt_intRegister")
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intRegister__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_Fxn func, xdc_UArg arg );
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intRegister__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_Fxn func, xdc_UArg arg );
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intUnregister__F, "ti_sdo_ipc_family_c647x_Interrupt_intUnregister")
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intUnregister__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intUnregister__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intSend__F, "ti_sdo_ipc_family_c647x_Interrupt_intSend")
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intSend__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intSend__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intPost__F, "ti_sdo_ipc_family_c647x_Interrupt_intPost")
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intPost__F( xdc_UInt16 srcProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
__extern xdc_Void ti_sdo_ipc_family_c647x_Interrupt_intPost__R( xdc_UInt16 srcProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo, xdc_UArg arg );
...
xdc__CODESECT(ti_sdo_ipc_family_c647x_Interrupt_intClear__F, "ti_sdo_ipc_family_c647x_Interrupt_intClear")
__extern xdc_UInt ti_sdo_ipc_family_c647x_Interrupt_intClear__F( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
__extern xdc_UInt ti_sdo_ipc_family_c647x_Interrupt_intClear__R( xdc_UInt16 remoteProcId, ti_sdo_ipc_notifyDrivers_IInterrupt_IntInfo* intInfo );
...
{
    return ti_sdo_ipc_family_c647x_Interrupt_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_family_c647x_Interrupt_Module_getMask( void ) 
{
    return ti_sdo_ipc_family_c647x_Interrupt_Module__diagsMask__C != NULL ? *ti_sdo_ipc_family_c647x_Interrupt_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_family_c647x_Interrupt_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_family_c647x_Interrupt_Module__diagsMask__C != NULL) *ti_sdo_ipc_family_c647x_Interrupt_Module__diagsMask__C = mask;
}
