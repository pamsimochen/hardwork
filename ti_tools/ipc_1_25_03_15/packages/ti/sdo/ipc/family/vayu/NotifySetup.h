...
#define ti_sdo_ipc_family_vayu_NotifySetup___VERS 150
...
/* NUM_CORES */
#define ti_sdo_ipc_family_vayu_NotifySetup_NUM_CORES (7)
...
typedef xdc_UInt32 __ARRAY1_ti_sdo_ipc_family_vayu_NotifySetup_procIdTable[7];
...
/* eve0ProcId */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId__D
#define ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId (ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId (ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId__C;
#endif
...
/* dsp0ProcId */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId__D
#define ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId (ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId (ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId__C;
#endif
...
/* benelliProcId */
#ifdef ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId__D
#define ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId (ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId__D)
#else
#define ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId (ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId__C)
typedef xdc_UInt CT__ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId;
__extern __FAR__ const CT__ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId__C;
#endif
...
/* Module_startup */
#define ti_sdo_ipc_family_vayu_NotifySetup_Module_startup( state ) (-1)

/* Module__startupDone__S */
xdc__CODESECT(ti_sdo_ipc_family_vayu_NotifySetup_Module__startupDone__S, "ti_sdo_ipc_family_vayu_NotifySetup_Module__startupDone")
...
xdc__CODESECT(ti_sdo_ipc_family_vayu_NotifySetup_attach__F, "ti_sdo_ipc_family_vayu_NotifySetup_attach")
__extern xdc_Int ti_sdo_ipc_family_vayu_NotifySetup_attach__F( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
__extern xdc_Int ti_sdo_ipc_family_vayu_NotifySetup_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_family_vayu_NotifySetup_sharedMemReq__F, "ti_sdo_ipc_family_vayu_NotifySetup_sharedMemReq")
__extern xdc_SizeT ti_sdo_ipc_family_vayu_NotifySetup_sharedMemReq__F( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
__extern xdc_SizeT ti_sdo_ipc_family_vayu_NotifySetup_sharedMemReq__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_ipc_family_vayu_NotifySetup_numIntLines__F, "ti_sdo_ipc_family_vayu_NotifySetup_numIntLines")
__extern xdc_UInt16 ti_sdo_ipc_family_vayu_NotifySetup_numIntLines__F( xdc_UInt16 remoteProcId );
__extern xdc_UInt16 ti_sdo_ipc_family_vayu_NotifySetup_numIntLines__R( xdc_UInt16 remoteProcId );
...
{
    return ti_sdo_ipc_family_vayu_NotifySetup_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_family_vayu_NotifySetup_Module_getMask( void ) 
{
    return ti_sdo_ipc_family_vayu_NotifySetup_Module__diagsMask__C != NULL ? *ti_sdo_ipc_family_vayu_NotifySetup_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_family_vayu_NotifySetup_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_family_vayu_NotifySetup_Module__diagsMask__C != NULL) *ti_sdo_ipc_family_vayu_NotifySetup_Module__diagsMask__C = mask;
}
...
#define NotifySetup_eve0ProcId ti_sdo_ipc_family_vayu_NotifySetup_eve0ProcId
...
#define NotifySetup_dsp0ProcId ti_sdo_ipc_family_vayu_NotifySetup_dsp0ProcId
#define NotifySetup_dsp1ProcId ti_sdo_ipc_family_vayu_NotifySetup_dsp1ProcId
#define NotifySetup_benelliProcId ti_sdo_ipc_family_vayu_NotifySetup_benelliProcId
