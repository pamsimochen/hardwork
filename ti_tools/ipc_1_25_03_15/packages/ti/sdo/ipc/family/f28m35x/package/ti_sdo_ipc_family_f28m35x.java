...
public class ti_sdo_ipc_family_f28m35x
{
    ...
    void IpcMgr$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("sharedMemoryEnable", Proto.Elm.newCNum("(xdc_Bits32)"), 0xffffffffL, "wh");
            po.addFld("sharedMemoryOwnerMask", Proto.Elm.newCNum("(xdc_Bits32)"), 0L, "wh");
            po.addFld("sharedMemoryAccess", new Proto.Arr(Proto.Elm.newCNum("(xdc_Bits32)"), false, xdc.services.intern.xsr.Enum.intValue(8L)), $$DEFAULT, "wh");
