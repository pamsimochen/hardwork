...
#define ti_sdo_utils_INameServerRemote___VERS 150
...
/* create */
static inline ti_sdo_utils_INameServerRemote_Handle ti_sdo_utils_INameServerRemote_create( ti_sdo_utils_INameServerRemote_Module __mod, xdc_UInt16 procId, const ti_sdo_utils_INameServerRemote_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_utils_INameServerRemote_Args__create __args;
    __args.procId = procId;
    return (ti_sdo_utils_INameServerRemote_Handle) __mod->__sysp->__create(0, 0, &__args, (const xdc_UChar*)__prms, sizeof (ti_sdo_utils_INameServerRemote_Params), __eb);
}

/* delete */
static inline void ti_sdo_utils_INameServerRemote_delete( ti_sdo_utils_INameServerRemote_Handle* instp )
{
...
/* get_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_utils_INameServerRemote_get_FxnT)(void*, xdc_String, xdc_String, xdc_Ptr, xdc_UInt32*, xdc_runtime_knl_ISync_Handle, xdc_runtime_Error_Block*);
