...
#define ti_sdo_utils_MultiProc___VERS 150
...
/* procIdList */
#define ti_sdo_utils_MultiProc_procIdList (ti_sdo_utils_MultiProc_procIdList__C)
typedef xdc_UInt16 __T1_ti_sdo_utils_MultiProc_procIdList;
typedef xdc_UInt16 *__ARRAY1_ti_sdo_utils_MultiProc_procIdList;
typedef __ARRAY1_ti_sdo_utils_MultiProc_procIdList __TA_ti_sdo_utils_MultiProc_procIdList;
typedef __TA_ti_sdo_utils_MultiProc_procIdList CT__ti_sdo_utils_MultiProc_procIdList;
__extern __FAR__ const CT__ti_sdo_utils_MultiProc_procIdList ti_sdo_utils_MultiProc_procIdList__C;
...
xdc__CODESECT(ti_sdo_utils_MultiProc_Module__startupDone__S, "ti_sdo_utils_MultiProc_Module__startupDone")
...
__extern xdc_UInt16 ti_sdo_utils_MultiProc_getClusterId__R( xdc_UInt16 procId );
...
__extern xdc_Void ti_sdo_utils_MultiProc_dummy__R( void );
...
{
    return ti_sdo_utils_MultiProc_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_utils_MultiProc_Module_getMask( void ) 
{
    return ti_sdo_utils_MultiProc_Module__diagsMask__C != NULL ? *ti_sdo_utils_MultiProc_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_utils_MultiProc_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_utils_MultiProc_Module__diagsMask__C != NULL) *ti_sdo_utils_MultiProc_Module__diagsMask__C = mask;
}
...
#define MultiProc_procIdList ti_sdo_utils_MultiProc_procIdList
...
#endif
/*
 *  @(#) ti.sdo.utils; 1, 0, 0, 0,; 5-10-2013 12:31:46; /db/vtree/library/trees/ipc/ipc-i15/src/ xlibrary
