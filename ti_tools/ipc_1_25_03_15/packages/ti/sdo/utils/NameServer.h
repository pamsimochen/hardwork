...
#define ti_sdo_utils_NameServer___VERS 150
...
typedef ti_sdo_utils_INameServerRemote_Handle *__ARRAY1_ti_sdo_utils_NameServer_Module_State__nsRemoteHandle;
...
struct ti_sdo_utils_NameServer_Struct {
    ...
    xdc_Bool __f9;
    ti_sdo_utils_List_Struct __f10;
...
xdc__CODESECT(ti_sdo_utils_NameServer_Module_startup__R, "ti_sdo_utils_NameServer_Module_startup")
__extern xdc_Int ti_sdo_utils_NameServer_Module_startup__R( xdc_Int state );

/* Instance_init__F */
xdc__CODESECT(ti_sdo_utils_NameServer_Instance_init__F, "ti_sdo_utils_NameServer_Instance_init")
__extern int ti_sdo_utils_NameServer_Instance_init__F( ti_sdo_utils_NameServer_Object*, xdc_String name, const ti_sdo_utils_NameServer_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__F */
xdc__CODESECT(ti_sdo_utils_NameServer_Instance_finalize__F, "ti_sdo_utils_NameServer_Instance_finalize")
__extern void ti_sdo_utils_NameServer_Instance_finalize__F( ti_sdo_utils_NameServer_Object* , int );

/* Instance_init__R */
xdc__CODESECT(ti_sdo_utils_NameServer_Instance_init__R, "ti_sdo_utils_NameServer_Instance_init")
__extern int ti_sdo_utils_NameServer_Instance_init__R( ti_sdo_utils_NameServer_Object*, xdc_String name, const ti_sdo_utils_NameServer_Params*, xdc_runtime_Error_Block* );

/* Instance_finalize__R */
xdc__CODESECT(ti_sdo_utils_NameServer_Instance_finalize__R, "ti_sdo_utils_NameServer_Instance_finalize")
__extern void ti_sdo_utils_NameServer_Instance_finalize__R( ti_sdo_utils_NameServer_Object* , int );

/* Handle__label__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Handle__label__S, "ti_sdo_utils_NameServer_Handle__label")
__extern xdc_runtime_Types_Label* ti_sdo_utils_NameServer_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label* lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Module__startupDone__S, "ti_sdo_utils_NameServer_Module__startupDone")
__extern xdc_Bool ti_sdo_utils_NameServer_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Object__create__S, "ti_sdo_utils_NameServer_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Object__delete__S, "ti_sdo_utils_NameServer_Object__delete")
__extern xdc_Void ti_sdo_utils_NameServer_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Object__destruct__S, "ti_sdo_utils_NameServer_Object__destruct")
__extern xdc_Void ti_sdo_utils_NameServer_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Object__get__S, "ti_sdo_utils_NameServer_Object__get")
__extern xdc_Ptr ti_sdo_utils_NameServer_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Object__first__S, "ti_sdo_utils_NameServer_Object__first")
__extern xdc_Ptr ti_sdo_utils_NameServer_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Object__next__S, "ti_sdo_utils_NameServer_Object__next")
__extern xdc_Ptr ti_sdo_utils_NameServer_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_utils_NameServer_Params__init__S, "ti_sdo_utils_NameServer_Params__init")
__extern xdc_Void ti_sdo_utils_NameServer_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );
...
xdc__CODESECT(ti_sdo_utils_NameServer_isRegistered__F, "ti_sdo_utils_NameServer_isRegistered")
__extern xdc_Bool ti_sdo_utils_NameServer_isRegistered__F( xdc_UInt16 procId );
__extern xdc_Bool ti_sdo_utils_NameServer_isRegistered__R( xdc_UInt16 procId );
...
xdc__CODESECT(ti_sdo_utils_NameServer_registerRemoteDriver__F, "ti_sdo_utils_NameServer_registerRemoteDriver")
__extern xdc_Int ti_sdo_utils_NameServer_registerRemoteDriver__F( ti_sdo_utils_INameServerRemote_Handle handle, xdc_UInt16 procId );
__extern xdc_Int ti_sdo_utils_NameServer_registerRemoteDriver__R( ti_sdo_utils_INameServerRemote_Handle handle, xdc_UInt16 procId );
...
xdc__CODESECT(ti_sdo_utils_NameServer_unregisterRemoteDriver__F, "ti_sdo_utils_NameServer_unregisterRemoteDriver")
__extern xdc_Void ti_sdo_utils_NameServer_unregisterRemoteDriver__F( xdc_UInt16 procId );
__extern xdc_Void ti_sdo_utils_NameServer_unregisterRemoteDriver__R( xdc_UInt16 procId );
...
xdc__CODESECT(ti_sdo_utils_NameServer_getKey__F, "ti_sdo_utils_NameServer_getKey")
__extern xdc_Ptr ti_sdo_utils_NameServer_getKey__F( ti_sdo_utils_NameServer_Object* __inst, xdc_UInt32 val );
__extern xdc_Ptr ti_sdo_utils_NameServer_getKey__R( ti_sdo_utils_NameServer_Handle __inst, xdc_UInt32 val );
...
/* getKey_{FxnT,fxnP} */
typedef xdc_Ptr (*ti_sdo_utils_NameServer_getKey_FxnT)(void*, xdc_UInt32);
static inline ti_sdo_utils_NameServer_getKey_FxnT ti_sdo_utils_NameServer_getKey_fxnP( void )
{
    return (ti_sdo_utils_NameServer_getKey_FxnT)ti_sdo_utils_NameServer_getKey; 
}
...
{
    return ti_sdo_utils_NameServer_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_utils_NameServer_Module_getMask( void ) 
{
    return ti_sdo_utils_NameServer_Module__diagsMask__C != NULL ? *ti_sdo_utils_NameServer_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_utils_NameServer_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_utils_NameServer_Module__diagsMask__C != NULL) *ti_sdo_utils_NameServer_Module__diagsMask__C = mask;
}
...
{
    if (dst) {
        ti_sdo_utils_NameServer_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_utils_NameServer_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline String ti_sdo_utils_NameServer_Handle_name( ti_sdo_utils_NameServer_Handle inst )
{
...
/* create */
static inline ti_sdo_utils_NameServer_Handle ti_sdo_utils_NameServer_create( xdc_String name, const ti_sdo_utils_NameServer_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_utils_NameServer_Args__create __args;
    __args.name = name;
    return (ti_sdo_utils_NameServer_Handle)ti_sdo_utils_NameServer_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_utils_NameServer_Params), __eb);
}

/* construct */
static inline void ti_sdo_utils_NameServer_construct( ti_sdo_utils_NameServer_Struct* __obj, xdc_String name, const ti_sdo_utils_NameServer_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_utils_NameServer_Args__create __args;
    __args.name = name;
    ti_sdo_utils_NameServer_Object__create__S(__obj, sizeof (ti_sdo_utils_NameServer_Struct), &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_utils_NameServer_Params), __eb);
}

/* delete */
static inline void ti_sdo_utils_NameServer_delete( ti_sdo_utils_NameServer_Handle* instp )
{
    ti_sdo_utils_NameServer_Object__delete__S(instp);
}

/* destruct */
static inline void ti_sdo_utils_NameServer_destruct( ti_sdo_utils_NameServer_Struct* obj )
{
    ti_sdo_utils_NameServer_Object__destruct__S(obj);
}
...
#define NameServer_getKey_fxnP ti_sdo_utils_NameServer_getKey_fxnP
#define NameServer_getKey_FxnT ti_sdo_utils_NameServer_getKey_FxnT
