...
#ifndef ti_sdo_utils_NameServerRemoteNull__INTERNAL__
#define ti_sdo_utils_NameServerRemoteNull__INTERNAL__

#ifndef ti_sdo_utils_NameServerRemoteNull__internalaccess
#define ti_sdo_utils_NameServerRemoteNull__internalaccess
#endif
...
/* attach */
#undef ti_sdo_utils_NameServerRemoteNull_attach
#define ti_sdo_utils_NameServerRemoteNull_attach ti_sdo_utils_NameServerRemoteNull_attach__E

/* detach */
#undef ti_sdo_utils_NameServerRemoteNull_detach
#define ti_sdo_utils_NameServerRemoteNull_detach ti_sdo_utils_NameServerRemoteNull_detach__E

/* sharedMemReq */
#undef ti_sdo_utils_NameServerRemoteNull_sharedMemReq
#define ti_sdo_utils_NameServerRemoteNull_sharedMemReq ti_sdo_utils_NameServerRemoteNull_sharedMemReq__E

/* get */
#undef ti_sdo_utils_NameServerRemoteNull_get
#define ti_sdo_utils_NameServerRemoteNull_get ti_sdo_utils_NameServerRemoteNull_get__F

/* Module_startup */
#undef ti_sdo_utils_NameServerRemoteNull_Module_startup
#define ti_sdo_utils_NameServerRemoteNull_Module_startup ti_sdo_utils_NameServerRemoteNull_Module_startup__F

/* Instance_init */
#undef ti_sdo_utils_NameServerRemoteNull_Instance_init
#define ti_sdo_utils_NameServerRemoteNull_Instance_init ti_sdo_utils_NameServerRemoteNull_Instance_init__F

/* Instance_finalize */
#undef ti_sdo_utils_NameServerRemoteNull_Instance_finalize
#define ti_sdo_utils_NameServerRemoteNull_Instance_finalize ti_sdo_utils_NameServerRemoteNull_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_ti.sdo.utils.NameServerRemoteNull"
typedef char ti_sdo_utils_NameServerRemoteNull_Object__sizingError[sizeof(ti_sdo_utils_NameServerRemoteNull_Object) > sizeof(ti_sdo_utils_NameServerRemoteNull_Struct) ? -1 : 1];


#endif /* ti_sdo_utils_NameServerRemoteNull__INTERNAL____ */
