...
#ifndef ti_sdo_utils_NameServer_SetupProxy__INTERNAL__
#define ti_sdo_utils_NameServer_SetupProxy__INTERNAL__

#ifndef ti_sdo_utils_NameServer_SetupProxy__internalaccess
#define ti_sdo_utils_NameServer_SetupProxy__internalaccess
#endif

#include <ti/sdo/utils/NameServer_SetupProxy.h>
...
/* attach */
#undef ti_sdo_utils_NameServer_SetupProxy_attach
#define ti_sdo_utils_NameServer_SetupProxy_attach ti_sdo_utils_NameServer_SetupProxy_attach__E

/* detach */
#undef ti_sdo_utils_NameServer_SetupProxy_detach
#define ti_sdo_utils_NameServer_SetupProxy_detach ti_sdo_utils_NameServer_SetupProxy_detach__E

/* sharedMemReq */
#undef ti_sdo_utils_NameServer_SetupProxy_sharedMemReq
#define ti_sdo_utils_NameServer_SetupProxy_sharedMemReq ti_sdo_utils_NameServer_SetupProxy_sharedMemReq__E

/* get */
#undef ti_sdo_utils_NameServer_SetupProxy_get
#define ti_sdo_utils_NameServer_SetupProxy_get ti_sdo_utils_NameServer_SetupProxy_get__F

/* Module_startup */
#undef ti_sdo_utils_NameServer_SetupProxy_Module_startup
#define ti_sdo_utils_NameServer_SetupProxy_Module_startup ti_sdo_utils_NameServer_SetupProxy_Module_startup__F

/* Instance_init */
#undef ti_sdo_utils_NameServer_SetupProxy_Instance_init
#define ti_sdo_utils_NameServer_SetupProxy_Instance_init ti_sdo_utils_NameServer_SetupProxy_Instance_init__F

/* Instance_finalize */
#undef ti_sdo_utils_NameServer_SetupProxy_Instance_finalize
#define ti_sdo_utils_NameServer_SetupProxy_Instance_finalize ti_sdo_utils_NameServer_SetupProxy_Instance_finalize__F
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_ti.sdo.utils.NameServer_SetupProxy"
typedef char ti_sdo_utils_NameServer_SetupProxy_Object__sizingError[sizeof(ti_sdo_utils_NameServer_SetupProxy_Object) > sizeof(ti_sdo_utils_NameServer_SetupProxy_Struct) ? -1 : 1];


#endif /* ti_sdo_utils_NameServer_SetupProxy__INTERNAL____ */
