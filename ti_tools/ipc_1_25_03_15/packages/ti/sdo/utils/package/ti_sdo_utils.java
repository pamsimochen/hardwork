...
public class ti_sdo_utils
{
    ...
    void NameServer$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sdo.utils.NameServer.Object", new Proto.Str(po, false));
    ...
    void INameServerRemote$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sdo.utils.INameServerRemote.Object", new Proto.Str(po, false));
    ...
    void NameServerRemoteNull$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sdo.utils.NameServerRemoteNull.Object", new Proto.Str(po, false));
    ...
    void List$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sdo.utils.List.Object", new Proto.Str(po, false));
    ...
    void NameServer_SetupProxy$$OBJECTS()
    {
        ...
        Object objP = om.bind("ti.sdo.utils.NameServer_SetupProxy.Object", new Proto.Str(po, false));
    ...
    void NameServer$$SIZES()
    {
        ...
        sizes.clear();
        sizes.add(Global.newArray("nsRemoteHandle", "UPtr"));
    ...
    void NameServer$$TYPES()
    {
        ...
        po.init("ti.sdo.utils.NameServer.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("nsRemoteHandle", new Proto.Arr((Proto)om.findStrict("ti.sdo.utils.INameServerRemote.Handle", "ti.sdo.utils"), false), $$DEFAULT, "w");
    ...
    void MultiProc$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("procIdList", new Proto.Arr(Proto.Elm.newCNum("(xdc_UInt16)"), false), $$DEFAULT, "w");
        }//isCFG
        fxn = Global.get(cap, "module$use");
    ...
    void NameServer$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sdo.utils.NameServer$$Module_State", "ti.sdo.utils");
        po.bind("nsRemoteHandle$fetchDesc", Global.newObject("type", "xdc.rov.support.ScalarStructs.S_Ptr", "isScalar", true));
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.a28L',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.a28FP',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.a64P',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.a64Pe',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.a674',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae64P',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae64Pe',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae674',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae64T',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae66',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae66e',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.ae9',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aea8f',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aea8fnv',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aem3',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aem4',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aem4f',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aearp32',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aearp32F',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aer4te',\n");
            sb.append("'lib/utils/debug/ti.sdo.utils.aer4fte',\n");
            sb.append("'lib/smputils/debug/ti.sdo.utils.aem3',\n");
            sb.append("'lib/smputils/debug/ti.sdo.utils.aem4',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.a28L', {target: 'ti.targets.C28_large', suffix: '28L'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.a28FP', {target: 'ti.targets.C28_float', suffix: '28FP'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.a64P', {target: 'ti.targets.C64P', suffix: '64P'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.a64Pe', {target: 'ti.targets.C64P_big_endian', suffix: '64Pe'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.a674', {target: 'ti.targets.C674', suffix: '674'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae64P', {target: 'ti.targets.elf.C64P', suffix: 'e64P'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae64Pe', {target: 'ti.targets.elf.C64P_big_endian', suffix: 'e64Pe'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae674', {target: 'ti.targets.elf.C674', suffix: 'e674'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae64T', {target: 'ti.targets.elf.C64T', suffix: 'e64T'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae66', {target: 'ti.targets.elf.C66', suffix: 'e66'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae66e', {target: 'ti.targets.elf.C66_big_endian', suffix: 'e66e'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aea8f', {target: 'ti.targets.arm.elf.A8F', suffix: 'ea8f'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aearp32', {target: 'ti.targets.arp32.elf.ARP32', suffix: 'earp32'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aearp32F', {target: 'ti.targets.arp32.elf.ARP32_far', suffix: 'earp32F'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aer4te', {target: 'ti.targets.arm.elf.R4t_big_endian', suffix: 'er4te'}],\n");
            sb.append("['lib/utils/debug/ti.sdo.utils.aer4fte', {target: 'ti.targets.arm.elf.R4Ft_big_endian', suffix: 'er4fte'}],\n");
            sb.append("['lib/smputils/debug/ti.sdo.utils.aem3', {target: 'ti.targets.arm.elf.M3', suffix: 'em3'}],\n");
            sb.append("['lib/smputils/debug/ti.sdo.utils.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
        sb.append("];\n");
        Global.eval(sb.toString());
    }
    ...
    void NameServer$$SINGLETONS()
    {
        ...
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray("E_maxReached", "E_entryExists"));
    ...
    void MultiProc$$SINGLETONS()
    {
        ...
        mcfgs.add("procIdList");
        icfgs.add("procIdList");
