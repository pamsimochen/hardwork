...
#define ti_sdo_utils_NameServer_SetupProxy___VERS 150
...
/* Handle__label__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Handle__label__S, "ti_sdo_utils_NameServer_SetupProxy_Handle__label")
...
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Module__startupDone__S, "ti_sdo_utils_NameServer_SetupProxy_Module__startupDone")
__extern xdc_Bool ti_sdo_utils_NameServer_SetupProxy_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Object__create__S, "ti_sdo_utils_NameServer_SetupProxy_Object__create")
...
/* Object__delete__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Object__delete__S, "ti_sdo_utils_NameServer_SetupProxy_Object__delete")
__extern xdc_Void ti_sdo_utils_NameServer_SetupProxy_Object__delete__S( xdc_Ptr instp );

/* Object__destruct__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Object__destruct__S, "ti_sdo_utils_NameServer_SetupProxy_Object__destruct")
__extern xdc_Void ti_sdo_utils_NameServer_SetupProxy_Object__destruct__S( xdc_Ptr objp );

/* Object__get__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Object__get__S, "ti_sdo_utils_NameServer_SetupProxy_Object__get")
__extern xdc_Ptr ti_sdo_utils_NameServer_SetupProxy_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Object__first__S, "ti_sdo_utils_NameServer_SetupProxy_Object__first")
__extern xdc_Ptr ti_sdo_utils_NameServer_SetupProxy_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Object__next__S, "ti_sdo_utils_NameServer_SetupProxy_Object__next")
__extern xdc_Ptr ti_sdo_utils_NameServer_SetupProxy_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Params__init__S, "ti_sdo_utils_NameServer_SetupProxy_Params__init")
__extern xdc_Void ti_sdo_utils_NameServer_SetupProxy_Params__init__S( xdc_Ptr dst, xdc_Ptr src, xdc_SizeT psz, xdc_SizeT isz );

/* Proxy__abstract__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Proxy__abstract__S, "ti_sdo_utils_NameServer_SetupProxy_Proxy__abstract")
__extern xdc_Bool ti_sdo_utils_NameServer_SetupProxy_Proxy__abstract__S( void );

/* Proxy__delegate__S */
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_Proxy__delegate__S, "ti_sdo_utils_NameServer_SetupProxy_Proxy__delegate")
...
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_attach__R, "ti_sdo_utils_NameServer_SetupProxy_attach")
__extern xdc_Int ti_sdo_utils_NameServer_SetupProxy_attach__R( xdc_UInt16 remoteProcId, xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_detach__R, "ti_sdo_utils_NameServer_SetupProxy_detach")
__extern xdc_Int ti_sdo_utils_NameServer_SetupProxy_detach__R( xdc_UInt16 remoteProcId );
...
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_sharedMemReq__R, "ti_sdo_utils_NameServer_SetupProxy_sharedMemReq")
__extern xdc_SizeT ti_sdo_utils_NameServer_SetupProxy_sharedMemReq__R( xdc_Ptr sharedAddr );
...
xdc__CODESECT(ti_sdo_utils_NameServer_SetupProxy_get__R, "ti_sdo_utils_NameServer_SetupProxy_get")
__extern xdc_Int ti_sdo_utils_NameServer_SetupProxy_get__R( ti_sdo_utils_NameServer_SetupProxy_Handle __inst, xdc_String instanceName, xdc_String name, xdc_Ptr value, xdc_UInt32* valueLen, xdc_runtime_knl_ISync_Handle syncHandle, xdc_runtime_Error_Block* eb );
...
/* get_{FxnT,fxnP} */
typedef xdc_Int (*ti_sdo_utils_NameServer_SetupProxy_get_FxnT)(void*, xdc_String, xdc_String, xdc_Ptr, xdc_UInt32*, xdc_runtime_knl_ISync_Handle, xdc_runtime_Error_Block*);
static inline ti_sdo_utils_NameServer_SetupProxy_get_FxnT ti_sdo_utils_NameServer_SetupProxy_get_fxnP( void )
{
    return (ti_sdo_utils_NameServer_SetupProxy_get_FxnT)ti_sdo_utils_NameServer_SetupProxy_get; 
}
...
if (ti_sdo_utils_NameServer_SetupProxy_Proxy__abstract__S()) return (ti_sdo_utils_NameServer_SetupProxy_Handle)i;
    return (void*)i2->__fxns == (void*)ti_sdo_utils_NameServer_SetupProxy_Proxy__delegate__S() ? (ti_sdo_utils_NameServer_SetupProxy_Handle)i : 0;
}
...
{
    if (dst) {
        ti_sdo_utils_NameServer_SetupProxy_Params__init__S(dst, (xdc_Ptr)src, sizeof(ti_sdo_utils_NameServer_SetupProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}

/* create */
static inline ti_sdo_utils_NameServer_SetupProxy_Handle ti_sdo_utils_NameServer_SetupProxy_create( xdc_UInt16 procId, const ti_sdo_utils_NameServer_SetupProxy_Params* __prms, xdc_runtime_Error_Block* __eb )
{
    ti_sdo_utils_NameServer_SetupProxy_Args__create __args;
    __args.procId = procId;
    return (ti_sdo_utils_NameServer_SetupProxy_Handle)ti_sdo_utils_NameServer_SetupProxy_Object__create__S(0, 0, &__args, (const xdc_UChar*)__prms, sizeof(ti_sdo_utils_NameServer_SetupProxy_Params), __eb);
}

/* delete */
static inline void ti_sdo_utils_NameServer_SetupProxy_delete( ti_sdo_utils_NameServer_SetupProxy_Handle* instp )
{
    ti_sdo_utils_NameServer_SetupProxy_Object__delete__S(instp);
}
...
#define NameServer_SetupProxy_get_fxnP ti_sdo_utils_NameServer_SetupProxy_get_fxnP
#define NameServer_SetupProxy_get_FxnT ti_sdo_utils_NameServer_SetupProxy_get_FxnT
