...
\begin{DoxyCompactList}\small\item\em Sets the message priority of a message. \end{DoxyCompactList}\item 
\#define \hyperlink{_message_q_8h_ad362a4aed0277886db9c82bb5071c0f0}{Message\-Q\-\_\-\-A\-N\-Y}~(Bits16)$\sim$(0)
\begin{DoxyCompactList}\small\item\em Denotes any queue\-Id is acceptable. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hline
\end{DoxyParams}
\index{Message\-Q.\-h@{Message\-Q.\-h}!Message\-Q\-\_\-\-A\-N\-Y@{Message\-Q\-\_\-\-A\-N\-Y}}
\index{Message\-Q\-\_\-\-A\-N\-Y@{Message\-Q\-\_\-\-A\-N\-Y}!MessageQ.h@{Message\-Q.\-h}}
\paragraph[{Message\-Q\-\_\-\-A\-N\-Y}]{\setlength{\rightskip}{0pt plus 5cm}\#define Message\-Q\-\_\-\-A\-N\-Y~(Bits16)$\sim$(0)}\label{_message_q_8h_ad362a4aed0277886db9c82bb5071c0f0}
...
\index{Message\-Q.\-h@{Message\-Q.\-h}!Message\-Q\-\_\-\-Free\-Hook\-Fxn@{Message\-Q\-\_\-\-Free\-Hook\-Fxn}}
\index{Message\-Q\-\_\-\-Free\-Hook\-Fxn@{Message\-Q\-\_\-\-Free\-Hook\-Fxn}!MessageQ.h@{Message\-Q.\-h}}
...
\hline
\end{DoxyParams}
\index{Message\-Q.\-h@{Message\-Q.\-h}!Message\-Q\-\_\-\-Params2\-\_\-init@{Message\-Q\-\_\-\-Params2\-\_\-init}}
\index{Message\-Q\-\_\-\-Params2\-\_\-init@{Message\-Q\-\_\-\-Params2\-\_\-init}!MessageQ.h@{Message\-Q.\-h}}
\paragraph[{Message\-Q\-\_\-\-Params2\-\_\-init}]{\setlength{\rightskip}{0pt plus 5cm}Void Message\-Q\-\_\-\-Params2\-\_\-init (
\begin{DoxyParamCaption}
\item[{{\bf Message\-Q\-\_\-\-Params2} $\ast$}]{params}
\end{DoxyParamCaption}
)}\label{_message_q_8h_a2f7743bad878b04d8448b1141162091f}


Initialize \hyperlink{struct_message_q___params2}{Message\-Q\-\_\-\-Params2}. 
...
Message\-Q Handle 
\end{DoxyReturn}
\index{Message\-Q.\-h@{Message\-Q.\-h}!Message\-Q\-\_\-create2@{Message\-Q\-\_\-create2}}
\index{Message\-Q\-\_\-create2@{Message\-Q\-\_\-create2}!MessageQ.h@{Message\-Q.\-h}}
\paragraph[{Message\-Q\-\_\-create2}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Message\-Q\-\_\-\-Handle} Message\-Q\-\_\-create2 (
\begin{DoxyParamCaption}
\item[{String}]{name, }
\item[{const {\bf Message\-Q\-\_\-\-Params2} $\ast$}]{params}
\end{DoxyParamCaption}
)}\label{_message_q_8h_a7d5165a5c50905f87da2df01a917ea88}


Create a Message\-Q instance with the \hyperlink{struct_message_q___params2}{Message\-Q\-\_\-\-Params2} structure. 

The name supplied here does not have to be in persistent memory. The maximum length of the string supplied here, including the '\textbackslash{}0' terminator is '32' by default.

There are no verifications to ensure that the name supplied in \hyperlink{_message_q_8h_a7d5165a5c50905f87da2df01a917ea88}{Message\-Q\-\_\-create2()} is unique across all processors. Caution must be exercised to ensure that each processor uses a unique name.


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em name} & Name of the queue \\
\hline
\mbox{\tt in}  & {\em params} & Initialized \hyperlink{struct_message_q___params2}{Message\-Q\-\_\-\-Params2}\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Message\-Q Handle 
...
\end{DoxyItemize}
\end{DoxyReturn}
\index{Message\-Q.\-h@{Message\-Q.\-h}!Message\-Q\-\_\-open\-Queue\-Id@{Message\-Q\-\_\-open\-Queue\-Id}}
\index{Message\-Q\-\_\-open\-Queue\-Id@{Message\-Q\-\_\-open\-Queue\-Id}!MessageQ.h@{Message\-Q.\-h}}
\paragraph[{Message\-Q\-\_\-open\-Queue\-Id}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Message\-Q\-\_\-\-Queue\-Id} Message\-Q\-\_\-open\-Queue\-Id (
\begin{DoxyParamCaption}
\item[{U\-Int16}]{queue\-Index, }
\item[{U\-Int16}]{remote\-Proc\-Id}
\end{DoxyParamCaption}
)}\label{_message_q_8h_ac725833eb72ca8fcb33978377d036fcc}


Opens a Message\-Q given the queue index and remote processor id. 

This function can be used instead of Message\-Q\-\_\-open if the queue was created with a specified Queue\-Index.


\begin{DoxyCode}
\textcolor{preprocessor}{        #define SERVERQUEUEINDEX  1}
\textcolor{preprocessor}{}\textcolor{preprocessor}{        #define SERVERMULTIPROCID 2}
\textcolor{preprocessor}{}  
        serverFxn() \{
            ...
            messageQ = MessageQ_create2(\textcolor{stringliteral}{"server"}, &params2);
            ...
  
        clientFxn() \{
            MessageQ_QueueId serverQueue;
            serverQueue = MessageQ_openQueueId(SERVERQUEUEINDEX, 
      SERVERMULTIPROCID);
\end{DoxyCode}


It is up to the application to guaratee that the queue that is being opened has already been created. The Message\-Q\-\_\-open\-Queue\-Id A\-P\-I does not validate that the queue has been created (unlike the Message\-Q\-\_\-open function).


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em queue\-Index} & Queue\-Index specified in the \hyperlink{struct_message_q___params2}{Message\-Q\-\_\-\-Params2} \\
\hline
\mbox{\tt in}  & {\em remote\-Proc\-Id} & Multiproc\-\_\-\-Id of where the created queue resides\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The Message\-Q\-\_\-\-Queue\-Id associated with the queue\-Index and remote\-Proc\-Id 
\end{DoxyReturn}
...
{\ttfamily size} must be at least large enough to hold a \hyperlink{struct_message_q___msg_header}{Message\-Q\-\_\-\-Msg\-Header} 
\end{DoxyPrecond}
\index{Message\-Q.\-h@{Message\-Q.\-h}!Message\-Q\-\_\-set\-Free\-Hook\-Fxn@{Message\-Q\-\_\-set\-Free\-Hook\-Fxn}}
\index{Message\-Q\-\_\-set\-Free\-Hook\-Fxn@{Message\-Q\-\_\-set\-Free\-Hook\-Fxn}!MessageQ.h@{Message\-Q.\-h}}
\paragraph[{Message\-Q\-\_\-set\-Free\-Hook\-Fxn}]{\setlength{\rightskip}{0pt plus 5cm}Void Message\-Q\-\_\-set\-Free\-Hook\-Fxn (
\begin{DoxyParamCaption}
\item[{{\bf Message\-Q\-\_\-\-Free\-Hook\-Fxn}}]{free\-Hook\-Fxn}
\end{DoxyParamCaption}
)}\label{_message_q_8h_af487f79f7661b7622835e9c37045a23f}


Sets Message\-Q's free hook function. 

This A\-P\-I allows a user to specify a hook function which is called within Message\-Q\-\_\-free. The hook is called after a message is freed back to the associated heap. The two parameters to the hook function are the heap\-Id and the msg\-Id of the freed message.

The function is called within the Message\-Q\-\_\-free, so care must be taken to minimize any performance or calling context impact.

The Message\-Q\-\_\-set\-Free\-Hook\-Fxn function is not thread safe. It should only be called when no Message\-Q\-\_\-frees are happening.

To disable the hook function, simply call Message\-Q\-\_\-set\-Free\-Hook\-Fxn with N\-U\-L\-L.


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em free\-Hook\-Fxn} & function to be called within Message\-Q\-\_\-free \\
\hline
\end{DoxyParams}
