...
/* EDMA Channel Registers for Shadow region 5 */
#define DM81XX_EDMA3_ESR            (DM81XX_EDMA3_CC_BASE + 0x2A10)
#define DM81XX_EDMA3_ESRH           (DM81XX_EDMA3_CC_BASE + 0x2A14)
#define DM81XX_EDMA3_IESR           (DM81XX_EDMA3_CC_BASE + 0x2A60)
#define DM81XX_EDMA3_IESRH          (DM81XX_EDMA3_CC_BASE + 0x2A64)
#define DM81XX_EDMA3_IPR            (DM81XX_EDMA3_CC_BASE + 0x2A68)
#define DM81XX_EDMA3_IPRH           (DM81XX_EDMA3_CC_BASE + 0x2A6C)
#define DM81XX_EDMA3_ICR            (DM81XX_EDMA3_CC_BASE + 0x2A70)
#define DM81XX_EDMA3_ICRH           (DM81XX_EDMA3_CC_BASE + 0x2A74)
