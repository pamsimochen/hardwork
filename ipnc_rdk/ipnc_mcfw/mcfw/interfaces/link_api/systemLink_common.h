...
/**
    ...
    \param [IN]  None   *
*/
#define SYSTEM_COMMON_CMD_GET_EDMA_CH                 (0x9010)
/**
    \brief System CMD: System command to check core status.

    \param [IN]  None   *
*/
#define SYSTEM_COMMON_CMD_PUT_EDMA_CH                 (0x9011)
/**
    \brief System CMD: System command to check core status.
...
/**
    ...
    in all the container modes.
*/
typedef struct SystemCommon_edmaChPrm {

	OSA_DmaChHndl dmaHndl;
	/**< [IN] DMA Handle */
	
} SystemCommon_edmaChPrm;
...
/**
    ...
    in all the container modes.
*/
typedef struct SystemCommon_rvmLutPrm {

	Int8 fileName[128];
	/**< [IN] LUT file name */
	
	UInt32 lutBufAddr;
	/**< [IN] LUT Buffer Address */
