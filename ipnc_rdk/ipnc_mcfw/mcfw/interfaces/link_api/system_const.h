...
#define SYSTEM_DEVICE_VID_CAM_OV7740_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x000Cu)
#define SYSTEM_DEVICE_VID_CAM_MT9M034_DUAL_HEAD_BOARD_DRV (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x000Du)

#define SYSTEM_DEVICE_VID_CAM_IMX136_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x000Eu)
#define SYSTEM_DEVICE_VID_CAM_AR0330_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x000Fu)
#define SYSTEM_DEVICE_VID_CAM_IMX104_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x0010u)
#define SYSTEM_DEVICE_VID_CAM_AL30210_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x0011u)
#define SYSTEM_DEVICE_VID_CAM_OV2710_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x0012u)
#define SYSTEM_DEVICE_VID_CAM_IMX122_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x0013u)
#define SYSTEM_DEVICE_VID_CAM_IMX140_DRV    (SYSTEM_DEVICE_VID_CAM_SENSOR_DRV_BASE + 0x0014u)
