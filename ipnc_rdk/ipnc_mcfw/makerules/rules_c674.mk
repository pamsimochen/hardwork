...
ifeq ($(PROFILE_$(CORE)), release)
 CFLAGS_XDCINTERNAL = -Dxdc_target_name__=C674 -Dxdc_bld__profile_release -DGENERIC -ms -oe -O3 -k -op0 -os  --optimize_with_debug --inline_recursion_limit=20 --opt_for_speed=4 
 CFLAGS_INTERNAL += -mt -op2 
# ifndef MODULE_NAME
 CFLAGS_XDCINTERNAL += -Dxdc_cfg__header__='$(CONFIGURO_DIR)/package/cfg/$(XDC_HFILE_NAME)_pe674.h' 
# endif
 LNKFLAGS_INTERNAL_PROFILE = -o2
 #LNKFLAGS_INTERNAL_PROFILE = --opt='--endian=$(ENDIAN) --abi=$(CSWITCH_FORMAT) -qq -pdsw225 $(CFLAGS_GLOBAL_$(CORE)) -oe --symdebug:dwarf -ms -op2 -O3 -k -os --optimize_with_debug --inline_recursion_limit=20 --diag_suppress=23000' --strict_compatibility=on --unused_section_elimination=on
# LNKFLAGS_INTERNAL_PROFILE = 
endif
...
ifeq ($(LOCAL_APP_NAME),)
 ...
 ALG_LNKCMD = $(MCFW_ROOT_PATH)/mcfw/src_bios6/cfg/ti814x/link_algs.cmd
else
 ifeq ($(PROFILE_$(CORE)),whole_program_debug)
...
# Include asm dependency make files that were generated by $(CC)
-include $(ASRCS:%.s=$(DEPDIR)/%.P)
